  ...
  switch (number) {
    ...
    case X86_64_SYSCALL_FS_CANONICAL:
      return DaveHostFilesystemCanonical(
          (const char*)(uintptr_t)a0, (char*)(uintptr_t)a1, (size_t)a2);
    case X86_64_SYSCALL_FS_DESCRIPTOR_STATUS:
