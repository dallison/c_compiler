...
static bool RV32FpIsDoubleWidth(TypeRecord* type) {
  return TypeUsesFloat64Representation(type);
}

static void LowerVariables(RV32Generator* rv, Generator* gen);
...
const char* RV32OpcodeName(int op) {
  RV32Opcode opcode = (RV32Opcode)op;
  switch (opcode) {
    default:
    ...
    case RV32_OP(fsw):
      return "fsw";
    case RV32_OP(fmadd_s):
      return "fmadd.s";
    case RV32_OP(fmsub_s):
      return "fmsub.s";
    case RV32_OP(fnmsub_s):
      return "fnmsub.s";
    case RV32_OP(fnmadd_s):
      return "fnmadd.s";
    case RV32_OP(fadd_s):
      return "fadd.s";
    case RV32_OP(fsub_s):
    ...
    case RV32_OP(fdiv_s):
      return "fdiv.s";
    case RV32_OP(fsqrt_s):
      return "fsqrt.s";
    case RV32_OP(fsgnj_s):
      return "fsgnj.s";
    case RV32_OP(fsgnjn_s):
      return "fsgnjn.s";
    case RV32_OP(fsgnjx_s):
      return "fsgnjx.s";
    case RV32_OP(fmin_s):
      return "fmin.s";
    case RV32_OP(fmax_s):
    ...
    case RV32_OP(fclass_s):
      return "fclass.s";
    case RV32_OP(fcvt_s_w):
      return "fcvt.s.w";
    case RV32_OP(fcvt_s_wu):
      return "fcvt.s.wu";
    ...
    case RV32_OP(fsd):
      return "fsd";
    case RV32_OP(fmadd_d):
      return "fmadd.d";
    case RV32_OP(fmsub_d):
      return "fmsub.d";
    case RV32_OP(fnmsub_d):
      return "fnmsub.d";
    case RV32_OP(fnmadd_d):
      return "fnmadd.d";
    case RV32_OP(fadd_d):
      return "fadd.d";
    case RV32_OP(fsub_d):
    ...
    case RV32_OP(fdiv_d):
      return "fdiv.d";
    case RV32_OP(fsqrt_d):
      return "fsqrt.d";
    case RV32_OP(fsgnj_d):
      return "fsgnj.d";
    case RV32_OP(fsgnjn_d):
      return "fsgnjn.d";
    case RV32_OP(fsgnjx_d):
      return "fsgnjx.d";
    case RV32_OP(fmin_d):
      return "fmin.d";
    case RV32_OP(fmax_d):
      return "fmax.d";
    case RV32_OP(fcvt_s_d):
      return "fcvt.s.d";
    case RV32_OP(fcvt_d_s):
      return "fcvt.d.s";
    case RV32_OP(feq_d):
      return "feq.d";
    case RV32_OP(flt_d):
    ...
    case RV32_OP(fcvt_wu_d):
      return "fcvt.wu.d";
    case RV32_OP(fcvt_d_w):
      return "fcvt.d.w";
    case RV32_OP(fcvt_d_wu):
      return "fcvt.d.wu";
    ...
    case RV32_OP(fcvt_d_l):
      return "fcvt.d.l";
    case RV32_OP(fcvt_d_lu):
      return "fcvt.d.lu";
    case RV32_OP(fmv_d_x):
      return "fmv.d.x";
    ...
    case RV32_OP(reload):
      return "reload";
    case RV32_OP(atomic_load):
      return "atomic_load";
    case RV32_OP(atomic_store):
      return "atomic_store";
    case RV32_OP(atomic_fetch_add):
      return "atomic_fetch_add";
    case RV32_OP(atomic_fetch_sub):
      return "atomic_fetch_sub";
    case RV32_OP(atomic_add_fetch):
      return "atomic_add_fetch";
    case RV32_OP(atomic_sub_fetch):
      return "atomic_sub_fetch";
    case RV32_OP(atomic_compare_exchange_bool):
      return "atomic_compare_exchange_bool";
    case RV32_OP(atomic_compare_exchange_val):
      return "atomic_compare_exchange_val";
    case RV32_OP(atomic_compare_exchange_n):
...
//    case RV32_OP(rmovd):
    ...
    case RV32_OP(atomic_fence):
      return false;
    default:
      return !RV32IsFixedRegister(inst) && !RV32IsConst(inst);
  }
}

bool RV32GeneratesOutput(TargetInstruction* inst) {
  if (RV32IsFixedRegister(inst)) {
    return false;
  }
  switch ((RV32Opcode)inst->opcode) {
    ...
    case RV32_OP(resultd):
      return false;
    default:
      return RV32IsExpression(inst) && !RV32IsSymbol(inst) && !RV32IsConst(inst);
  }
}
...
bool RV32IsFloatingPoint(TargetInstruction* inst) {
  if ((RV32Opcode)inst->opcode < RV32_OP(flw) || (RV32Opcode)inst->opcode > RV32_OP(fmv_d_x)) {
    return false;
  }
  switch ((RV32Opcode)inst->opcode) {
    case RV32_OP(fa0):
...
bool RV32IsSymbol(TargetInstruction* inst) {
  return (RV32Opcode)((int)inst->opcode == (int)RV32_OP(symbol));
}
...
bool RV32IsSpill(TargetInstruction* inst) {
  return (RV32Opcode)((int)inst->opcode == (int)RV32_OP(spill));
}

bool RV32IsLabel(TargetInstruction* inst) {
  return (RV32Opcode)((int)inst->opcode == (int)RV32_OP(label));
}

bool RV32IsReturn(TargetInstruction* inst) {
  return (RV32Opcode)((int)inst->opcode == (int)RV32_OP(ret));
}

int64_t RV32IntValue(TargetInstruction* inst) {
  if (inst->opcode == (TargetOpcode)RV32_OP(x0)) {
    return 0;
  }
...
bool RV32IsJumpableEntry(TargetInstruction* inst) {
  return inst->opcode == (TargetOpcode)RV32_OP(j);
}

static TargetVirtuals virtuals = {
  .opcode_name = RV32OpcodeName,
  .is_branch = RV32IsBranch,
  .is_call = RV32IsCall,
  .is_return = RV32IsReturn,
  .is_spill = RV32IsSpill,
  .is_label = RV32IsLabel,
  .is_floating_point = RV32IsFloatingPoint,
  .is_conditional_branch = RV32IsConditionalBranch,
  .is_fixed_register = RV32IsFixedRegister,
  .is_const = RV32IsConst,
  .is_symbol = RV32IsSymbol,
  .is_expression = RV32IsExpression,
  .is_table_entry = RV32IsJumpableEntry,
  .get_branch_target = RV32GetBranchTarget,
  .calls_may_stay_in_block = true,
};

void RV32GeneratorInit(RV32Generator* rv, Generator* gen) {
  ...
  RV32RegisterAllocatorInit(&rv->register_allocator, rv);
}

RV32Generator* NewRV32Generator(Generator* gen) {
  RV32Generator* rv = malloc(sizeof(RV32Generator));
  RV32GeneratorInit(rv, gen);
  return rv;
}

void RV32GeneratorDestruct(RV32Generator* rv) {
  ...
  RV32RegisterAllocatorDestruct(&rv->register_allocator);
  
}

static void ResolveExceptionRanges(RV32Generator* rv, Generator* gen) {
  ...
  for (size_t i = 0; i < gen->exception_ranges.length; i++) {
    ...
    RV32ExceptionRange* range = malloc(sizeof(RV32ExceptionRange));
...
void RV32GeneratorDelete(RV32Generator* rv) {
  RV32GeneratorDestruct(rv);
  free(rv);
}
...
static TargetInstruction* NewInstruction1(RV32Opcode opcode,
                                          TargetInstruction* op1) {
  return TargetNewInstruction1((TargetOpcode)opcode, op1);
}

static TargetInstruction* NewInstruction2(RV32Opcode opcode,
                                          TargetInstruction* op1,
                                          TargetInstruction* op2) {
  return TargetNewInstruction2((TargetOpcode)opcode, op1, op2);
}

static COMPILER_UNUSED TargetInstruction* NewInstruction3(RV32Opcode opcode,
                                          TargetInstruction* op1,
                                          TargetInstruction* op2,
...
static TargetInstruction* Emit(RV32Generator* rv, TargetInstruction* inst) {
  return TargetEmit(&rv->base, inst);
}

static COMPILER_UNUSED TargetInstruction* EmitBefore(RV32Generator* rv, TargetInstruction* inst,
                                     TargetInstruction* pos) {
  return TargetEmitBefore(&rv->base, inst, pos);
}

static COMPILER_UNUSED TargetInstruction* EmitAfter(RV32Generator* rv, TargetInstruction* inst,
                                    TargetInstruction* pos) {
  return TargetEmitAfter(&rv->base, inst, pos);
}

static COMPILER_UNUSED TargetInstruction* EmitConstant(RV32Generator* rv, TargetInstruction* c) {
  return TargetEmitConstant(&rv->base, c);
}

static COMPILER_UNUSED TargetInstruction* EmitSymbol(RV32Generator* rv, TargetInstruction* c) {
  return TargetEmitSymbol(&rv->base, c);
}

static COMPILER_UNUSED TargetInstruction* FramePointer(RV32Generator* rv) {
  return TargetFramePointer(&rv->base);
}

static COMPILER_UNUSED TargetInstruction* StackPointer(RV32Generator* rv) {
...
static TargetInstruction* GetIntConstant(RV32Generator* rv, IRNode* node,
                                         TargetType type, int64_t value) {
  return TargetGetIntConstant(&rv->base, node, type, value);
}

static COMPILER_UNUSED TargetInstruction* GetFloatingPointConstant(RV32Generator* rv,
                                                   IRNode* node,
                                                   TargetType type,
                                                   double value) {
...
static TargetInstruction* GetSymbol(RV32Generator* rv, IRNode* node,
                                    Symbol* symbol) {
  return TargetGetSymbol(&rv->base, node, symbol);
}

static TargetInstruction* NewInstruction(RV32Opcode opcode) {
  return TargetNewInstruction((TargetOpcode)opcode);
}

static TargetInstruction* Zero(RV32Generator* rv) {
  if (rv->zero == NULL) {
    rv->zero = Emit(rv, NewInstruction(RV32_OP(x0)));
  }
  return rv->zero;
}

static TargetInstruction* Tmp(RV32Generator* rv) {
  if (rv->tmp == NULL) {
    rv->tmp = Emit(rv, NewInstruction(RV32_OP(t0)));
  }
  return rv->tmp;
}

static COMPILER_UNUSED TargetInstruction* Tmp2(RV32Generator* rv) {
  if (rv->tmp2 == NULL) {
    rv->tmp2 = Emit(rv, NewInstruction(RV32_OP(t2)));
  }
  return rv->tmp2;
}

static TargetInstruction* IntArgumentRegister(RV32Generator* rv, int argnum) {
  if (rv->int_argument_registers[argnum] == NULL) {
    ...
    rv->int_argument_registers[argnum] =
        EmitSymbol(rv, NewInstruction(RV32_OP(a0) + argnum));
  }
  return rv->int_argument_registers[argnum];
}


static TargetInstruction* FloatingPointArgumentRegister(RV32Generator* rv,
                                                        int argnum) {
  if (rv->fp_argument_registers[argnum] == NULL) {
    // Allocate instruction for argument register and emit it.  The argument
    // registers have to be contiguous in value from a0..a7.
    rv->fp_argument_registers[argnum] =
        EmitSymbol(rv, NewInstruction(RV32_OP(fa0) + argnum));
  }
  return rv->fp_argument_registers[argnum];
}

static TargetInstruction* IntVariableRegister(RV32Generator* rv, int varnum, Symbol* sym) {
...
static TargetInstruction* FloatingPointVariableRegister(RV32Generator* rv, int varnum, Symbol* sym) {
  for (size_t i = 0; i < rv->var_regs.length; i++) {
    RegisterVariable* var = rv->var_regs.value.p[i];
    if (var->is_fp && var->varnum == varnum) {
      return var->inst;
...
static TargetInstruction* AddImmediate(RV32Generator* rv, TargetInstruction* src,
                                       int64_t immed) {
  int64_t imm = immed;
  if (immed < 0) {
    imm = -immed;
  ...
  if (imm <= 0x7ff) {
    return Emit(rv, NewInstruction2(RV32_OP(addi), src, immed_inst));
  }
  TargetInstruction* li = Emit(rv, NewInstruction1(RV32_OP(li), immed_inst));
...
static TargetInstruction* AddValue(RV32Generator* rv, TargetInstruction* src,
                                   TargetInstruction* value) {
  if (TargetIsConst(value)) {
    return AddImmediate(rv, src, TargetIntValue(value));
  }

  if (((int)value->opcode == (int)RV32_OP(x0))) {
    return src;
  }
  return Emit(rv, NewInstruction2(RV32_OP(add), src, value));
}

// Calculate the offset from the frame pointer to a local variable in the stack.
static int LocalVariableOffset(RV32Generator* rv, int32_t var_offset) {
  return var_offset - rv->base.stack_frame_size -
      RV32_STACK_FRAME_HEADER_SIZE;
}

static TargetInstruction* PagedOffsetFrom(RV32Generator* rv, TargetInstruction* src,
...
// offset from the src.
static TargetInstruction* OffsetFrom(RV32Generator* rv, TargetInstruction* src,
                                     int32_t offset) {
  bool offset_in_range = RV32IsPossibleImmediate(offset);
  if (offset_in_range) {
...
static TargetInstruction* LoadImmediate(RV32Generator* rv, RV32Opcode opcode,
                                          TargetInstruction* base, int32_t offset) {
  if (RV32IsPossibleImmediate(offset)) {
...
static TargetInstruction* StoreImmediate(RV32Generator* rv, RV32Opcode opcode,
...
static TargetInstruction* Memcpy(RV32Generator* rv, TargetInstruction* dest_addr,
  ...
  if (length <= 40) {
    ...
    for (int i = 0; i < num_words; i++, src_offset += 4, dest_offset += 4) {
      TargetInstruction* load = LoadImmediate(rv, RV32_OP(lw), src_addr, src_offset);
      result = StoreImmediate(rv, RV32_OP(sw), load, dest_addr, dest_offset);
    }
    for (int i = 0; i < num_bytes; i++, src_offset += 1, dest_offset += 1) {
      TargetInstruction* load = LoadImmediate(rv, RV32_OP(lb), src_addr, src_offset);
      result = StoreImmediate(rv, RV32_OP(sb), load, dest_addr, dest_offset);
    }
    if (count_as_call) {
      rv->base.num_calls--;
    }
  ...
  //    Emit(rv, NewInstruction2(RV32_OP(rmov), IntArgumentRegister(rv, 2), size));
  ...
  TargetInstruction* arg1 = SetDestOrMove(rv, src_addr, IntArgumentRegister(rv, 1),
                                           RV32_OP(mv));
      //Emit(
      //rv, NewInstruction2(RV32_OP(rmov), IntArgumentRegister(rv, 1), src_addr));
  ...
  TargetInstruction* arg0 = SetDestOrMove(rv, dest_addr, IntArgumentRegister(rv, 0),
                                          RV32_OP(mv));
      //Emit(
      //rv, NewInstruction2(RV32_OP(rmov), IntArgumentRegister(rv, 0), dest_addr));

  // We need to keep the arguments alive until the point of the call.  This
  // is done using a RV32_OP(regarg) instruction sequence.  See BuildArgList for
  // details on the regarg instruction.
  TargetInstruction* regarg =
      Emit(rv, NewInstruction2(RV32_OP(regarg), NULL, arg2));
  regarg = Emit(rv, NewInstruction2(RV32_OP(regarg), regarg, arg1));
  regarg = Emit(rv, NewInstruction2(RV32_OP(regarg), regarg, arg0));

  TargetInstruction* memcpy = GetSymbol(rv, NULL, rv->base.memcpy);
  return Emit(rv, NewInstruction2(RV32_OP(call), memcpy, regarg));
}

static TargetInstruction* Memzero(RV32Generator* rv, TargetInstruction* dest_addr,
  ...
  if (length <= 40) {
    ...
    for (int i = 0; i < num_words; i++, offset += 4) {
      result = StoreImmediate(rv, RV32_OP(sw), Zero(rv), dest_addr, offset);
    }
    for (int i = 0; i < num_bytes; i++, offset += 1) {
      result = StoreImmediate(rv, RV32_OP(sb), Zero(rv), dest_addr, offset);
    }
    rv->base.num_calls--;
    return result;
  }
  ...
  TargetInstruction* size = Emit(
      rv, NewInstruction1(RV32_OP(li),
                          GetIntConstant(rv, NULL, kTargetType32Bit, length)));
  TargetInstruction* arg2 = SetDestOrMove(rv, size, IntArgumentRegister(rv, 2), RV32_OP(mv));
  //TargetInstruction* arg2 =
  //    Emit(rv, NewInstruction2(RV32_OP(rmov), IntArgumentRegister(rv, 2), size));

  // Second arg is zero.
  TargetInstruction* arg1 = Emit(
      rv, NewInstruction1(RV32_OP(mv), Zero(rv)));
  ...
  TargetInstruction* arg0 = SetDestOrMove(rv, dest_addr, IntArgumentRegister(rv, 0), RV32_OP(mv));
  ...
  return Emit(rv, NewInstruction2(RV32_OP(call), memset, regarg));
}

static RV32Opcode IR2RV(IROpcode op) {
  switch (op) {
    case IR_OP(addi):
      return RV32_OP(add);
    case IR_OP(addf):
      return RV32_OP(fadd_s);
    case IR_OP(addd):
      return RV32_OP(fadd_d);
    case IR_OP(adda):
      return RV32_OP(add);
    ...
    case IR_OP(subi):
      return RV32_OP(sub);
    case IR_OP(subf):
      return RV32_OP(fsub_s);
    case IR_OP(subd):
      return RV32_OP(fsub_d);
    case IR_OP(suba):
      return RV32_OP(sub);
    ...
    case IR_OP(muli):
      return RV32_OP(mul);
    case IR_OP(mulf):
      return RV32_OP(fmul_s);
    case IR_OP(muld):
      return RV32_OP(fmul_d);

    case IR_OP(divi):
      return RV32_OP(div);
    case IR_OP(divf):
      return RV32_OP(fdiv_s);
    case IR_OP(divd):
      return RV32_OP(fdiv_d);
    ...
    case IR_OP(negi):
      return RV32_OP(neg);
    case IR_OP(negf):
      return RV32_OP(fneg_s);
    case IR_OP(negd):
      return RV32_OP(fneg_d);

    case IR_OP(i2f):
      return RV32_OP(fcvt_s_w);
    case IR_OP(i2d):
      return RV32_OP(fcvt_d_w);
    case IR_OP(f2d):
      return RV32_OP(fcvt_d_s);
    case IR_OP(d2f):
      return RV32_OP(fcvt_s_d);
    case IR_OP(f2i):
      return RV32_OP(fcvt_w_s);
    case IR_OP(d2i):
      return RV32_OP(fcvt_w_d);

    case IR_OP(movi):
      return RV32_OP(mv);
    case IR_OP(movf):
      return RV32_OP(fmv_s);
    case IR_OP(movd):
      return RV32_OP(fmv_d);
    case IR_OP(mova):
      return RV32_OP(mv);
//    case IR_OP(rmovi):
//      return RV32_OP(rmov);
//    case IR_OP(rmovf):
//      return RV32_OP(rmovf);
//    case IR_OP(rmovd):
//      return RV32_OP(rmovd);
//    case IR_OP(rmova):
//      return RV32_OP(rmov);
    case IR_OP(tmp):
      return RV32_OP(tmp);
...
static int MaxIntRegisterVariables(RV32Generator* rv) {
  bool is_leaf = rv->base.num_calls == 0 && OptLevel1() && !rv->not_leaf;
  if (is_leaf) {
    return RV32_LAST_LEAF_INT_REG_VAR - RV32_FIRST_LEAF_INT_REG_VAR + 1;
  }
  return RV32_LAST_INT_REG_VAR - RV32_FIRST_INT_REG_VAR + 1;
}

static int MaxFpRegisterVariables(RV32Generator* rv) {
  bool is_leaf = rv->base.num_calls == 0 && OptLevel1() && !rv->not_leaf;
  if (is_leaf) {
    return RV32_LAST_LEAF_FP_REG_VAR - RV32_FIRST_LEAF_FP_REG_VAR + 1;
  }
  return RV32_LAST_FP_REG_VAR - RV32_FIRST_FP_REG_VAR + 1;
}

static bool UseRegisterForVariable(RV32Generator* rv, IRNode* var_node) {
  if (OptLevel0()) {
...
static TargetInstruction* LoadStaticVariableAddress(RV32Generator* rv,
                                                    IRNode* node) {
  ...
  RV32Opcode opcode = var->symbol->flags.is_local ? RV32_OP(lla) : RV32_OP(la);
...
static struct {
  ...
  RV32Opcode load;
    ...
    {TypeIsInt, RV32_OP(lw)},
    {TypeIsShort, RV32_OP(lh)},
    {TypeIsChar8, RV32_OP(lbu)},
    {TypeIsChar, RV32_OP(lb)},
    {TypeIsLong, RV32_OP(lw)},
    {TypeIsLongLong, RV32_OP(lw)},
    {TypeIsUnsignedInt, RV32_OP(lw)},
    {TypeIsUnsignedShort, RV32_OP(lhu)},
    {TypeIsUnsignedChar, RV32_OP(lbu)},
    {TypeUsesFloat32Representation, RV32_OP(flw)},
    {RV32FpIsDoubleWidth, RV32_OP(fld)},
    {TypeIsBool, RV32_OP(lb)},
    {TypeIsPointerOrArray, RV32_OP(lw)},
    {TypeIsFunction, RV32_OP(lw)},
    {NULL, 0},
};

static TargetInstruction* FinishWithDest(RV32Generator* rv, IRNode* node,
                                         TargetInstruction* result,
                                         RV32Opcode mov_opcode);

static COMPILER_UNUSED TargetInstruction* LoadVariableValue(RV32Generator* rv, IRNode* node,
                                            TargetInstruction* addr,
                                            TargetInstruction* offset) {
  RV32Opcode opcode = RV32_OP(lw);
...
static TargetInstruction* TlsGetAddrCall(RV32Generator* rv, IRNode* node) {
  IRVariable* variable = (IRVariable*)node;
  TargetInstruction* symbol = GetSymbol(rv, node, variable->symbol);
  TargetInstruction* index =
      Emit(rv, NewInstruction1(RV32_OP(tlsgd), symbol));
  rv->not_leaf = true;
  rv->base.num_calls++;
  TargetInstruction* arg0 =
      SetDestOrMove(rv, index, IntArgumentRegister(rv, 0), RV32_OP(mv));
  TargetInstruction* regarg =
      Emit(rv, NewInstruction2(RV32_OP(regarg), NULL, arg0));
  TargetInstruction* fn = GetSymbol(rv, NULL, rv->base.__tls_get_addr);
  return Emit(rv, NewInstruction2(RV32_OP(call), fn, regarg));
}

static TargetInstruction* GetTlsVariableAddress(RV32Generator* rv,
                                                IRNode* node) {
  ...
  IRVariable* variable = (IRVariable*)node;
  TargetInstruction* symbol = GetSymbol(rv, node, variable->symbol);
  return Emit(rv, NewInstruction1(RV32_OP(tprel), symbol));
}

static TargetInstruction* MaterializeDoubleConstantBits(RV32Generator* rv,
                                                        uint64_t bits) {
  TargetInstruction* lo = Emit(rv, NewInstruction1(
      RV32_OP(li), GetIntConstant(rv, NULL, kTargetType32Bit,
                                  (int32_t)(uint32_t)bits)));
  TargetInstruction* hi = Emit(rv, NewInstruction1(
      RV32_OP(li), GetIntConstant(rv, NULL, kTargetType32Bit,
  ...
  Emit(rv, NewInstruction3(
               RV32_OP(sw), lo, StackPointer(rv),
               GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
  Emit(rv, NewInstruction3(
               RV32_OP(sw), hi, StackPointer(rv),
               GetIntConstant(rv, NULL, kTargetType32Bit, 4)));
  TargetInstruction* result = Emit(rv, NewInstruction2(
      RV32_OP(fld), StackPointer(rv),
      GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
...
static TargetInstruction* Materialize(RV32Generator* rv, IRNode* node) {
    ...
    switch (node->opcode) {
      ...
      case IR_OP(consta):
        if (IRIsZero(node)) {
          ...
          //return Emit(rv, NewInstruction1(RV32_OP(mv), Zero(rv)));
          return Zero(rv);
        } else {
          return Emit(rv, NewInstruction1(RV32_OP(li), GetLoweredNode(node)));
        }
      case IR_OP(constf): {
        ...
        return Emit(rv, NewInstruction1(RV32_OP(fmv_w_x), c));
      }
      case IR_OP(constd): {
  ...
  if (IRIsAutoVariable(node)) {
    ...
    if (TypeIsVLA(node->type)) {
      ...
      if (RV32_IS_REG_VAR(var_offset)) {
        // Variable is in a register.
        int var_num = var_offset & ~RV32_REG_VAR;
...
static TargetInstruction* MaterializeIntConstantToTmp(RV32Generator* rv,
                                                      IRConstant* constant) {
  return Emit(
      rv, NewInstruction1(
              RV32_OP(li),
...
static void ApplyFixups(RV32Generator* rv, IRNode* label_node) {
...
static TargetInstruction* MultiplyByConstant(RV32Generator* rv,
                               IRNode* variable,
                               IRConstant* constant) {
  ...
  while (value != 0) {
    if ((value & 1) == 1) {
      ...
      if (bitpos == 0) {
       ...
       inst =
           Emit(rv, NewInstruction2(RV32_OP(slli), input,
      ...
      if (left != NULL && right != NULL) {
        ...
        inst = Emit(rv, NewInstruction2(RV32_OP(add), left, right));
...
static TargetInstruction* LowerWideExpression(RV32Generator* rv, IRNode* node);
static TargetInstruction* LowerWideLoad(RV32Generator* rv, IRNode* node);
static TargetInstruction* LowerWideStore(RV32Generator* rv, IRNode* node);
static void MaterializeWide(RV32Generator* rv, IRNode* node,
                            TargetInstruction** lo, TargetInstruction** hi);
static TargetInstruction* LowerWideIntToFP(RV32Generator* rv, IRNode* node);
static TargetInstruction* LowerFPToWideInt(RV32Generator* rv, IRNode* node);

static TargetInstruction* LowerExpression(RV32Generator* rv, IRNode* node) {
  // If we have already lowered the IR node, return it.
  if (node->data.ptr != NULL) {
    return node->data.ptr;
  }
  RV32Opcode opcode = IR2RV(node->opcode);
  if ((node->opcode == IR_OP(i2f) || node->opcode == IR_OP(i2d)) &&
      TypeIsUnsigned(((IRNode*)node->inputs.value.p[0])->type)) {
    opcode = node->opcode == IR_OP(i2f) ? RV32_OP(fcvt_s_wu)
                                        : RV32_OP(fcvt_d_wu);
  } else if ((node->opcode == IR_OP(f2i) || node->opcode == IR_OP(d2i)) &&
             TypeIsUnsigned(node->type)) {
    opcode = node->opcode == IR_OP(f2i) ? RV32_OP(fcvt_wu_s)
                                        : RV32_OP(fcvt_wu_d);
  }
  if (node->opcode == IR_OP(tmp) && TypeIsWideInt(node->type)) {
    TargetInstruction* marker = Emit(rv, NewInstruction(RV32_OP(tmp)));
  ...
  switch (opcode) {
    ...
    case RV32_OP(add): {
      ...
      if (IRIsConst(op2)) {
        ...
        if (RV32IsPossibleImmediate(c)) {
          inst = (TargetInstruction*)NewInstruction(RV32_OP(addi));
    ...
    case RV32_OP(rem): {
      ...
      if (IRIsConst(op2)) {
        ...
        if (TypeIsUnsigned(node->type) && IsPowerOf2(c) && c < 64) {
          int64_t mask = c - 1;
          inst =
                 NewInstruction2(RV32_OP(andi), Materialize(rv, op1),
    ...
    case RV32_OP(and): {
      ...
      if (IRIsConst(op2)) {
        ...
        if (c == 0) {
          ...
          inst = Zero(rv);
        } else if (RV32IsPossibleImmediate(c)) {
          inst = (TargetInstruction*)NewInstruction(RV32_OP(andi));
          inst->operand[0] = Materialize(rv, op1);
          inst->operand[1] = GetLoweredNode(op2);
        } else {
          inst = NewInstruction2(RV32_OP(and), Materialize(rv, op1),
        ...
        if (c == 0) {
          ...
          inst = NewInstruction2(RV32_OP(and), Materialize(rv, op2),
                                 MaterializeIntConstantToTmp(rv,
                                                            (IRConstant*)op1));
        }
      }
    ...
    case RV32_OP(or): {
      ...
      if (IRIsConst(op2)) {
        ...
        if (c == 0) {
          ...
          inst = (TargetInstruction*)NewInstruction(RV32_OP(ori));
          inst->operand[0] = Materialize(rv, op1);
          inst->operand[1] = GetLoweredNode(op2);
        } else {
          inst = NewInstruction2(RV32_OP(or), Materialize(rv, op1),
                                 MaterializeIntConstantToTmp(rv,
                                                            (IRConstant*)op2));
        }
      } else if (IRIsConst(op1)) {
        ...
        if (c == 0) {
          ...
          inst = NewInstruction2(RV32_OP(or), Materialize(rv, op2),
                                 MaterializeIntConstantToTmp(rv,
                                                            (IRConstant*)op1));
        }
      }
  ...
  // RISC-V32 has distinct signed/unsigned divide and remainder instructions, but
  ...
  if (TypeIsUnsigned(node->type)) {
    if (opcode == RV32_OP(div)) {
      opcode = RV32_OP(divu);
    } else if (opcode == RV32_OP(rem)) {
      opcode = RV32_OP(remu);
    }
  }
  if (inst == NULL) {
  ...
  if ((RV32Opcode)inst->opcode == RV32_OP(tmp) && TypeUsesHardwareFloatRegister(node->type)) {
    inst->flags |= RV32_INST_FLOAT_TMP;
  }
  RV32Opcode mov_opcode = RV32_OP(mv);
  if (TypeUsesHardwareFloatRegister(node->type)) {
    mov_opcode = RV32FpIsDoubleWidth(node->type) ? RV32_OP(fmv_d) : RV32_OP(fmv_s);
  }
  return FinishWithDest(rv, node, inst, mov_opcode);
}

static COMPILER_UNUSED TargetInstruction* LowerRmov(RV32Generator* rv, IRNode* node) {
...
static TargetInstruction* GetDestInstruction(RV32Generator* rv, IRNode* node) {
  if (node->dest == NULL) {
    return NULL;
  }
...
static TargetInstruction* SubtractForComparison(RV32Generator* rv, IRNode* node,
  ...
  if (TypeIsWideInt(op1->type) || TypeIsWideInt(op2->type)) {
    ...
    if (IRIsConst(op2) && ((IRConstant*)op2)->value.ivalue == 0) {
      return Emit(rv, NewInstruction2(RV32_OP(or), alo, ahi));
    }
    MaterializeWide(rv, op2, &blo, &bhi);
    TargetInstruction* xlo =
        Emit(rv, NewInstruction2(RV32_OP(xor), alo, blo));
    TargetInstruction* xhi =
        Emit(rv, NewInstruction2(RV32_OP(xor), ahi, bhi));
    return Emit(rv, NewInstruction2(RV32_OP(or), xlo, xhi));
  }
  if (!IRIsConst(op2)) {
    // Second operand isn't constant, compiled as sub.
    return Emit(rv, NewInstruction2(RV32_OP(sub), Materialize(rv, op1),
                                    Materialize(rv, op2)));
  }
  ...
  if (RV32IsPossibleImmediate(value)) {
...
// instructions.
static TargetInstruction* CompareLessThanInt(RV32Generator* rv, IRNode* node,
                                             IRNode* op1, IRNode* op2) {
  ...
  if (TypeIsWideInt(op1->type) || TypeIsWideInt(op2->type)) {
    ...
    MaterializeWide(rv, op1, &alo, &ahi);
    MaterializeWide(rv, op2, &blo, &bhi);
    TargetInstruction* hi_lt = Emit(
        rv, NewInstruction2(is_unsigned ? RV32_OP(sltu) : RV32_OP(slt), ahi,
                            bhi));
    TargetInstruction* hi_ne =
        Emit(rv, NewInstruction2(RV32_OP(xor), ahi, bhi));
    hi_ne = Emit(rv, NewInstruction1(RV32_OP(snez), hi_ne));
    TargetInstruction* lo_lt =
        Emit(rv, NewInstruction2(RV32_OP(sltu), alo, blo));
    TargetInstruction* hi_eq =
        Emit(rv, NewInstruction1(RV32_OP(seqz), hi_ne));
    TargetInstruction* from_hi =
        Emit(rv, NewInstruction2(RV32_OP(and), hi_lt, hi_ne));
    TargetInstruction* from_lo =
        Emit(rv, NewInstruction2(RV32_OP(and), lo_lt, hi_eq));
    return Emit(rv, NewInstruction2(RV32_OP(or), from_hi, from_lo));
  }
  if (!IRIsConst(op2)) {
    ...
    return Emit(rv, NewInstruction2(is_unsigned ? RV32_OP(sltu) : RV32_OP(slt), i1,
                                    i2));
  }
  ...
  if (!is_unsigned && value == 0) {
    ...
    return Emit(rv, NewInstruction1(RV32_OP(sltz), Materialize(rv, op1)));
  }

  if (RV32IsPossibleImmediate(value)) {
    // Immediate, use slti/sltiu.
    return Emit(
        rv, NewInstruction2(is_unsigned ? RV32_OP(sltiu) : RV32_OP(slti),
                            Materialize(rv, op1),
  ...
  return Emit(rv, NewInstruction2(is_unsigned ? RV32_OP(sltu) : RV32_OP(slt),
                                  Materialize(rv, op1),
                                  Materialize(rv, op2)));
}
...
static TargetInstruction* LowerComparison(RV32Generator* rv, IRNode* node) {
  assert(node->inputs.length == 2);
  IRNode* op1 = node->inputs.value.p[0];
  IRNode* op2 = node->inputs.value.p[1];
  switch (node->opcode) {
    ...
    case IR_OP(cmpeqa): {
      ...
      if (sub == NULL) {
        return Emit(
            rv, SetLoweredNode(
                    node, NewInstruction1(RV32_OP(seqz), Materialize(rv, op1))));
      } else {
        return Emit(rv,
                    SetLoweredNode(node, NewInstruction1(RV32_OP(seqz), sub)));
      }
    }
    case IR_OP(cmpnei):
    case IR_OP(cmpnea): {
      ...
      if (sub == NULL) {
        return Emit(
            rv, SetLoweredNode(
                    node, NewInstruction1(RV32_OP(snez), Materialize(rv, op1))));
      } else {
        return Emit(rv,
                    SetLoweredNode(node, NewInstruction1(RV32_OP(snez), sub)));
      }
    }
    case IR_OP(cmplti):
    case IR_OP(cmplta):
    ...
    case IR_OP(cmplea): {
      ...
      return Emit(rv, SetLoweredNode(node, NewInstruction1(RV32_OP(seqz), slt)));
    }
    ...
    case IR_OP(cmpeqf):
      ...
      return Emit(
          rv, SetLoweredNode(node,
                             NewInstruction2(RV32_OP(feq_s), Materialize(rv, op1),
                                             Materialize(rv, op2))));
    ...
    case IR_OP(cmpnef): {
      ...
      TargetInstruction* cmp =
          Emit(rv, NewInstruction2(RV32_OP(feq_s), Materialize(rv, op1),
                                   Materialize(rv, op2)));
      return Emit(rv, SetLoweredNode(node, NewInstruction1(RV32_OP(seqz), cmp)));
    }
    ...
    case IR_OP(cmpltf):
      ...
      return Emit(
          rv, SetLoweredNode(node,
                             NewInstruction2(RV32_OP(flt_s), Materialize(rv, op1),
                                             Materialize(rv, op2))));
    case IR_OP(cmplef):
      // fle.s op1, op2
      return Emit(
          rv, SetLoweredNode(node,
                             NewInstruction2(RV32_OP(fle_s), Materialize(rv, op1),
                                             Materialize(rv, op2))));
    case IR_OP(cmpgtf):
      // flt.s op2, op1
      return Emit(
          rv, SetLoweredNode(node,
                             NewInstruction2(RV32_OP(flt_s), Materialize(rv, op2),
                                             Materialize(rv, op1))));
    case IR_OP(cmpgef):
      // fle.s op2, op1
      return Emit(
          rv, SetLoweredNode(node,
                             NewInstruction2(RV32_OP(fle_s), Materialize(rv, op2),
                                             Materialize(rv, op1))));
    ...
    case IR_OP(cmpeqd):
      ...
      return Emit(
          rv, SetLoweredNode(node,
                             NewInstruction2(RV32_OP(feq_d), Materialize(rv, op1),
                                             Materialize(rv, op2))));
    case IR_OP(cmpned): {
      // feq.d op1, op2
      // invert
      TargetInstruction* cmp =
          Emit(rv, NewInstruction2(RV32_OP(feq_d), Materialize(rv, op1),
                                   Materialize(rv, op2)));
      return Emit(rv, SetLoweredNode(node, NewInstruction1(RV32_OP(seqz), cmp)));
    }
    ...
    case IR_OP(cmpltd):
      ...
      return Emit(
          rv, SetLoweredNode(node,
                             NewInstruction2(RV32_OP(flt_d), Materialize(rv, op1),
                                             Materialize(rv, op2))));
    case IR_OP(cmpled):
      // fle.d op1, op2
      return Emit(
          rv, SetLoweredNode(node,
                             NewInstruction2(RV32_OP(fle_d), Materialize(rv, op1),
                                             Materialize(rv, op2))));
    case IR_OP(cmpgtd):
      // flt.d op2, op1
      return Emit(
          rv, SetLoweredNode(node,
                             NewInstruction2(RV32_OP(flt_d), Materialize(rv, op2),
                                             Materialize(rv, op1))));
    case IR_OP(cmpged):
      // fle.d op2, op1
      return Emit(
          rv, SetLoweredNode(node,
                             NewInstruction2(RV32_OP(fle_d), Materialize(rv, op2),
                                             Materialize(rv, op1))));
    default:
      assert(false);
  }
...
static TargetInstruction* LowerThreeWay(RV32Generator* rv, IRNode* node) {
  assert(node->inputs.length == 2);
  ...
  if (is_float || is_double) {
    RV32Opcode flt = is_double ? RV32_OP(flt_d) : RV32_OP(flt_s);
    RV32Opcode feq = is_double ? RV32_OP(feq_d) : RV32_OP(feq_s);
    ...
    TargetInstruction* diff = Emit(rv, NewInstruction2(RV32_OP(sub), gt, lt));
    TargetInstruction* aord = Emit(rv, NewInstruction2(feq, ma, ma));
    TargetInstruction* bord = Emit(rv, NewInstruction2(feq, mb, mb));
    TargetInstruction* both = Emit(rv, NewInstruction2(RV32_OP(and), aord, bord));
    TargetInstruction* unord = Emit(rv, NewInstruction1(RV32_OP(seqz), both));
    TargetInstruction* twice = Emit(rv, NewInstruction2(RV32_OP(add), unord, unord));
    return SetLoweredNode(node, Emit(rv, NewInstruction2(RV32_OP(add), diff,
                                                         twice)));
  }
  ...
  return SetLoweredNode(node, Emit(rv, NewInstruction2(RV32_OP(sub), gt, lt)));
}

static void GetAddressAndOffsetFrom(RV32Generator* rv,
                                 TargetInstruction* addr,
                                 int offset,
...
static bool GetRegAndOffset(RV32Generator* rv, IRNode* addr_node,
                            TargetInstruction** addr,
                            TargetInstruction** offset) {
  if (IRIsThreadVariable(addr_node)) {
    ...
    *offset = Zero(rv);
    ...
    if ((addr_node->flags & kIRNrvoMarker) != 0) {
      // NRVO variable.
      int reg = addr_node->data.ivalue & ~RV32_REG_VAR;
...
static TargetInstruction* Load(RV32Generator* rv, IRNode* addr_node, RV32Opcode opcode) {
  TargetInstruction* addr;
  TargetInstruction* offset;
  ...
  if (!on_stack) {
    if (TypeUsesHardwareFloatRegister(addr_node->type)) {
      return Emit(rv, NewInstruction1(RV32FpIsDoubleWidth(addr_node->type) ?
                                      RV32_OP(fmv_d) : RV32_OP(fmv_s), addr));
    }
    return Emit(rv, NewInstruction1(RV32_OP(mv), addr));
  }
...
static TargetInstruction* WideMov(RV32Generator* rv, TargetInstruction* src) {
  return Emit(rv, NewInstruction1(RV32_OP(mv), src));
}
...
static void MaterializeWide(RV32Generator* rv, IRNode* node,
  ...
  if (IRIsConst(node)) {
    ...
    *lo = Emit(rv, NewInstruction1(
        RV32_OP(li), GetIntConstant(rv, NULL, kTargetType32Bit,
                                    (int32_t)(uint32_t)v)));
    *hi = Emit(rv, NewInstruction1(
        RV32_OP(li), GetIntConstant(rv, NULL, kTargetType32Bit,
...
static TargetInstruction* LowerWideIntToFP(RV32Generator* rv, IRNode* node) {
  ...
  TargetInstruction* high = Emit(rv, NewInstruction1(
      TypeIsUnsigned(((IRNode*)node->inputs.value.p[0])->type)
          ? RV32_OP(fcvt_d_wu)
          : RV32_OP(fcvt_d_w),
      hi));
  ...
  high = Emit(rv, NewInstruction2(RV32_OP(fmul_d), high, scale));
  TargetInstruction* low =
      Emit(rv, NewInstruction1(RV32_OP(fcvt_d_wu), lo));
  TargetInstruction* result =
      Emit(rv, NewInstruction2(RV32_OP(fadd_d), high, low));
  if (node->opcode == IR_OP(i2f)) {
    result = Emit(rv, NewInstruction1(RV32_OP(fcvt_s_d), result));
  }
  return SetLoweredNode(node, result);
}
...
static TargetInstruction* LowerFPToWideInt(RV32Generator* rv, IRNode* node) {
  ...
  if (node->opcode == IR_OP(f2i)) {
    value = Emit(rv, NewInstruction1(RV32_OP(fcvt_d_s), value));
  }
  TargetInstruction* arg0 = SetDestOrMove(
      rv, value, FloatingPointArgumentRegister(rv, 0), RV32_OP(fmv_d));
  TargetInstruction* regarg =
      Emit(rv, NewInstruction2(RV32_OP(regarg), NULL, arg0));
  TargetInstruction* sym =
      GetSymbol(rv, NULL,
                GetLibcallSymbol(TypeIsUnsigned(node->type)
                                     ? "__davecc_double_to_u64"
                                     : "__davecc_double_to_i64"));
  TargetInstruction* call =
      Emit(rv, NewInstruction2(RV32_OP(call), sym, regarg));
  rv->not_leaf = true;
  rv->base.num_calls++;

  TargetInstruction* hi =
      Emit(rv, NewInstruction1(RV32_OP(mv), IntArgumentRegister(rv, 1)));
  TargetInstruction* lo = Emit(rv, NewInstruction1(RV32_OP(mv), call));
  PairWideHalves(lo, hi);
  SetLoweredHi(node, hi);
  return SetLoweredNode(node, lo);
}

static TargetInstruction* WideLibCall(RV32Generator* rv, IRNode* node,
                                      const char* name) {
  IRNode* a = node->inputs.value.p[0];
  IRNode* b = node->inputs.value.p[1];
  TargetInstruction *alo, *ahi, *blo, *bhi;
  ...
  TargetInstruction* arg0 =
      SetDestOrMove(rv, alo, IntArgumentRegister(rv, 0), RV32_OP(mv));
  TargetInstruction* arg1 =
      SetDestOrMove(rv, ahi, IntArgumentRegister(rv, 1), RV32_OP(mv));
  TargetInstruction* arg2 =
      SetDestOrMove(rv, blo, IntArgumentRegister(rv, 2), RV32_OP(mv));
  TargetInstruction* arg3 =
      SetDestOrMove(rv, bhi, IntArgumentRegister(rv, 3), RV32_OP(mv));

  TargetInstruction* regarg =
      Emit(rv, NewInstruction2(RV32_OP(regarg), NULL, arg3));
  regarg = Emit(rv, NewInstruction2(RV32_OP(regarg), regarg, arg2));
  regarg = Emit(rv, NewInstruction2(RV32_OP(regarg), regarg, arg1));
  regarg = Emit(rv, NewInstruction2(RV32_OP(regarg), regarg, arg0));

  TargetInstruction* sym = GetSymbol(rv, NULL, GetLibcallSymbol(name));
  TargetInstruction* call = Emit(rv, NewInstruction2(RV32_OP(call), sym, regarg));
  rv->not_leaf = true;
  rv->base.num_calls++;

  TargetInstruction* a1 = IntArgumentRegister(rv, 1);
  TargetInstruction* hi = Emit(rv, NewInstruction1(RV32_OP(mv), a1));
  TargetInstruction* lo = Emit(rv, NewInstruction1(RV32_OP(mv), call));
  PairWideHalves(lo, hi);
  SetLoweredHi(node, hi);
  return SetLoweredNode(node, lo);
...
static TargetInstruction* WideLibCallShift(RV32Generator* rv, IRNode* node,
                                           const char* name) {
  IRNode* a = node->inputs.value.p[0];
  IRNode* b = node->inputs.value.p[1];
  ...
  TargetInstruction* arg1 =
      SetDestOrMove(rv, ahi, IntArgumentRegister(rv, 1), RV32_OP(mv));
  TargetInstruction* arg2 =
      SetDestOrMove(rv, amount, IntArgumentRegister(rv, 2), RV32_OP(mv));
...
static TargetInstruction* LowerWideExpression(RV32Generator* rv, IRNode* node) {
  ...
  switch (node->opcode) {
    ...
    case IR_OP(addi): {
      ...
      lo = Emit(rv, NewInstruction2(RV32_OP(add), alo, blo));
      TargetInstruction* carry =
          Emit(rv, NewInstruction2(RV32_OP(sltu), lo, alo));
      hi = Emit(rv, NewInstruction2(RV32_OP(add), ahi, bhi));
      hi = Emit(rv, NewInstruction2(RV32_OP(add), hi, carry));
      break;
    }
    ...
    case IR_OP(subi): {
      ...
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      MaterializeWide(rv, node->inputs.value.p[1], &blo, &bhi);
      lo = Emit(rv, NewInstruction2(RV32_OP(sub), alo, blo));
      TargetInstruction* borrow =
          Emit(rv, NewInstruction2(RV32_OP(sltu), alo, blo));
      hi = Emit(rv, NewInstruction2(RV32_OP(sub), ahi, bhi));
      hi = Emit(rv, NewInstruction2(RV32_OP(sub), hi, borrow));
      break;
    }
    ...
    case IR_OP(ori):
    case IR_OP(xori): {
      RV32Opcode op = node->opcode == IR_OP(andi)   ? RV32_OP(and)
                      : node->opcode == IR_OP(ori)  ? RV32_OP(or)
                                                    : RV32_OP(xor);
      TargetInstruction *alo, *ahi, *blo, *bhi;
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      MaterializeWide(rv, node->inputs.value.p[1], &blo, &bhi);
    ...
    case IR_OP(muli): {
      ...
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      MaterializeWide(rv, node->inputs.value.p[1], &blo, &bhi);
      lo = Emit(rv, NewInstruction2(RV32_OP(mul), alo, blo));
      hi = Emit(rv, NewInstruction2(RV32_OP(mulhu), alo, blo));
      TargetInstruction* t1 =
          Emit(rv, NewInstruction2(RV32_OP(mul), alo, bhi));
      hi = Emit(rv, NewInstruction2(RV32_OP(add), hi, t1));
      TargetInstruction* t2 =
          Emit(rv, NewInstruction2(RV32_OP(mul), ahi, blo));
      hi = Emit(rv, NewInstruction2(RV32_OP(add), hi, t2));
      break;
    }

    case IR_OP(divi):
      return WideLibCall(
          rv, node, TypeIsUnsigned(node->type) ? "__udivdi3" : "__divdi3");

    case IR_OP(modi):
      return WideLibCall(
          rv, node, TypeIsUnsigned(node->type) ? "__umoddi3" : "__moddi3");

    case IR_OP(onescomp): {
      TargetInstruction *alo, *ahi;
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      lo = Emit(rv, NewInstruction1(RV32_OP(not), alo));
      hi = Emit(rv, NewInstruction1(RV32_OP(not), ahi));
      break;
    }
    ...
    case IR_OP(negi): {
      TargetInstruction *alo, *ahi;
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      TargetInstruction* nlo = Emit(rv, NewInstruction1(RV32_OP(not), alo));
      TargetInstruction* nhi = Emit(rv, NewInstruction1(RV32_OP(not), ahi));
      TargetInstruction* one =
          GetIntConstant(rv, NULL, kTargetType32Bit, 1);
      lo = Emit(rv, NewInstruction2(RV32_OP(addi), nlo, one));
      TargetInstruction* carry =
          Emit(rv, NewInstruction2(RV32_OP(sltu), lo, nlo));
      hi = Emit(rv, NewInstruction2(RV32_OP(add), nhi, carry));
      break;
    }
      ...
      if (n == 0) {
        ...
        if (n < 32) {
          ...
          TargetInstruction* hi_hi =
              Emit(rv, NewInstruction2(RV32_OP(slli), ahi, nconst));
          TargetInstruction* hi_lo =
              Emit(rv, NewInstruction2(RV32_OP(srli), alo, ncross));
          hi = Emit(rv, NewInstruction2(RV32_OP(or), hi_hi, hi_lo));
          lo = Emit(rv, NewInstruction2(RV32_OP(slli), alo, nconst));
        } else {
          hi = (n == 32)
                   ? WideMov(rv, alo)
        ...
        RV32Opcode high_op = (op == IR_OP(asri)) ? RV32_OP(srai) : RV32_OP(srli);
        if (n < 32) {
          TargetInstruction* nconst =
              GetIntConstant(rv, NULL, kTargetType32Bit, n);
          TargetInstruction* ncross =
          ...
          TargetInstruction* lo_lo =
              Emit(rv, NewInstruction2(RV32_OP(srli), alo, nconst));
          TargetInstruction* lo_hi =
              Emit(rv, NewInstruction2(RV32_OP(slli), ahi, ncross));
          lo = Emit(rv, NewInstruction2(RV32_OP(or), lo_lo, lo_hi));
...
static TargetInstruction* LowerWideLoad(RV32Generator* rv, IRNode* node) {
  ...
  if (!on_stack) {
    ...
    lo = Emit(rv, NewInstruction2(RV32_OP(lw), addr, offset));
    TargetInstruction* offset_hi =
        GetIntConstant(rv, NULL, kTargetType32Bit, off + 4);
    hi = Emit(rv, NewInstruction2(RV32_OP(lw), addr, offset_hi));
    PairWideHalves(lo, hi);
  }
  SetLoweredHi(node, hi);
  return SetLoweredNode(node, lo);
...
static TargetInstruction* LowerWideStore(RV32Generator* rv, IRNode* node) {
  ...
  bool on_stack = GetRegAndOffset(rv, addr_node, &addr, &offset);
  if (!on_stack) {
    TargetInstruction* result = SetDestOrMove(rv, src_lo, addr, RV32_OP(mv));
  ...
  TargetInstruction* low_store =
      Emit(rv, NewInstruction3(RV32_OP(sw), src_lo, addr, offset));
  TargetInstruction* offset_hi =
      GetIntConstant(rv, NULL, kTargetType32Bit, off + 4);
  Emit(rv, NewInstruction3(RV32_OP(sw), src_hi, addr, offset_hi));
  return SetLoweredNode(node, low_store);
}

static TargetInstruction* LowerLoad(RV32Generator* rv, IRNode* node) {
  RV32Opcode opcode;
...
// register.
static int StoreWidth(RV32Opcode opcode) {
  switch (opcode) {
    case RV32_OP(sb):
      return 1;
    case RV32_OP(sh):
...
static TargetInstruction* NarrowToStoreWidth(RV32Generator* rv,
                                             TargetInstruction* value,
  ...
  if (TargetIsConst(value)) {
    ...
    return Emit(rv, NewInstruction1(RV32_OP(li),
                                    GetIntConstant(rv, NULL, kTargetType32Bit,
                                                   narrowed)));
  }
  ...
  TargetInstruction* left =
      Emit(rv, NewInstruction2(RV32_OP(slli), value, shift));
  return Emit(rv, NewInstruction2(is_signed ? RV32_OP(srai) : RV32_OP(srli), left,
                                  shift));
}
...
static TargetInstruction* LowerStore(RV32Generator* rv, IRNode* node) {
  RV32Opcode opcode;
  assert(node->inputs.length == 2);
...
static struct BranchInfo {
  ...
  RV32Opcode branch;  // Branch opcode.
  bool reverse;     // Reverse operands.
} branch_compare_ops[] = {
    {IR_OP(cmpeqi), true, RV32_OP(beq), false},
    {IR_OP(cmpnei), true, RV32_OP(bne), false},
    {IR_OP(cmplti), true, RV32_OP(blt), false},
    {IR_OP(cmplei), false, RV32_OP(blt), true},
    {IR_OP(cmpgti), true, RV32_OP(blt), true},
    {IR_OP(cmpgei), true, RV32_OP(bge), false},

    {IR_OP(cmpeqa), true, RV32_OP(beq), false},
    {IR_OP(cmpnea), true, RV32_OP(bne), false},
    {IR_OP(cmplta), true, RV32_OP(bltu), false},
    {IR_OP(cmplea), false, RV32_OP(bltu), true},
    {IR_OP(cmpgta), true, RV32_OP(bltu), true},
    {IR_OP(cmpgea), true, RV32_OP(bgeu), false},

    {IR_OP(cmpeqi), false, RV32_OP(bne), false},
    {IR_OP(cmpnei), false, RV32_OP(beq), false},
    {IR_OP(cmplti), false, RV32_OP(bge), false},
    {IR_OP(cmplei), true, RV32_OP(bge), true},
    {IR_OP(cmpgti), false, RV32_OP(bge), true},
    {IR_OP(cmpgei), false, RV32_OP(blt), false},

    {IR_OP(cmpeqa), false, RV32_OP(bne), false},
    {IR_OP(cmpnea), false, RV32_OP(beq), false},
    {IR_OP(cmplta), false, RV32_OP(bgeu), false},
    {IR_OP(cmplea), true, RV32_OP(bgeu), true},
    {IR_OP(cmpgta), false, RV32_OP(bgeu), true},
    {IR_OP(cmpgea), false, RV32_OP(bltu), false},
};

#define NUM_BRANCH_COMPARES \
  (sizeof(branch_compare_ops) / sizeof(branch_compare_ops[0]))

static TargetInstruction* LowerConditionalBranch(RV32Generator* rv,
                                                 IRNode* node) {
  assert(node->inputs.length == 2);
  ...
  // 64-bit compares cannot fold into a single beq/blt: those only see the
  // low register.  Leave the comparison materialized (xor/or or slt of both
  // halves) and branch on that 0/1 instead.
  if (branch_info != NULL && expr->inputs.length >= 2) {
    IRNode* lhs = expr->inputs.value.p[0];
    IRNode* rhs = expr->inputs.value.p[1];
    if (NodeIsWideInt(lhs) || NodeIsWideInt(rhs)) {
      branch_info = NULL;
    }
  }
  ...
  if (branch_info != NULL) {
    ...
    if ((IRIsZero(op1) || IRIsZero(op2)) &&
        (branch_info->branch == RV32_OP(beq) ||
         branch_info->branch == RV32_OP(bne))) {
      RV32Opcode branch =
          branch_info->branch == RV32_OP(beq) ? RV32_OP(beqz) : RV32_OP(bnez);
    ...
    RV32Opcode branch_opcode = branch_info->branch;
    if ((op1 != NULL && TypeIsUnsigned(op1->type)) ||
        (op2 != NULL && TypeIsUnsigned(op2->type))) {
      if (branch_opcode == RV32_OP(blt)) {
        branch_opcode = RV32_OP(bltu);
      } else if (branch_opcode == RV32_OP(bge)) {
        branch_opcode = RV32_OP(bgeu);
      }
    }
  ...
  if (OptLevel1() && IRIsConst(expr)) {
    ...
    if (value == 0) {
      ...
      if (opcode == RV32_OP(bnez)) {
        // bnez with zero operand means branch will never be taken.
        return Emit(rv, NewInstruction(RV32_OP(nop)));
      }
      // beqz with zero is unconditional.
      inst = Emit(rv, NewInstruction(RV32_OP(j)));
      target_operand_num = 0;
    } else {
      if (opcode == RV32_OP(beqz)) {
    ...
    TargetInstruction* cond;
    if (NodeIsWideInt(expr)) {
      TargetInstruction *lo, *hi;
      MaterializeWide(rv, expr, &lo, &hi);
      cond = Emit(rv, NewInstruction2(RV32_OP(or), lo, hi));
    } else {
      cond = Materialize(rv, expr);
    }
    inst = Emit(rv, NewInstruction1(opcode, cond));
  }
...
static TargetInstruction* LowerBranch(RV32Generator* rv, IRNode* node) {
  ...
  TargetInstruction* inst =
      (TargetInstruction*)Emit(rv, NewInstruction(RV32_OP(j)));
...
static TargetInstruction* LowerLabel(RV32Generator* rv, IRNode* label) {
  TargetInstruction* inst =  Emit(rv, NewInstruction(RV32_OP(label)));
  label->data.ptr = inst;
  ApplyFixups(rv, label);
  return inst;
}

static TargetInstruction* LowerNamedLabel(RV32Generator* rv, IRNode* label) {
...
static TargetInstruction* LowerResult(RV32Generator* rv, IRNode* node) {
  assert(node->inputs.length == 1);
  RV32Opcode result_reg_opcode, opcode;
  switch (node->opcode) {
    case IR_OP(resulti):
    case IR_OP(resulta):
      result_reg_opcode = RV32_OP(resulti);
      opcode = RV32_OP(mv);
      break;
    case IR_OP(resultf):
      result_reg_opcode = RV32_OP(resultf);
      opcode = RV32_OP(fmv_s);
      break;
    case IR_OP(resultd):
      result_reg_opcode = RV32_OP(resultd);
  ...
  if (node->opcode == IR_OP(resulti) &&
    ...
    TargetInstruction *lo, *hi;
    MaterializeWide(rv, node->inputs.value.p[0], &lo, &hi);
    TargetInstruction* a0 = EmitSymbol(rv, NewInstruction(RV32_OP(resulti)));
    SetDestOrMove(rv, lo, a0, RV32_OP(mv));
    TargetInstruction* a1 = IntArgumentRegister(rv, 1);
    return SetLoweredNode(node, SetDestOrMove(rv, hi, a1, RV32_OP(mv)));
  }
  TargetInstruction* result = Materialize(rv, node->inputs.value.p[0]);
...
static TargetInstruction* LowerAsm(RV32Generator* rv, IRNode* node) {
  ...
  if (asm_node == NULL ||
    ...
    TargetInstruction* result = Emit(rv, NewInstruction1(RV32_OP(asm), literal));

    SetLoweredNode(node, result);
    return result;
  }

  assert(asm_node->outputs.length + asm_node->inputs.length <= RV32_MAX_ASM_OPERANDS);
  RV32AsmInstruction* asm_inst = malloc(sizeof(RV32AsmInstruction));
  TargetInitInstruction(&asm_inst->base, (TargetOpcode)RV32_OP(asm));
  asm_inst->base.flags |= RV32_INST_EXTENDED_ASM;
  ...
  size_t ir_index = 1;
  int operand_index = 0;
  TargetInstruction* output_regs[RV32_MAX_ASM_OPERANDS] = {0};
  for (size_t i = 0; i < asm_node->outputs.length; i++, operand_index++) {
    ...
    asm_inst->reg_nums[operand_index] = RV32_INT_ARG_START + arg_reg;
    asm_inst->is_fp[operand_index] = false;
    output_regs[i] = reg;
    if (operand->is_readwrite) {
      TargetInstruction* loaded =
          Load(rv, addr_node, operand->expr->type->size <= 4 ? RV32_OP(lw) : RV32_OP(lw));
      SetDestOrMove(rv, loaded, reg, RV32_OP(mv));
    }
  }
  ...
  for (size_t i = 0; i < asm_node->inputs.length; i++, operand_index++) {
    ...
    TargetInstruction* reg = IntArgumentRegister(rv, arg_reg);
    asm_inst->reg_nums[operand_index] = RV32_INT_ARG_START + arg_reg;
    SetDestOrMove(rv, Materialize(rv, input_node), reg, RV32_OP(mv));
  }
...
static TargetInstruction* LowerLiteralReference(RV32Generator* rv, IRNode* node) {
  IRConstant* id_node = node->inputs.value.p[0];
  TargetInstruction* literal =
      Emit(rv, TargetNewLiteral((int)id_node->value.ivalue));

  TargetInstruction* result = Emit(rv, NewInstruction1(RV32_OP(lla), literal));
  ...
  return FinishWithDest(rv, node, result, RV32_OP(mv));
}

static TargetInstruction* LowerAddressOf(RV32Generator* rv, IRNode* node) {
  TargetInstruction* src = Materialize(rv, node->inputs.value.p[0]);
  if (RV32IsVarRegister(src)) {
    src = Emit(rv, NewInstruction1(RV32_OP(mv), src));
  }
  return SetLoweredNode(node, src);
}

static TargetInstruction* LowerZeroExtend(RV32Generator* rv, IRNode* node) {
  ...
  if (NodeIsWideInt(node)) {
    ...
    if (diff > 0 && diff < 32) {
      ...
      TargetInstruction* lsl =
          Emit(rv, NewInstruction2(RV32_OP(slli), value, immed));
      lo = Emit(rv, NewInstruction2(RV32_OP(srli), lsl, immed));
    }
  ...
  if (diff <= 0 || diff >= 32) {
    return FinishWithDest(rv, node, value, RV32_OP(mv));
  }
  TargetInstruction* immed = GetIntConstant(rv, NULL, kTargetType32Bit, diff);
  TargetInstruction* lsl =
      Emit(rv, NewInstruction2(RV32_OP(slli), value, immed));
  TargetInstruction* lsr =
      Emit(rv, NewInstruction2(RV32_OP(srli), lsl, immed));
  return FinishWithDest(rv, node, lsr, RV32_OP(mv));
}

static TargetInstruction* LowerInc(RV32Generator* rv, IRNode* node) {
  IRNode* addr_node = node->inputs.value.p[0];
  RV32Opcode ld_opcode;
  RV32Opcode st_opcode;
  switch (node->opcode) {
    case IR_OP(inc8):
      ld_opcode = RV32_OP(lb);
      st_opcode = RV32_OP(sb);
      break;
    case IR_OP(uinc8):
      ld_opcode = RV32_OP(lbu);
      st_opcode = RV32_OP(sb);
      break;
    case IR_OP(inc16):
      ld_opcode = RV32_OP(lh);
      st_opcode = RV32_OP(sh);
      break;
    case IR_OP(uinc16):
      ld_opcode = RV32_OP(lhu);
      st_opcode = RV32_OP(sh);
      break;
   case IR_OP(inc32):
      ld_opcode = RV32_OP(lw);
      st_opcode = RV32_OP(sw);
      break;
    case IR_OP(uinc32):
       ld_opcode = RV32_OP(lw);
       st_opcode = RV32_OP(sw);
    ...
    case IR_OP(inca):
     ...
     break;
    case IR_OP(incf):
      ld_opcode = RV32_OP(flw);
      st_opcode = RV32_OP(fsw);
     break;
    case IR_OP(incd):
      ld_opcode = RV32_OP(fld);
      st_opcode = RV32_OP(fsd);
     break;
    default:
      abort();
  }
  ...
  if (TypeUsesHardwareFloatRegister(node->type)) {
    inc =  Emit(rv, NewInstruction2(RV32FpIsDoubleWidth(node->type) ? RV32_OP(fadd_d) : RV32_OP(fadd_s), load, amount));
  } else  {
...
static TargetInstruction* LowerDec(RV32Generator* rv, IRNode* node) {
  IRNode* addr_node = node->inputs.value.p[0];
  RV32Opcode ld_opcode;
  RV32Opcode st_opcode;
  switch (node->opcode) {
  ...
  TargetInstruction* amount = GetLoweredNode(amount_node);
  if (TypeUsesHardwareFloatRegister(node->type)) {
    inc =  Emit(rv, NewInstruction2(RV32FpIsDoubleWidth(node->type) ? RV32_OP(fsub_d) : RV32_OP(fsub_s), load, amount));
  } else  {
    inc =  AddImmediate(rv, load, -RV32IntValue(amount));
  }
  Store(rv, addr_node, inc, st_opcode);
...
static TargetInstruction* LowerGetBitField(RV32Generator* rv, IRNode* node) {
  ...
  TargetInstruction* lsl = Emit(rv, NewInstruction2(RV32_OP(slli), value, GetIntConstant(rv, NULL, kTargetType32Bit, 32 - (bit_pos + bit_size))));
  TargetInstruction* asr = Emit(rv, NewInstruction2(RV32_OP(srai), lsl, GetIntConstant(rv, NULL, kTargetType32Bit, 32 - bit_size)));
...
static TargetInstruction* LowerSetBitField(RV32Generator* rv, IRNode* node) {
  ...
  TargetInstruction* lsl = Emit(rv, NewInstruction2(RV32_OP(slli), input, GetIntConstant(rv, NULL, kTargetType32Bit, bit_pos)));
  TargetInstruction* m1 = Emit(rv, NewInstruction2(RV32_OP(andi), lsl, GetIntConstant(rv, NULL, kTargetType32Bit, mask)));

  TargetInstruction* m2 = Emit(rv, NewInstruction2(RV32_OP(andi), output, GetIntConstant(rv, NULL, kTargetType32Bit, ~mask)));
  TargetInstruction* result = Emit(rv, NewInstruction2(RV32_OP(or), m1, m2));
  SetLoweredNode(node, result);
  return result;
}

static TargetInstruction* FinishSignExtend(RV32Generator* rv, IRNode* node,
                                           TargetInstruction* lo) {
  if (NodeIsWideInt(node)) {
    TargetInstruction* hi = Emit(
        rv, NewInstruction2(RV32_OP(srai), lo,
                            GetIntConstant(rv, NULL, kTargetType32Bit, 31)));
    PairWideHalves(lo, hi);
    SetLoweredHi(node, hi);
    return SetLoweredNode(node, lo);
  }
  return FinishWithDest(rv, node, lo, RV32_OP(mv));
}

static TargetInstruction* LowerSignExtend(RV32Generator* rv, IRNode* node) {
  IRNode* input = node->inputs.value.p[0];
  TargetInstruction* value;
  if (NodeIsWideInt(input)) {
    TargetInstruction* unused_hi;
  ...
  if (diff == 32 || diff == 0) {
    ...
    return FinishSignExtend(rv, node,
                            Emit(rv, NewInstruction1(RV32_OP(mv), value)));
  }
  TargetInstruction* immed = GetIntConstant(rv, NULL, kTargetType32Bit, diff);
  TargetInstruction* lsl = Emit(rv, NewInstruction2(RV32_OP(slli), value, immed));
  TargetInstruction* asr = Emit(rv, NewInstruction2(RV32_OP(srai), lsl, immed));

  return FinishSignExtend(rv, node, asr);
}

static TargetInstruction* LowerAlign(RV32Generator* rv, IRNode* node) {
  TargetInstruction* value = Materialize(rv, node->inputs.value.p[0]);
  ...
  TargetInstruction* add = Emit(rv, NewInstruction2(RV32_OP(addi), value, immed));
  TargetInstruction* and = Emit(rv, NewInstruction2(RV32_OP(andi), add, inv_immed));

  SetLoweredNode(node, and);
  return and;
}

static TargetInstruction* PushArg(RV32Generator* rv, IRNode* node,
                                  TargetInstruction* inst, size_t offset) {
  if (node->type == NULL) {
    return Emit(rv, NewInstruction3(
                        RV32_OP(sw), inst, StackPointer(rv),
                        GetIntConstant(rv, node, kTargetType64Bit, offset)));
  }
  RV32Opcode opcode = RV32_OP(sw);
  if (TypeUsesHardwareFloatRegister(node->type)) {
    opcode = RV32FpIsDoubleWidth(node->type) ? RV32_OP(fsd) : RV32_OP(fsw);
  }
  return Emit(rv, NewInstruction3(
...
static TargetInstruction* PopArg(RV32Generator* rv, IRNode* node, size_t offset) {
  if (node->type == NULL) {
    return Emit(rv, NewInstruction2(
                        RV32_OP(lw), FramePointer(rv),
                        GetIntConstant(rv, node, kTargetType64Bit, offset)));
  }
  RV32Opcode opcode = RV32_OP(lw);
  if (TypeUsesHardwareFloatRegister(node->type)) {
    opcode = RV32FpIsDoubleWidth(node->type) ? RV32_OP(fld) : RV32_OP(flw);
  }
  return Emit(rv, NewInstruction2(
...
static TargetInstruction* LowerMemcpy(RV32Generator* rv, IRNode* node) {
...
static TargetInstruction* LowerMemzero(RV32Generator* rv, IRNode* node) {
...
static RV32PendingArgMove* NewPendingArgMove(TargetInstruction* source,
                                           TargetInstruction* destination,
                                           RV32Opcode opcode) {
  RV32PendingArgMove* move = malloc(sizeof(*move));
  move->source = source;
...
// Build a list of RV32_OP(regarg) instructions to hold the
...
static TargetInstruction* BuildArgList(RV32Generator* rv, Vector* arg_locations) {
  TargetInstruction* result = NULL;
  ...
  for (size_t i = 0; i < arg_locations->length; i++) {
    ...
    if (loc->type == kArgLocationRegister) {
      result =
          Emit(rv, NewInstruction2(RV32_OP(regarg), result, loc->location.reg));
      ...
      if (loc->second_reg != NULL) {
        result = Emit(rv,
                      NewInstruction2(RV32_OP(regarg), result, loc->second_reg));
      }
    }
  }
  return result;
...
typedef struct {
  ...
  TypeRecord* type[2];
  int offset[2];
} RV32FloatingAggregate;

static bool GetFloatingAggregate(TypeRecord* type,
                                 RV32FloatingAggregate* aggregate) {
  ...
  for (size_t i = 0; i < info->members.length; i++) {
    ...
    if (member->bit_size != 0 || member->symbol == NULL ||
        (!TypeUsesFloat32Representation(member->symbol->type) &&
         !RV32FpIsDoubleWidth(member->symbol->type)) ||
        aggregate->count == 2) {
      return false;
    }
...
static void MaterializeDoubleBits(RV32Generator* rv, IRNode* node,
                                  TargetInstruction** lo,
                                  TargetInstruction** hi) {
  ...
  TargetSetDest(newsp, StackPointer(rv));
  Emit(rv, NewInstruction3(
               RV32_OP(fsd), value, StackPointer(rv),
               GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
  *lo = Emit(rv, NewInstruction2(
      RV32_OP(lw), StackPointer(rv),
      GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
  *hi = Emit(rv, NewInstruction2(
      RV32_OP(lw), StackPointer(rv),
      GetIntConstant(rv, NULL, kTargetType32Bit, 4)));
...
static TargetInstruction* LowerCall(RV32Generator* rv, IRNode* node) {
  assert(node->inputs.length >= 1);
  ...
  for (size_t i = 1; i < node->inputs.length; i++) {
    ...
    RV32FloatingAggregate floating_aggregate;
    bool pass_floating_aggregate =
        !is_variadic_arg &&
        GetFloatingAggregate(arg_node->type, &floating_aggregate) &&
        next_fp_arg_reg + floating_aggregate.count <= RV32_NUM_FP_ARGS;
    if (is_hidden_struct_result) {
      ...
      VectorAppend(&arg_locations, location);
               ...
               (is_variadic_arg && TypeUsesHardwareFloatRegister(arg_node->type) &&
                RV32FpIsDoubleWidth(arg_node->type))) {
      ...
      if (next_int_arg_reg + 1 < RV32_NUM_INT_ARGS) {
        TargetInstruction* first =
            IntArgumentRegister(rv, next_int_arg_reg++);
        TargetInstruction* second =
            IntArgumentRegister(rv, next_int_arg_reg++);
        ...
        next_pushed_arg_offset =
            (next_pushed_arg_offset + 7) & ~(size_t)7;
        VectorAppend(&arg_locations,
      ...
      if (struct_size <= 4) {
        if (next_int_arg_reg < RV32_NUM_INT_ARGS) {
      ...
      if (next_fp_arg_reg < RV32_NUM_FP_ARGS) {
        // Argument goes in an argument register.
        TargetInstruction* arg_reg =
            FloatingPointArgumentRegister(rv, next_fp_arg_reg++);
        VectorAppend(&arg_locations, NewArgLocationRegister(arg_reg));
  ...
  if (total_stack_size > 0) {
    ...
    TargetSetDest(newsp, StackPointer(rv));
    //Emit(rv, NewInstruction2(RV32_OP(rmov), StackPointer(rv), newsp));
  }
    ...
    switch (arg_location->type) {
      case kArgLocationFPRegisterAggregate: {
        ...
        for (int member = 0; member < aggregate.count; member++) {
          RV32Opcode load_opcode =
              RV32FpIsDoubleWidth(aggregate.type[member]) ? RV32_OP(fld) : RV32_OP(flw);
          RV32Opcode move_opcode =
              RV32FpIsDoubleWidth(aggregate.type[member]) ? RV32_OP(fmv_d)
                                                   : RV32_OP(fmv_s);
      ...
      case kArgLocationRegisterPair: {
        if (TypeUsesHardwareFloatRegister(arg_node->type)) {
          ...
          VectorAppend(&pending_arg_moves,
                       NewPendingArgMove(lo, arg_location->location.reg,
                                         RV32_OP(mv)));
          VectorAppend(&pending_arg_moves,
                       NewPendingArgMove(hi, arg_location->second_reg,
                                         RV32_OP(mv)));
          break;
        }
      ...
      case kArgLocationPushedPair: {
        ...
        TargetInstruction* second = Emit(rv, NewInstruction2(
            ...
            GetIntConstant(rv, NULL, kTargetType32Bit, 4)));
        Emit(rv, NewInstruction3(
                     RV32_OP(sw), first, StackPointer(rv),
                     GetIntConstant(rv, NULL, kTargetType64Bit,
                                    arg_location->location.offset)));
        Emit(rv, NewInstruction3(
                     RV32_OP(sw), second, StackPointer(rv),
                     GetIntConstant(rv, NULL, kTargetType64Bit,
      ...
      case kArgLocationPushed: {
        ...
        if (pass_float_as_int) {
          arg = Emit(rv, NewInstruction1(!TypeUsesFloat32Representation(
                                       ...
                                       arg));
          Emit(rv, NewInstruction3(
                       RV32_OP(sw), arg, StackPointer(rv),
      ...
      case kArgLocationRegister: {
        ...
        if (pass_float_as_int) {
          ...
          if (RV32FpIsDoubleWidth(arg_node->type)) {
            mov_opcode = RV32_OP(fmv_d);
          } else {
            mov_opcode = RV32_OP(fmv_s);
          }
        }
        VectorAppend(&pending_arg_moves,
                     NewPendingArgMove(arg, arg_location->location.reg,
  ...
  for (size_t i = 0; i < pending_arg_moves.length; i++) {
    RV32PendingArgMove* pending = pending_arg_moves.value.p[i];
    TargetInstruction* move = Emit(
        rv, NewInstruction2(pending->opcode, pending->destination,
                            pending->source));
    move->flags |= RV32_INST_ARG_MOVE;
  }
  ...
  if (can_be_tail_call) {
    ...
    if (RV32IsExpression(addr)) {
      ...
      TargetInstruction* mv = Emit(rv, NewInstruction1(RV32_OP(mv), addr));
      mv->dest = Tmp(rv);
      Emit(rv, NewInstruction(RV32_OP(restore)));
      call = Emit(rv, NewInstruction1(RV32_OP(jr), Tmp(rv)));
    } else {
      Emit(rv, NewInstruction(RV32_OP(restore)));
      BuildArgList(rv, &arg_locations);
      if (((int)addr->opcode == (int)RV32_OP(symbol))) {
        // Direct tail call to a known function: a plain jump to the symbol.
        call = Emit(rv, NewInstruction1(RV32_OP(j), addr));
      } else {
        ...
        call = Emit(rv, NewInstruction1(RV32_OP(jr), addr));
      }
    }
    rv->base.num_calls--;
  } else {
    ...
    if (((int)addr->opcode == (int)RV32_OP(symbol))) {
      ...
      opcode = TypeUsesHardwareFloatRegister(node->type) ? RV32_OP(rcallf) : RV32_OP(rcall);
    }
    call =
  ...
  if (!can_be_tail_call) {
    ...
    if (NodeIsWideInt(node)) {
      TargetInstruction* a1 = IntArgumentRegister(rv, 1);
      TargetInstruction* hi =
          Emit(rv, NewInstruction1(RV32_OP(mv), a1));
...
static TargetInstruction* LowerComputedBranch(RV32Generator* rv, IRNode* node) {
  assert(node->inputs.length == 1);
  TargetInstruction* value = GetLoweredNode(node->inputs.value.p[0]);
  TargetInstruction* slli =
      Emit(rv, NewInstruction2(RV32_OP(slli), value,
                               GetIntConstant(rv, NULL, kTargetType32Bit, 2)));
  TargetInstruction* auipc =
      Emit(rv, NewInstruction1(RV32_OP(auipc),
                               GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
  TargetInstruction* add = Emit(rv, NewInstruction2(RV32_OP(add), auipc, slli));
  TargetInstruction* jalr =
      Emit(rv, NewInstruction3(RV32_OP(jalr), Zero(rv), add,
...
static TargetInstruction* LowerBuiltinVaStart(RV32Generator* rv, IRNode* node) {
  TargetInstruction* s0 = Emit(rv, NewInstruction(RV32_OP(fp)));
  ...
  if (!on_stack) {
    TargetInstruction* mv = Emit(rv, NewInstruction1(RV32_OP(mv), s0));
    mv->dest = addr;
    return SetLoweredNode(node, addr);
  }
  return SetLoweredNode(node,
                        Emit(rv, NewInstruction3(RV32_OP(sw), s0, addr, offset)));
}
...
static TargetInstruction* LowerBuiltinVaArg(RV32Generator* rv, IRNode* node) {
  ...
  if (!on_stack) {
    ...
    ap_load = Emit(rv, NewInstruction2(RV32_OP(lw), ap_addr, ap_offset));
  }
  TargetInstruction* result;
  size_t arg_size = 4;
  ...
  if (TypeIsStructOrUnion(node->type) &&
    ...
    arg_size = (struct_size + 3) & ~(size_t)3;
             ...
             (TypeIsStructOrUnion(node->type) &&
              node->type->info.struct_info->size > 16)) {
    // Hidden pointer in one XLEN slot.  Load it; do not 8-align as if this
    // were a scalar long long, or va_arg would skip the next argument.
    result = Emit(rv, NewInstruction2(RV32_OP(lw), ap_load,
                               GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
    arg_size = 4;
  } else if (TypeUsesHardwareFloatRegister(node->type)) {
    result = Emit(rv, NewInstruction2(RV32_OP(fld), ap_load,
                               GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
  } else if (NodeIsWideInt(node)) {
    result = Emit(rv, NewInstruction2(RV32_OP(lw), ap_load,
                               GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
    TargetInstruction* hi = Emit(rv, NewInstruction2(
        RV32_OP(lw), ap_load,
        GetIntConstant(rv, NULL, kTargetType32Bit, 4)));
    PairWideHalves(result, hi);
    SetLoweredHi(node, hi);
  ...
  TargetInstruction* addi =
      Emit(rv, NewInstruction2(RV32_OP(addi), ap_load,
                               GetIntConstant(rv, NULL, kTargetType32Bit,
                                              arg_size)));
  if (on_stack) {
    Emit(rv, NewInstruction3(RV32_OP(sw), addi, ap_addr, ap_offset));
  } else {
    TargetInstruction* mv = Emit(rv, NewInstruction1(RV32_OP(mv), addi));
    mv->dest = ap_load;
  }
  return SetLoweredNode(node, result);
}

static TargetInstruction* LowerBuiltinVaEnd(RV32Generator* rv, IRNode* node) {
  // Nothing to do for va_end.
  return NULL;
}

static TargetInstruction* LowerBuiltinVaCopy(RV32Generator* rv, IRNode* node) {
  TargetInstruction* dest_addr;
  TargetInstruction* dest_offset;
  bool dest_on_stack =
  ...
  TargetInstruction* value =
      src_on_stack
          ? Emit(rv, NewInstruction2(RV32_OP(lw), src_addr, src_offset))
          : src_addr;

  if (dest_on_stack) {
    return SetLoweredNode(
        node, Emit(rv,
                   NewInstruction3(RV32_OP(sw), value, dest_addr, dest_offset)));
  }
  TargetInstruction* move = Emit(rv, NewInstruction1(RV32_OP(mv), value));
  move->dest = dest_addr;
  return SetLoweredNode(node, dest_addr);
}

static TargetInstruction* LowerLocation(RV32Generator* rv, IRNode* node) {
  IRLocation* loc = (IRLocation*)node;
  return SetLoweredNode(node, Emit(rv, TargetNewLocation(loc)));
}

static TargetInstruction* LowerStackPointerOps(RV32Generator* rv, IRNode* node) {
  switch (node->opcode) {
    case IR_OP(decsp): {
      TargetInstruction* size = Materialize(rv, node->inputs.value.p[0]);
      TargetInstruction* new_sp;
      if (TargetIsConst(size)) {
        int64_t s = RV32IntValue(size);
        new_sp = AddImmediate(rv, StackPointer(rv), -s);
      } else {
        new_sp = Emit(rv, NewInstruction2(RV32_OP(sub), StackPointer(rv), size));
      }
    ...
    case IR_OP(savesp): {
      ...
      TargetInstruction* mv =
          Emit(rv, NewInstruction1(RV32_OP(mv), StackPointer(rv)));
      mv->dest = tmp;
      return tmp;
    }
    case IR_OP(restoresp): {
      TargetInstruction* tmp = Materialize(rv, node->inputs.value.p[0]);
      TargetInstruction* mv = Emit(rv, NewInstruction1(RV32_OP(mv), tmp));
...
static TargetInstruction* AtomicAddress(RV32Generator* rv, IRNode* addr_node) {
  ...
  if (TargetIsConst(offset)) {
    return AddImmediate(rv, base, RV32IntValue(offset));
  }
  return Emit(rv, NewInstruction2(RV32_OP(add), base, offset));
}

static void SetAtomicMetadata(TargetInstruction* inst, TypeRecord* value_type,
                              int success_order, int failure_order,
                              bool weak) {
  inst->flags |= AtomicAccessLog2(value_type) << RV32_ATOMIC_SIZE_SHIFT;
  inst->flags |= success_order << RV32_ATOMIC_ORDER_SHIFT;
  inst->flags |= failure_order << RV32_ATOMIC_FAILURE_ORDER_SHIFT;
  if (weak) {
    inst->flags |= RV32_ATOMIC_WEAK;
  }
}

static TargetInstruction* FinishAtomicValue(RV32Generator* rv, IRNode* node,
                                             TargetInstruction* inst) {
  Emit(rv, inst);
  TargetInstruction* dest = GetDestInstruction(rv, node);
  if (dest != NULL) {
    inst = SetDestOrMove(rv, inst, dest, RV32_OP(mv));
  }
  return SetLoweredNode(node, inst);
}

static TargetInstruction* LowerAtomic(RV32Generator* rv, IRNode* node) {
  if (node->opcode == IR_OP(atomic_fence)) {
    TargetInstruction* inst = NewInstruction(RV32_OP(atomic_fence));
  ...
  switch (node->opcode) {
    case IR_OP(atomic_load):
      inst = NewInstruction1(RV32_OP(atomic_load), addr);
    ...
    case IR_OP(atomic_store): {
      ...
      inst = NewInstruction2(RV32_OP(atomic_store), value, addr);
      SetAtomicMetadata(inst, value_type,
...
static TargetInstruction* LowerIRNode(RV32Generator* rv, Generator* gen,
                                      IRNode* node) {
  // If we have already lowered the IR node, return it.
  if (node->data.ptr != NULL) {
    return node->data.ptr;
  ...
  switch (node->opcode) {
    ...
    case IR_OP(popcounti):
      assert(false && "bit operation must be software-expanded before RISC-V32 lowering");
      return NULL;
    ...
    case IR_OP(resultv):
    case IR_OP(capturev):
      assert(false && "vector operation must be software-expanded before RISC-V32 lowering");
      return NULL;
    ...
    case IR_OP(observable_checkpoint): {
      TargetInstruction* checkpoint = Emit(rv, NewInstruction(RV32_OP(nop)));
    ...
    case IR_OP(nrvoval):
      return Emit(rv, NewInstruction1(RV32_OP(nrvoval), Materialize(rv, node->inputs.value.p[0])));
    ...
    case IR_OP(structreturn): {
      ...
      TargetInstruction* result =
          SetLoweredNode(node, EmitSymbol(rv, NewInstruction(RV32_OP(structreturn))));
      TargetInstruction* mv = Emit(rv, NewInstruction1(RV32_OP(mv),
    ...
    case IR_OP(enter):
      Emit(rv, NewInstruction(RV32_OP(save)));
    ...
    case IR_OP(ret):
      return Emit(rv, NewInstruction(RV32_OP(ret)));
...
//      return LowerRmov(rv, node);
    ...
    case IR_OP(cmpgta):
    case IR_OP(cmpgea):
      return FinishWithDest(rv, node, LowerComparison(rv, node), RV32_OP(mv));
    ...
    case IR_OP(cmp3wayf):
    case IR_OP(cmp3wayd):
      return FinishWithDest(rv, node, LowerThreeWay(rv, node), RV32_OP(mv));
  ...
  for (size_t i = 0; i < args->length; i++) {
    if (i == arg_num) {
      ...
      bool in_fp_registers =
          ...
          fp_reg + aggregate.count - 1 <= RV32_FP_ARG_END;
      if (in_fp_registers) {
        location.type = kArgLocationFPRegisterAggregate;
...
static TargetInstruction* LoadFpArgumentIntoRegisterVariable(RV32Generator* rv,
                                                             int reg_var,
                                             ArgLocation arg_loc,
                                             IRNode* symbol) {
  switch (arg_loc.type) {
  case kArgLocationRegister:
    case kArgLocationPassedByReferenceInRegister: {
      ...
      RV32Opcode move_op = RV32FpIsDoubleWidth(symbol->type) ? RV32_OP(fmv_d) : RV32_OP(fmv_s);
      Emit(rv, NewInstruction2(move_op, var,
                FloatingPointArgumentRegister(rv,
                    (int)arg_loc.location.offset - RV32_FP_ARG_START)));
      return var;
    }
    case kArgLocationPushed:
    case kArgLocationPassedByReferenceOnStack: {
...
static TargetInstruction* LoadIntArgumentIntoRegisterVariable(RV32Generator* rv,
                                                              int reg_var,
                                             ArgLocation arg_loc,
                                             IRNode* symbol) {
  switch (arg_loc.type) {
    ...
    case kArgLocationPassedByReferenceInRegister: {
      ...
      TargetInstruction* mv = Emit(rv, NewInstruction1(RV32_OP(mv),
                 IntArgumentRegister(rv,
                          (int)arg_loc.location.offset - RV32_INT_ARG_START)));
      mv->dest = var;
      return var;
    }
    case kArgLocationPassedByReferenceOnStack:
...
static int SavedArgumentAreaLowAddress(const RV32Generator* rv) {
  int low = -RV32_STACK_FRAME_HEADER_SIZE;
...
static int AllocateSavedArgumentArea(const RV32Generator* rv, int size,
                                     int alignment) {
  assert(size > 0);
...
static int SavedArgumentAreaSize(const RV32Generator* rv) {
  return -RV32_STACK_FRAME_HEADER_SIZE - SavedArgumentAreaLowAddress(rv);
}

static void HomeFloatingAggregateArgument(
    RV32Generator* rv, PoolEntry* entry, ArgLocation location,
    const RV32FloatingAggregate* aggregate) {
  int size = 0;
  for (int member = 0; member < aggregate->count; member++) {
  ...
  for (int member = 0; member < aggregate->count; member++) {
    ...
    VectorAppend(
        &rv->saved_regs,
        NewSavedArgumentRegister(reg, RV32_FP_REG,
...
static void AssignRegisterOrOffset(RV32Generator* rv, PoolEntry* entry,
  ...
  if (TypeUsesHardwareFloatRegister(entry->pooled->type)) {
    if (UseRegisterForVariable(rv, entry->pooled)) {
      ...
      entry->pooled->data.ivalue = RV32_REG_VAR | reg;
      ...
      if (is_arg) {
        ...
        if (location.type == kArgLocationRegister) {
          ...
          SavedArgumentRegister* saved = NewSavedArgumentRegister(
              (int)location.location.offset, RV32_FP_REG, offset,
    ...
    if (is_arg) {
      if (size <= 4) {
        ...
        if (location.type == kArgLocationFPRegisterAggregate) {
          ...
          int offset = AllocateSavedArgumentArea(rv, 8, 8);
          SavedArgumentRegister* saved = NewSavedArgumentRegister(
              (int)location.location.offset, RV32_FP_REG, offset, 8, false);
          entry->pooled->data.ivalue = offset;
          VectorAppend(&rv->saved_regs, saved);
          rv->num_int_arg_regs++;
          SetDebugStackLocation(entry, entry->pooled->data.ivalue);
      ...
      if ((entry->pooled->flags & kIRNrvoMarker) != 0) {
        ...
        // structreturn.
        entry->pooled->data.ivalue = RV32_REG_VAR | rv->struct_return_reg;
        TargetInstruction* var = IntVariableRegister(rv, rv->struct_return_reg, entry->value.symbol);
        Emit(rv, NewInstruction2(RV32_OP(mv), var,
                    IntArgumentRegister(rv, 0)));
...
static void FinalizeDebugStackLocations(RV32Generator* rv, Vector* vars) {
...
void RV32Lower(RV32Generator* rv, Generator* gen) {
  ...
  if (compiler->print_back_end|| compiler->ir_output_file != stdout) {
    RV32Print(rv, compiler->ir_output_file);
  }
  ...
  RV32AllocateRegisters(&rv->register_allocator);
}

void RV32Print(RV32Generator* rv, FILE* fp) {
  TargetInstruction* inst = TargetFirstInstruction(&rv->base);
  while (inst != NULL) {
    TargetPrintInstruction(inst, RV32OpcodeName, fp);
