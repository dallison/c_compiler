...
//  c_compiler_library
//
//  Created by David Allison on 4/16/20.
...
// To convert from an enum to these switch statements, copy in the
// enumeration and run this (for example):
// $ sed -i -e 's/DW_AT(\([^)]*\))[^,]*,/case DW_AT(\1): return "DW_AT_\1";/g'
// dwarf_defs.c
...
const char* DW_ATEString(DW_ATE ate) {
  switch (ate) {
    ...
    case DW_ATE(imaginary_float):
      return "DW_ATE_imaginary_float";
    case DW_ATE(packed_decimal):
      return "DW_ATE_packed_decimal";
    case DW_ATE(numeric_string):
      return "DW_ATE_numeric_string";
    case DW_ATE(edited):
      return "DW_ATE_edited";
    case DW_ATE(signed_fixed):
      return "DW_ATE_signed_fixed";
    case DW_ATE(unsigned_fixed):
      return "DW_ATE_unsigned_fixed";
    case DW_ATE(decimal_float):
