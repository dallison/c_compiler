...
typedef struct {
  ...
  // Declaration attributes encountered in decl-specifier/declarator positions.
  // They are transferred to the next Symbol produced by ParseDeclarator.
  Vector pending_declaration_attributes;  // Attribute*
