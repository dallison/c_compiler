...
// RISC-V32 currently uses the 64-bit double representation for long double.
// Keep the source-language distinction, but select double-width instructions
// and floating-point registers for both types.
static bool XTENSAFpIsDoubleWidth(TypeRecord* type) {
  return TypeUsesFloat64Representation(type);
}

static void LowerVariables(XTENSAGenerator* rv, Generator* gen);
...
const char* XTENSAOpcodeName(int op) {
  XTENSAOpcode opcode = (XTENSAOpcode)op;
  switch (opcode) {
    default:
    ...
    case XTENSA_OP(and):
      return "and";
    case XTENSA_OP(fence):
      return "fence";
    case XTENSA_OP(fence_i):
      return "fence.i";
    case XTENSA_OP(ecall):
      return "ecall";
    case XTENSA_OP(ebreak):
      return "ebreak";
    case XTENSA_OP(csrrw):
      return "csrrw";
    case XTENSA_OP(csrrs):
      return "csrrs";
    case XTENSA_OP(csrrc):
      return "csrrc";
    case XTENSA_OP(csrrwi):
      return "csrrwi";
    case XTENSA_OP(csrrsi):
      return "csrrsi";
    case XTENSA_OP(csrrci):
      return "csrrci";

    // RV64I instructions (kept for opcode completeness; not emitted).
    case XTENSA_OP(lwu):
      return "lwu";
    case XTENSA_OP(ld):
      return "ld";
    ...
    case XTENSA_OP(mulh):
      return "mulh";
    case XTENSA_OP(mulhsu):
      return "mulhsu";
    case XTENSA_OP(mulhu):
      return "mulhu";
    case XTENSA_OP(div):
      return "div";
    case XTENSA_OP(divu):
    ...
    case XTENSA_OP(divw):
      return "divw";
    case XTENSA_OP(divuw):
      return "divuw";
    case XTENSA_OP(remw):
      return "remw";
    case XTENSA_OP(remuw):
      return "remuw";
    ...
    case XTENSA_OP(fsw):
      return "fsw";
    case XTENSA_OP(fmadd_s):
      return "fmadd.s";
    case XTENSA_OP(fmsub_s):
      return "fmsub.s";
    case XTENSA_OP(fnmsub_s):
      return "fnmsub.s";
    case XTENSA_OP(fnmadd_s):
      return "fnmadd.s";
    case XTENSA_OP(fadd_s):
      return "fadd.s";
    case XTENSA_OP(fsub_s):
      return "fsub.s";
    case XTENSA_OP(fmul_s):
      return "fmul.s";
    case XTENSA_OP(fdiv_s):
      return "fdiv.s";
    case XTENSA_OP(fsqrt_s):
      return "fsqrt.s";
    case XTENSA_OP(fsgnj_s):
      return "fsgnj.s";
    case XTENSA_OP(fsgnjn_s):
      return "fsgnjn.s";
    case XTENSA_OP(fsgnjx_s):
      return "fsgnjx.s";
    case XTENSA_OP(fmin_s):
      return "fmin.s";
    case XTENSA_OP(fmax_s):
      return "fmax.s";
    case XTENSA_OP(fcvt_w_s):
      return "fcvt.w.s";
    case XTENSA_OP(fcvt_wu_s):
      return "fcvt.wu.s";
    case XTENSA_OP(fmv_x_w):
      return "fmv.x.w";
    case XTENSA_OP(feq_s):
      return "feq.s";
    case XTENSA_OP(flt_s):
      return "flt.s";
    case XTENSA_OP(fle_s):
      return "fle.s";
    case XTENSA_OP(fclass_s):
      return "fclass.s";
    case XTENSA_OP(fcvt_s_w):
      return "fcvt.s.w";
    case XTENSA_OP(fcvt_s_wu):
      return "fcvt.s.wu";
    case XTENSA_OP(fmv_w_x):
      return "fmv.w.x";

    // RV64F instructions.
    case XTENSA_OP(fcvt_l_s):
      return "fcvt.l.s";
    case XTENSA_OP(fcvt_lu_s):
      return "fcvt.lu.s";
    case XTENSA_OP(fcvt_s_l):
      return "fcvt.s.l";
    case XTENSA_OP(fcvt_s_lu):
      return "fcvt.s.lu";
    ...
    case XTENSA_OP(fsd):
      return "fsd";
    case XTENSA_OP(fmadd_d):
      return "fmadd.d";
    case XTENSA_OP(fmsub_d):
      return "fmsub.d";
    case XTENSA_OP(fnmsub_d):
      return "fnmsub.d";
    case XTENSA_OP(fnmadd_d):
      return "fnmadd.d";
    case XTENSA_OP(fadd_d):
      return "fadd.d";
    case XTENSA_OP(fsub_d):
      return "fsub.d";
    case XTENSA_OP(fmul_d):
      return "fmul.d";
    case XTENSA_OP(fdiv_d):
      return "fdiv.d";
    case XTENSA_OP(fsqrt_d):
      return "fsqrt.d";
    case XTENSA_OP(fsgnj_d):
      return "fsgnj.d";
    case XTENSA_OP(fsgnjn_d):
      return "fsgnjn.d";
    case XTENSA_OP(fsgnjx_d):
      return "fsgnjx.d";
    case XTENSA_OP(fmin_d):
      return "fmin.d";
    case XTENSA_OP(fmax_d):
      return "fmax.d";
    case XTENSA_OP(fcvt_s_d):
      return "fcvt.s.d";
    case XTENSA_OP(fcvt_d_s):
      return "fcvt.d.s";
    case XTENSA_OP(feq_d):
      return "feq.d";
    case XTENSA_OP(flt_d):
      return "flt.d";
    case XTENSA_OP(fle_d):
      return "fle.d";
    case XTENSA_OP(fclass_d):
      return "fclass.d";
    case XTENSA_OP(fcvt_w_d):
      return "fcvt.w.d";
    case XTENSA_OP(fcvt_wu_d):
      return "fcvt.wu.d";
    case XTENSA_OP(fcvt_d_w):
      return "fcvt.d.w";
    case XTENSA_OP(fcvt_d_wu):
      return "fcvt.d.wu";

    // RV64D instructions.
    case XTENSA_OP(fcvt_l_d):
      return "fcvt.l.d";
    case XTENSA_OP(fcvt_lu_d):
      return "fcvt.lu.d";
    case XTENSA_OP(fmv_x_d):
      return "fmv.x.d";
    case XTENSA_OP(fcvt_d_l):
      return "fcvt.d.l";
    case XTENSA_OP(fcvt_d_lu):
      return "fcvt.d.lu";
    case XTENSA_OP(fmv_d_x):
      return "fmv.d.x";
    ...
    case XTENSA_OP(neg):
      return "neg";
    case XTENSA_OP(fneg_s):
      return "fneg.s";
    case XTENSA_OP(fneg_d):
      return "fneg.d";
    case XTENSA_OP(li):
      return "li";
    case XTENSA_OP(seqz):
...
bool XTENSAIsExpression(TargetInstruction* inst) {
  switch ((XTENSAOpcode)inst->opcode) {
    ...
    case XTENSA_OP(atomic_fence):
      return false;
    default:
      return !XTENSAIsFixedRegister(inst) && !XTENSAIsConst(inst);
  }
}

bool XTENSAGeneratesOutput(TargetInstruction* inst) {
  if (XTENSAIsFixedRegister(inst)) {
    return false;
  }
  switch ((XTENSAOpcode)inst->opcode) {
    ...
    case XTENSA_OP(resultd):
      return false;
    default:
      return XTENSAIsExpression(inst) && !XTENSAIsSymbol(inst) &&
             !XTENSAIsConst(inst);
  }
}
...
bool XTENSAIsIntConst(TargetInstruction* inst) {
  switch ((XTENSAOpcode)inst->opcode) {
    case XTENSA_OP(const32):
    case XTENSA_OP(const8):
    case XTENSA_OP(const16):
    case XTENSA_OP(const64):
      return true;
    default:
      return false;
  }
...
bool XTENSAIsConst(TargetInstruction* inst) {
  switch ((XTENSAOpcode)inst->opcode) {
    ...
    case XTENSA_OP(const16):
    case XTENSA_OP(const64):
    case XTENSA_OP(constf):
    case XTENSA_OP(constd):
      return true;
    default:
      return false;
  }
...
bool XTENSAIsFloatingPoint(TargetInstruction* inst) {
  if ((XTENSAOpcode)inst->opcode < XTENSA_OP(flw) ||
      (XTENSAOpcode)inst->opcode > XTENSA_OP(fmv_d_x)) {
    return false;
  }
  switch ((XTENSAOpcode)inst->opcode) {
    case XTENSA_OP(fa0):
...
bool XTENSAIsSymbol(TargetInstruction* inst) {
  return (XTENSAOpcode)((int)inst->opcode == (int)XTENSA_OP(symbol));
}
...
bool XTENSAIsSpill(TargetInstruction* inst) {
  return (XTENSAOpcode)((int)inst->opcode == (int)XTENSA_OP(spill));
}

bool XTENSAIsLabel(TargetInstruction* inst) {
  return (XTENSAOpcode)((int)inst->opcode == (int)XTENSA_OP(label));
}

bool XTENSAIsReturn(TargetInstruction* inst) {
  return (XTENSAOpcode)((int)inst->opcode == (int)XTENSA_OP(ret));
}

int64_t XTENSAIntValue(TargetInstruction* inst) {
  if (inst->opcode == (TargetOpcode)XTENSA_OP(x0)) {
    return 0;
  }
...
bool XTENSAIsJumpableEntry(TargetInstruction* inst) {
  return inst->opcode == (TargetOpcode)XTENSA_OP(j);
}

static TargetVirtuals virtuals = {
    .opcode_name = XTENSAOpcodeName,
    .is_branch = XTENSAIsBranch,
    .is_call = XTENSAIsCall,
    .is_return = XTENSAIsReturn,
    .is_spill = XTENSAIsSpill,
    .is_label = XTENSAIsLabel,
    .is_floating_point = XTENSAIsFloatingPoint,
    .is_conditional_branch = XTENSAIsConditionalBranch,
    .is_fixed_register = XTENSAIsFixedRegister,
    .is_const = XTENSAIsConst,
    .is_symbol = XTENSAIsSymbol,
    .is_expression = XTENSAIsExpression,
    .is_table_entry = XTENSAIsJumpableEntry,
    .get_branch_target = XTENSAGetBranchTarget,
    .calls_may_stay_in_block = true,
};

void XTENSAGeneratorInit(XTENSAGenerator* rv, Generator* gen) {
  ...
  XTENSARegisterAllocatorInit(&rv->register_allocator, rv);
}

XTENSAGenerator* NewXTENSAGenerator(Generator* gen) {
  XTENSAGenerator* rv = malloc(sizeof(XTENSAGenerator));
  XTENSAGeneratorInit(rv, gen);
  return rv;
}

void XTENSAGeneratorDestruct(XTENSAGenerator* rv) {
  ...
  XTENSARegisterAllocatorDestruct(&rv->register_allocator);
}

static void ResolveExceptionRanges(XTENSAGenerator* rv, Generator* gen) {
  ...
  for (size_t i = 0; i < gen->exception_ranges.length; i++) {
    ...
    XTENSAExceptionRange* range = malloc(sizeof(XTENSAExceptionRange));
...
void XTENSAGeneratorDelete(XTENSAGenerator* rv) {
  XTENSAGeneratorDestruct(rv);
  free(rv);
}
...
static COMPILER_UNUSED void SavedArgumentRegisterDelete(
    SavedArgumentRegister* reg) {
  free(reg);
}

// Some static utility functions that map to generic target functions.
static TargetInstruction* NewInstruction1(XTENSAOpcode opcode,
                                          TargetInstruction* op1) {
  return TargetNewInstruction1((TargetOpcode)opcode, op1);
}

static TargetInstruction* NewInstruction2(XTENSAOpcode opcode,
                                          TargetInstruction* op1,
                                          TargetInstruction* op2) {
  return TargetNewInstruction2((TargetOpcode)opcode, op1, op2);
}

static COMPILER_UNUSED TargetInstruction* NewInstruction3(
    XTENSAOpcode opcode, TargetInstruction* op1, TargetInstruction* op2,
    TargetInstruction* op3) {
  return TargetNewInstruction3((TargetOpcode)opcode, op1, op2, op3);
}

static TargetInstruction* Emit(XTENSAGenerator* rv, TargetInstruction* inst) {
  return TargetEmit(&rv->base, inst);
}

static COMPILER_UNUSED TargetInstruction* EmitBefore(XTENSAGenerator* rv,
                                                     TargetInstruction* inst,
                                                     TargetInstruction* pos) {
  return TargetEmitBefore(&rv->base, inst, pos);
}

static COMPILER_UNUSED TargetInstruction* EmitAfter(XTENSAGenerator* rv,
                                                    TargetInstruction* inst,
                                                    TargetInstruction* pos) {
  return TargetEmitAfter(&rv->base, inst, pos);
}

static COMPILER_UNUSED TargetInstruction* EmitConstant(XTENSAGenerator* rv,
                                                       TargetInstruction* c) {
  return TargetEmitConstant(&rv->base, c);
}

static COMPILER_UNUSED TargetInstruction* EmitSymbol(XTENSAGenerator* rv,
                                                     TargetInstruction* c) {
  return TargetEmitSymbol(&rv->base, c);
}

static COMPILER_UNUSED TargetInstruction* FramePointer(XTENSAGenerator* rv) {
  return TargetFramePointer(&rv->base);
}

static COMPILER_UNUSED TargetInstruction* StackPointer(XTENSAGenerator* rv) {
...
static TargetInstruction* GetIntConstant(XTENSAGenerator* rv, IRNode* node,
                                         TargetType type, int64_t value) {
  return TargetGetIntConstant(&rv->base, node, type, value);
}

static COMPILER_UNUSED TargetInstruction* GetFloatingPointConstant(
    XTENSAGenerator* rv, IRNode* node, TargetType type, double value) {
  return TargetGetFloatingPointConstant(&rv->base, node, type, value);
}

static TargetInstruction* GetSymbol(XTENSAGenerator* rv, IRNode* node,
                                    Symbol* symbol) {
  return TargetGetSymbol(&rv->base, node, symbol);
}

static TargetInstruction* NewInstruction(XTENSAOpcode opcode) {
  return TargetNewInstruction((TargetOpcode)opcode);
}

static TargetInstruction* Zero(XTENSAGenerator* rv) {
  if (rv->zero == NULL) {
    rv->zero = Emit(rv, NewInstruction(XTENSA_OP(x0)));
  }
  return rv->zero;
}

static TargetInstruction* Tmp(XTENSAGenerator* rv) {
  if (rv->tmp == NULL) {
    rv->tmp = Emit(rv, NewInstruction(XTENSA_OP(t0)));
  }
  return rv->tmp;
}

static COMPILER_UNUSED TargetInstruction* Tmp2(XTENSAGenerator* rv) {
  if (rv->tmp2 == NULL) {
    rv->tmp2 = Emit(rv, NewInstruction(XTENSA_OP(t2)));
  }
  return rv->tmp2;
}

static TargetInstruction* IntArgumentRegister(XTENSAGenerator* rv, int argnum) {
  if (rv->int_argument_registers[argnum] == NULL) {
    ...
    rv->int_argument_registers[argnum] =
        EmitSymbol(rv, NewInstruction(XTENSA_OP(a0) + argnum));
  }
  return rv->int_argument_registers[argnum];
}

static TargetInstruction* FloatingPointArgumentRegister(XTENSAGenerator* rv,
                                                        int argnum) {
  if (rv->fp_argument_registers[argnum] == NULL) {
    // Allocate instruction for argument register and emit it.  The argument
    // registers have to be contiguous in value from a0..a7.
    rv->fp_argument_registers[argnum] =
        EmitSymbol(rv, NewInstruction(XTENSA_OP(fa0) + argnum));
  }
  return rv->fp_argument_registers[argnum];
}

static TargetInstruction* IntVariableRegister(XTENSAGenerator* rv, int varnum,
                                              Symbol* sym) {
...
static TargetInstruction* FloatingPointVariableRegister(XTENSAGenerator* rv,
                                                        int varnum,
                                                        Symbol* sym) {
  for (size_t i = 0; i < rv->var_regs.length; i++) {
    RegisterVariable* var = rv->var_regs.value.p[i];
...
static TargetInstruction* AddImmediate(XTENSAGenerator* rv,
                                       TargetInstruction* src, int64_t immed) {
  int64_t imm = immed;
  if (immed < 0) {
    imm = -immed;
  }
  ...
  if (imm <= 0x7ff) {
    return Emit(rv, NewInstruction2(XTENSA_OP(addi), src, immed_inst));
  }
  TargetInstruction* li = Emit(rv, NewInstruction1(XTENSA_OP(li), immed_inst));
...
static TargetInstruction* AddValue(XTENSAGenerator* rv, TargetInstruction* src,
                                   TargetInstruction* value) {
  if (TargetIsConst(value)) {
    return AddImmediate(rv, src, TargetIntValue(value));
  }

  if (((int)value->opcode == (int)XTENSA_OP(x0))) {
    return src;
  }
  return Emit(rv, NewInstruction2(XTENSA_OP(add), src, value));
}

// Calculate the offset from the frame pointer to a local variable in the stack.
static int LocalVariableOffset(XTENSAGenerator* rv, int32_t var_offset) {
  return var_offset - rv->base.stack_frame_size -
         XTENSA_STACK_FRAME_HEADER_SIZE;
}

static TargetInstruction* PagedOffsetFrom(XTENSAGenerator* rv,
...
// offset from the src.
static TargetInstruction* OffsetFrom(XTENSAGenerator* rv,
                                     TargetInstruction* src, int32_t offset) {
  bool offset_in_range = XTENSAIsPossibleImmediate(offset);
  if (offset_in_range) {
...
static TargetInstruction* LoadImmediate(XTENSAGenerator* rv,
                                        XTENSAOpcode opcode,
                                        TargetInstruction* base,
                                        int32_t offset) {
  if (XTENSAIsPossibleImmediate(offset)) {
    return Emit(rv, NewInstruction2(
                        opcode, base,
                        GetIntConstant(rv, NULL, kTargetType32Bit, offset)));
  }
  int32_t page_offset;
  TargetInstruction* page_inst =
      PagedOffsetFrom(rv, base, offset, &page_offset);
  return Emit(rv, NewInstruction2(
                      opcode, page_inst,
                      GetIntConstant(rv, NULL, kTargetType32Bit, page_offset)));
}

static TargetInstruction* StoreImmediate(XTENSAGenerator* rv,
                                         XTENSAOpcode opcode,
                                         TargetInstruction* value,
                                         TargetInstruction* base,
                                         int32_t offset) {
  ...
  TargetInstruction* page_inst =
      PagedOffsetFrom(rv, base, offset, &page_offset);
  return Emit(rv, NewInstruction3(
                      opcode, value, page_inst,
                      GetIntConstant(rv, NULL, kTargetType32Bit, page_offset)));
}

static TargetInstruction* Memcpy(XTENSAGenerator* rv,
  ...
  if (length <= 40) {
    ...
    for (int i = 0; i < num_words; i++, src_offset += 4, dest_offset += 4) {
      TargetInstruction* load =
          LoadImmediate(rv, XTENSA_OP(lw), src_addr, src_offset);
      result = StoreImmediate(rv, XTENSA_OP(sw), load, dest_addr, dest_offset);
    }
    for (int i = 0; i < num_bytes; i++, src_offset += 1, dest_offset += 1) {
      TargetInstruction* load =
          LoadImmediate(rv, XTENSA_OP(lb), src_addr, src_offset);
      result = StoreImmediate(rv, XTENSA_OP(sb), load, dest_addr, dest_offset);
    }
    if (count_as_call) {
      rv->base.num_calls--;
    }
  ...
  TargetInstruction* size = Emit(
      rv, NewInstruction1(XTENSA_OP(li),
                          GetIntConstant(rv, NULL, kTargetType32Bit, length)));
  TargetInstruction* arg2 =
      SetDestOrMove(rv, size, IntArgumentRegister(rv, 2), XTENSA_OP(mv));
  // TargetInstruction* arg2 =
  //     Emit(rv, NewInstruction2(XTENSA_OP(rmov), IntArgumentRegister(rv, 2),
  //     size));
  ...
  TargetInstruction* arg1 =
      SetDestOrMove(rv, src_addr, IntArgumentRegister(rv, 1), XTENSA_OP(mv));
  // Emit(
  // rv, NewInstruction2(XTENSA_OP(rmov), IntArgumentRegister(rv, 1),
  // src_addr));
  ...
  TargetInstruction* arg0 =
      SetDestOrMove(rv, dest_addr, IntArgumentRegister(rv, 0), XTENSA_OP(mv));
  // Emit(
  // rv, NewInstruction2(XTENSA_OP(rmov), IntArgumentRegister(rv, 0),
  // dest_addr));

  // We need to keep the arguments alive until the point of the call.  This
  // is done using a XTENSA_OP(regarg) instruction sequence.  See BuildArgList
  // for details on the regarg instruction.
  TargetInstruction* regarg =
      Emit(rv, NewInstruction2(XTENSA_OP(regarg), NULL, arg2));
  regarg = Emit(rv, NewInstruction2(XTENSA_OP(regarg), regarg, arg1));
  regarg = Emit(rv, NewInstruction2(XTENSA_OP(regarg), regarg, arg0));

  TargetInstruction* memcpy = GetSymbol(rv, NULL, rv->base.memcpy);
  return Emit(rv, NewInstruction2(XTENSA_OP(call), memcpy, regarg));
}

static TargetInstruction* Memzero(XTENSAGenerator* rv,
                                  TargetInstruction* dest_addr, int length,
                                  int offset) {
  if (length <= 40) {
    // Length is short, copy using sequence of ld/sd and lb/sb instructions.
    int num_bytes = length & 3;
    ...
    for (int i = 0; i < num_words; i++, offset += 4) {
      result = StoreImmediate(rv, XTENSA_OP(sw), Zero(rv), dest_addr, offset);
    }
    for (int i = 0; i < num_bytes; i++, offset += 1) {
      result = StoreImmediate(rv, XTENSA_OP(sb), Zero(rv), dest_addr, offset);
    }
    rv->base.num_calls--;
    return result;
  }
  ...
  // Second arg is zero.
  TargetInstruction* arg1 = Emit(rv, NewInstruction1(XTENSA_OP(mv), Zero(rv)));
  ...
  return Emit(rv, NewInstruction2(XTENSA_OP(call), memset, regarg));
}

static XTENSAOpcode IR2RV(IROpcode op) {
  switch (op) {
    case IR_OP(addi):
      return XTENSA_OP(add);
    case IR_OP(addf):
      return XTENSA_OP(fadd_s);
    case IR_OP(addd):
      return XTENSA_OP(fadd_d);
    case IR_OP(adda):
      return XTENSA_OP(add);

    case IR_OP(subi):
      return XTENSA_OP(sub);
    case IR_OP(subf):
      return XTENSA_OP(fsub_s);
    case IR_OP(subd):
      return XTENSA_OP(fsub_d);
    case IR_OP(suba):
      return XTENSA_OP(sub);

    case IR_OP(muli):
      return XTENSA_OP(mul);
    case IR_OP(mulf):
      return XTENSA_OP(fmul_s);
    case IR_OP(muld):
      return XTENSA_OP(fmul_d);

    case IR_OP(divi):
      return XTENSA_OP(div);
    case IR_OP(divf):
      return XTENSA_OP(fdiv_s);
    case IR_OP(divd):
      return XTENSA_OP(fdiv_d);

    case IR_OP(modi):
      return XTENSA_OP(rem);

    case IR_OP(lsri):
      return XTENSA_OP(srl);
    case IR_OP(asri):
      return XTENSA_OP(sra);
    case IR_OP(lsli):
      return XTENSA_OP(sll);

    case IR_OP(ori):
      return XTENSA_OP(or);
    case IR_OP(andi):
      return XTENSA_OP(and);
    case IR_OP(xori):
      return XTENSA_OP(xor);

    case IR_OP(noti):
    case IR_OP(nota):
      return XTENSA_OP(seqz);
    case IR_OP(onescomp):
      return XTENSA_OP(not);
    case IR_OP(negi):
      return XTENSA_OP(neg);
    case IR_OP(negf):
      return XTENSA_OP(fneg_s);
    case IR_OP(negd):
      return XTENSA_OP(fneg_d);

    case IR_OP(i2f):
      return XTENSA_OP(fcvt_s_w);
    case IR_OP(i2d):
      return XTENSA_OP(fcvt_d_w);
    case IR_OP(f2d):
      return XTENSA_OP(fcvt_d_s);
    case IR_OP(d2f):
      return XTENSA_OP(fcvt_s_d);
    case IR_OP(f2i):
      return XTENSA_OP(fcvt_w_s);
    case IR_OP(d2i):
      return XTENSA_OP(fcvt_w_d);

    case IR_OP(movi):
      return XTENSA_OP(mv);
    case IR_OP(movf):
      return XTENSA_OP(fmv_s);
    case IR_OP(movd):
      return XTENSA_OP(fmv_d);
    case IR_OP(mova):
      return XTENSA_OP(mv);
      //    case IR_OP(rmovi):
      //      return XTENSA_OP(rmov);
      //    case IR_OP(rmovf):
      //      return XTENSA_OP(rmovf);
      //    case IR_OP(rmovd):
      //      return XTENSA_OP(rmovd);
      //    case IR_OP(rmova):
      //      return XTENSA_OP(rmov);
    case IR_OP(tmp):
      return XTENSA_OP(tmp);
    default:
      assert(false);
      return 0;
  }
...
static int MaxIntRegisterVariables(XTENSAGenerator* rv) {
  bool is_leaf = rv->base.num_calls == 0 && OptLevel1() && !rv->not_leaf;
  if (is_leaf) {
    return XTENSA_LAST_LEAF_INT_REG_VAR - XTENSA_FIRST_LEAF_INT_REG_VAR + 1;
  }
  return XTENSA_LAST_INT_REG_VAR - XTENSA_FIRST_INT_REG_VAR + 1;
}

static int MaxFpRegisterVariables(XTENSAGenerator* rv) {
  bool is_leaf = rv->base.num_calls == 0 && OptLevel1() && !rv->not_leaf;
  if (is_leaf) {
    return XTENSA_LAST_LEAF_FP_REG_VAR - XTENSA_FIRST_LEAF_FP_REG_VAR + 1;
  }
  return XTENSA_LAST_FP_REG_VAR - XTENSA_FIRST_FP_REG_VAR + 1;
}

static bool UseRegisterForVariable(XTENSAGenerator* rv, IRNode* var_node) {
  if (OptLevel0()) {
  ...
  // 64-bit integers occupy a register pair and are always homed on the stack.
...
static TargetInstruction* LoadStaticVariableAddress(XTENSAGenerator* rv,
                                                    IRNode* node) {
  ...
  XTENSAOpcode opcode =
      var->symbol->flags.is_local ? XTENSA_OP(lla) : XTENSA_OP(la);
...
static struct {
  ...
  XTENSAOpcode load;
    ...
    {TypeIsInt, XTENSA_OP(lw)},
    {TypeIsShort, XTENSA_OP(lh)},
    {TypeIsChar8, XTENSA_OP(lbu)},
    {TypeIsChar, XTENSA_OP(lb)},
    {TypeIsLong, XTENSA_OP(lw)},
    {TypeIsLongLong, XTENSA_OP(lw)},
    {TypeIsUnsignedInt, XTENSA_OP(lw)},
    {TypeIsUnsignedShort, XTENSA_OP(lhu)},
    {TypeIsUnsignedChar, XTENSA_OP(lbu)},
    {TypeUsesFloat32Representation, XTENSA_OP(flw)},
    {XTENSAFpIsDoubleWidth, XTENSA_OP(fld)},
    {TypeIsBool, XTENSA_OP(lb)},
    {TypeIsPointerOrArray, XTENSA_OP(lw)},
    {TypeIsFunction, XTENSA_OP(lw)},
    {NULL, 0},
};

static TargetInstruction* FinishWithDest(XTENSAGenerator* rv, IRNode* node,
                                         TargetInstruction* result,
                                         XTENSAOpcode mov_opcode);

static COMPILER_UNUSED TargetInstruction* LoadVariableValue(
    XTENSAGenerator* rv, IRNode* node, TargetInstruction* addr,
    TargetInstruction* offset) {
  XTENSAOpcode opcode = XTENSA_OP(lw);
...
static TargetInstruction* TlsGetAddrCall(XTENSAGenerator* rv, IRNode* node) {
  IRVariable* variable = (IRVariable*)node;
  TargetInstruction* symbol = GetSymbol(rv, node, variable->symbol);
  TargetInstruction* index =
      Emit(rv, NewInstruction1(XTENSA_OP(tlsgd), symbol));
  rv->not_leaf = true;
  rv->base.num_calls++;
  TargetInstruction* arg0 =
      SetDestOrMove(rv, index, IntArgumentRegister(rv, 0), XTENSA_OP(mv));
  TargetInstruction* regarg =
      Emit(rv, NewInstruction2(XTENSA_OP(regarg), NULL, arg0));
  TargetInstruction* fn = GetSymbol(rv, NULL, rv->base.__tls_get_addr);
  return Emit(rv, NewInstruction2(XTENSA_OP(call), fn, regarg));
}

static TargetInstruction* GetTlsVariableAddress(XTENSAGenerator* rv,
                                                IRNode* node) {
  ...
  IRVariable* variable = (IRVariable*)node;
  TargetInstruction* symbol = GetSymbol(rv, node, variable->symbol);
  return Emit(rv, NewInstruction1(XTENSA_OP(tprel), symbol));
}

static TargetInstruction* MaterializeDoubleConstantBits(XTENSAGenerator* rv,
                                                        uint64_t bits) {
  TargetInstruction* lo = Emit(
      rv,
      NewInstruction1(XTENSA_OP(li), GetIntConstant(rv, NULL, kTargetType32Bit,
                                                    (int32_t)(uint32_t)bits)));
  TargetInstruction* hi = Emit(
      rv, NewInstruction1(XTENSA_OP(li),
                          GetIntConstant(rv, NULL, kTargetType32Bit,
                                         (int32_t)(uint32_t)(bits >> 32))));
  TargetInstruction* newsp = AddImmediate(rv, StackPointer(rv), -16);
  TargetSetDest(newsp, StackPointer(rv));
  Emit(rv, NewInstruction3(XTENSA_OP(sw), lo, StackPointer(rv),
                           GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
  Emit(rv, NewInstruction3(XTENSA_OP(sw), hi, StackPointer(rv),
                           GetIntConstant(rv, NULL, kTargetType32Bit, 4)));
  TargetInstruction* result =
      Emit(rv, NewInstruction2(XTENSA_OP(fld), StackPointer(rv),
                               GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
  TargetInstruction* restore = AddImmediate(rv, StackPointer(rv), 16);
  TargetSetDest(restore, StackPointer(rv));
  TargetAddUser(result, restore);
  return result;
}
...
static TargetInstruction* Materialize(XTENSAGenerator* rv, IRNode* node) {
  ...
  if (IRIsConst(node)) {
    switch (node->opcode) {
      ...
      case IR_OP(consta):
        if (IRIsZero(node)) {
          // RISC-V32 has an explicit zero register (x0).  If we are loading
          // the constant zero, just move it into the destination.
          // return Emit(rv, NewInstruction1(XTENSA_OP(mv), Zero(rv)));
          return Zero(rv);
        } else {
          return Emit(rv, NewInstruction1(XTENSA_OP(li), GetLoweredNode(node)));
        }
      case IR_OP(constf): {
        ...
        return Emit(rv, NewInstruction1(XTENSA_OP(fmv_w_x), c));
      }
      case IR_OP(constd): {
        double value = ((IRConstant*)node)->value.fvalue;
        uint64_t bits;
        memcpy(&bits, &value, sizeof(bits));
        return MaterializeDoubleConstantBits(rv, bits);
      }
      default:
        assert(false);
    }
  ...
  if (IRIsAutoVariable(node)) {
    ...
    if (TypeIsVLA(node->type)) {
      ...
      if (XTENSA_IS_REG_VAR(var_offset)) {
        // Variable is in a register.
        int var_num = var_offset & ~XTENSA_REG_VAR;
...
static TargetInstruction* MaterializeIntConstantToTmp(XTENSAGenerator* rv,
                                                      IRConstant* constant) {
  return Emit(rv, NewInstruction1(XTENSA_OP(li),
                                  GetIntConstant(rv, NULL, kTargetType64Bit,
                                                 constant->value.ivalue)));
}

static void ApplyFixups(XTENSAGenerator* rv, IRNode* label_node) {
...
//
// While each RISC-V32 processor is different, let's assume that the multiplier
...
static TargetInstruction* MultiplyByConstant(XTENSAGenerator* rv,
                                             IRNode* variable,
                                             IRConstant* constant) {
  ...
  while (value != 0) {
    if ((value & 1) == 1) {
      ...
      if (left != NULL && right != NULL) {
        ...
        inst = Emit(rv, NewInstruction2(XTENSA_OP(add), left, right));
...
static TargetInstruction* LowerWideExpression(XTENSAGenerator* rv,
                                              IRNode* node);
static TargetInstruction* LowerWideLoad(XTENSAGenerator* rv, IRNode* node);
static TargetInstruction* LowerWideStore(XTENSAGenerator* rv, IRNode* node);
static void MaterializeWide(XTENSAGenerator* rv, IRNode* node,
                            TargetInstruction** lo, TargetInstruction** hi);
static TargetInstruction* LowerWideIntToFP(XTENSAGenerator* rv, IRNode* node);
static TargetInstruction* LowerFPToWideInt(XTENSAGenerator* rv, IRNode* node);

static TargetInstruction* LowerExpression(XTENSAGenerator* rv, IRNode* node) {
  // If we have already lowered the IR node, return it.
  if (node->data.ptr != NULL) {
    return node->data.ptr;
  }
  XTENSAOpcode opcode = IR2RV(node->opcode);
  if ((node->opcode == IR_OP(i2f) || node->opcode == IR_OP(i2d)) &&
      TypeIsUnsigned(((IRNode*)node->inputs.value.p[0])->type)) {
    opcode = node->opcode == IR_OP(i2f) ? XTENSA_OP(fcvt_s_wu)
                                        : XTENSA_OP(fcvt_d_wu);
  } else if ((node->opcode == IR_OP(f2i) || node->opcode == IR_OP(d2i)) &&
             TypeIsUnsigned(node->type)) {
    opcode = node->opcode == IR_OP(f2i) ? XTENSA_OP(fcvt_wu_s)
                                        : XTENSA_OP(fcvt_wu_d);
  }
  if (node->opcode == IR_OP(tmp) && TypeIsWideInt(node->type)) {
    TargetInstruction* marker = Emit(rv, NewInstruction(XTENSA_OP(tmp)));
    return SetLoweredNode(node, marker);
  }
  if ((node->opcode == IR_OP(i2f) || node->opcode == IR_OP(i2d)) &&
      NodeIsWideInt(node->inputs.value.p[0])) {
    return LowerWideIntToFP(rv, node);
  }
  if ((node->opcode == IR_OP(f2i) || node->opcode == IR_OP(d2i)) &&
      NodeIsWideInt(node)) {
    return LowerFPToWideInt(rv, node);
  }
  if (NodeIsWideInt(node)) {
    switch (node->opcode) {
      ...
      case IR_OP(divi):
      case IR_OP(modi):
        return LowerWideExpression(rv, node);
      default:
        break;
    }
  }
  ...
  switch (opcode) {
    ...
    case XTENSA_OP(add): {
      ...
      if (IRIsConst(op2)) {
        ...
        if (XTENSAIsPossibleImmediate(c)) {
          inst = (TargetInstruction*)NewInstruction(XTENSA_OP(addi));
      ...
      if (IRIsConst(op2)) {
        ...
        if (c == 0) {
          ...
          switch (opcode) {
            case XTENSA_OP(sll):
              // TODO: slliw?
              opcode = XTENSA_OP(slli);
              break;
            case XTENSA_OP(srl):
              opcode = XTENSA_OP(srli);
              break;
            case XTENSA_OP(sra):
              opcode = XTENSA_OP(srai);
              break;
            default:
              break;
          }
    ...
    case XTENSA_OP(rem): {
      ...
      if (IRIsConst(op2)) {
        ...
        if (TypeIsUnsigned(node->type) && IsPowerOf2(c) && c < 64) {
          int64_t mask = c - 1;
          inst =
              NewInstruction2(XTENSA_OP(andi), Materialize(rv, op1),
    ...
    case XTENSA_OP(and): {
      ...
      if (IRIsConst(op2)) {
        ...
        if (c == 0) {
          ...
          inst = Zero(rv);
        } else if (XTENSAIsPossibleImmediate(c)) {
          inst = (TargetInstruction*)NewInstruction(XTENSA_OP(andi));
          inst->operand[0] = Materialize(rv, op1);
          inst->operand[1] = GetLoweredNode(op2);
        } else {
          inst = NewInstruction2(
              XTENSA_OP(and), Materialize(rv, op1),
              MaterializeIntConstantToTmp(rv, (IRConstant*)op2));
        }
      } else if (IRIsConst(op1)) {
        int64_t c = ((IRConstant*)op1)->value.ivalue;
        if (c == 0) {
          ...
          inst = NewInstruction2(
              XTENSA_OP(and), Materialize(rv, op2),
              MaterializeIntConstantToTmp(rv, (IRConstant*)op1));
        }
      }
      break;
    }
    ...
    case XTENSA_OP(or): {
      ...
      if (IRIsConst(op2)) {
        ...
        if (c == 0) {
          ...
          inst = (TargetInstruction*)NewInstruction(XTENSA_OP(ori));
          inst->operand[0] = Materialize(rv, op1);
          inst->operand[1] = GetLoweredNode(op2);
        } else {
          inst = NewInstruction2(
              XTENSA_OP(or), Materialize(rv, op1),
              MaterializeIntConstantToTmp(rv, (IRConstant*)op2));
        }
      } else if (IRIsConst(op1)) {
        int64_t c = ((IRConstant*)op1)->value.ivalue;
        if (c == 0) {
          ...
          inst = NewInstruction2(
              XTENSA_OP(or), Materialize(rv, op2),
              MaterializeIntConstantToTmp(rv, (IRConstant*)op1));
        }
      }
      break;
  ...
  // RISC-V32 has distinct signed/unsigned divide and remainder instructions,
  // but IR2RV only sees the IR opcode (not the operand type) and so defaults to
  // the signed forms.  Promote to the unsigned forms when the result type is
  // unsigned.  Without this, an unsigned operation such as ULLONG_MAX / 10
  // would be lowered to the signed (-1) / 10 == 0, corrupting e.g. printf's
  // decimal conversion of large values.  (The strength-reduced power-of-2 cases
  // handled in the switch above are already type-aware and have set `inst`, so
  // they are unaffected.)
  if (TypeIsUnsigned(node->type)) {
    if (opcode == XTENSA_OP(div)) {
      opcode = XTENSA_OP(divu);
    } else if (opcode == XTENSA_OP(rem)) {
      opcode = XTENSA_OP(remu);
    }
  }
  if (inst == NULL) {
    inst = (TargetInstruction*)NewInstruction(opcode);
  ...
  if ((XTENSAOpcode)inst->opcode == XTENSA_OP(tmp) &&
      TypeIsFloatingPoint(node->type)) {
    inst->flags |= XTENSA_INST_FLOAT_TMP;
  }
  XTENSAOpcode mov_opcode = XTENSA_OP(mv);
  if (TypeIsFloatingPoint(node->type)) {
    mov_opcode =
        XTENSAFpIsDoubleWidth(node->type) ? XTENSA_OP(fmv_d) : XTENSA_OP(fmv_s);
  }
  return FinishWithDest(rv, node, inst, mov_opcode);
}

static COMPILER_UNUSED TargetInstruction* LowerRmov(XTENSAGenerator* rv,
                                                    IRNode* node) {
...
static TargetInstruction* GetDestInstruction(XTENSAGenerator* rv,
                                             IRNode* node) {
  if (node->dest == NULL) {
    return NULL;
  }
...
static TargetInstruction* SubtractForComparison(XTENSAGenerator* rv,
                                                IRNode* node, IRNode* op1,
                                                IRNode* op2) {
  if (TypeIsWideInt(op1->type) || TypeIsWideInt(op2->type)) {
    TargetInstruction *alo, *ahi, *blo, *bhi;
    MaterializeWide(rv, op1, &alo, &ahi);
    if (IRIsConst(op2) && ((IRConstant*)op2)->value.ivalue == 0) {
      return Emit(rv, NewInstruction2(XTENSA_OP(or), alo, ahi));
    }
    MaterializeWide(rv, op2, &blo, &bhi);
    TargetInstruction* xlo =
        Emit(rv, NewInstruction2(XTENSA_OP(xor), alo, blo));
    TargetInstruction* xhi =
        Emit(rv, NewInstruction2(XTENSA_OP(xor), ahi, bhi));
    return Emit(rv, NewInstruction2(XTENSA_OP(or), xlo, xhi));
  }
  if (!IRIsConst(op2)) {
    // Second operand isn't constant, compiled as sub.
    return Emit(rv, NewInstruction2(XTENSA_OP(sub), Materialize(rv, op1),
                                    Materialize(rv, op2)));
  }
  ...
  if (XTENSAIsPossibleImmediate(value)) {
...
// instructions.
static TargetInstruction* CompareLessThanInt(XTENSAGenerator* rv, IRNode* node,
  ...
  if (TypeIsWideInt(op1->type) || TypeIsWideInt(op2->type)) {
    ...
    MaterializeWide(rv, op1, &alo, &ahi);
    MaterializeWide(rv, op2, &blo, &bhi);
    TargetInstruction* hi_lt =
        Emit(rv, NewInstruction2(is_unsigned ? XTENSA_OP(sltu) : XTENSA_OP(slt),
                                 ahi, bhi));
    TargetInstruction* hi_ne =
        Emit(rv, NewInstruction2(XTENSA_OP(xor), ahi, bhi));
    hi_ne = Emit(rv, NewInstruction1(XTENSA_OP(snez), hi_ne));
    TargetInstruction* lo_lt =
        Emit(rv, NewInstruction2(XTENSA_OP(sltu), alo, blo));
    TargetInstruction* hi_eq =
        Emit(rv, NewInstruction1(XTENSA_OP(seqz), hi_ne));
    TargetInstruction* from_hi =
        Emit(rv, NewInstruction2(XTENSA_OP(and), hi_lt, hi_ne));
    TargetInstruction* from_lo =
        Emit(rv, NewInstruction2(XTENSA_OP(and), lo_lt, hi_eq));
    return Emit(rv, NewInstruction2(XTENSA_OP(or), from_hi, from_lo));
  }
  if (!IRIsConst(op2)) {
    ...
    return Emit(
        rv, NewInstruction2(is_unsigned ? XTENSA_OP(sltu) : XTENSA_OP(slt), i1,
                            i2));
  }
  ...
  if (!is_unsigned && value == 0) {
    ...
    return Emit(rv, NewInstruction1(XTENSA_OP(sltz), Materialize(rv, op1)));
  }

  if (XTENSAIsPossibleImmediate(value)) {
    // Immediate, use slti/sltiu.
    return Emit(
        rv, NewInstruction2(is_unsigned ? XTENSA_OP(sltiu) : XTENSA_OP(slti),
                            Materialize(rv, op1),
  ...
  return Emit(rv,
              NewInstruction2(is_unsigned ? XTENSA_OP(sltu) : XTENSA_OP(slt),
                              Materialize(rv, op1), Materialize(rv, op2)));
}
...
// RISC-V32 has combined compare and branch instructions so we can generally
...
static TargetInstruction* LowerComparison(XTENSAGenerator* rv, IRNode* node) {
  assert(node->inputs.length == 2);
  IRNode* op1 = node->inputs.value.p[0];
  IRNode* op2 = node->inputs.value.p[1];
  switch (node->opcode) {
    ...
    case IR_OP(cmpeqa): {
      ...
      if (sub == NULL) {
        return Emit(
            rv, SetLoweredNode(node, NewInstruction1(XTENSA_OP(seqz),
                                                     Materialize(rv, op1))));
      } else {
        return Emit(
            rv, SetLoweredNode(node, NewInstruction1(XTENSA_OP(seqz), sub)));
      }
    }
    case IR_OP(cmpnei):
    case IR_OP(cmpnea): {
      ...
      if (sub == NULL) {
        return Emit(
            rv, SetLoweredNode(node, NewInstruction1(XTENSA_OP(snez),
                                                     Materialize(rv, op1))));
      } else {
        return Emit(
            rv, SetLoweredNode(node, NewInstruction1(XTENSA_OP(snez), sub)));
      }
    }
    case IR_OP(cmplti):
    case IR_OP(cmplta):
    ...
    case IR_OP(cmplea): {
      ...
      return Emit(rv,
                  SetLoweredNode(node, NewInstruction1(XTENSA_OP(seqz), slt)));
    }
    ...
    case IR_OP(cmpeqf):
      ...
      return Emit(
          rv, SetLoweredNode(
                  node, NewInstruction2(XTENSA_OP(feq_s), Materialize(rv, op1),
                                        Materialize(rv, op2))));
    ...
    case IR_OP(cmpnef): {
      ...
      TargetInstruction* cmp =
          Emit(rv, NewInstruction2(XTENSA_OP(feq_s), Materialize(rv, op1),
                                   Materialize(rv, op2)));
      return Emit(rv,
                  SetLoweredNode(node, NewInstruction1(XTENSA_OP(seqz), cmp)));
    }
    ...
    case IR_OP(cmpltf):
      ...
      return Emit(
          rv, SetLoweredNode(
                  node, NewInstruction2(XTENSA_OP(flt_s), Materialize(rv, op1),
                                        Materialize(rv, op2))));
    case IR_OP(cmplef):
      // fle.s op1, op2
      return Emit(
          rv, SetLoweredNode(
                  node, NewInstruction2(XTENSA_OP(fle_s), Materialize(rv, op1),
                                        Materialize(rv, op2))));
    case IR_OP(cmpgtf):
      // flt.s op2, op1
      return Emit(
          rv, SetLoweredNode(
                  node, NewInstruction2(XTENSA_OP(flt_s), Materialize(rv, op2),
                                        Materialize(rv, op1))));
    case IR_OP(cmpgef):
      // fle.s op2, op1
      return Emit(
          rv, SetLoweredNode(
                  node, NewInstruction2(XTENSA_OP(fle_s), Materialize(rv, op2),
                                        Materialize(rv, op1))));
    ...
    case IR_OP(cmpeqd):
      ...
      return Emit(
          rv, SetLoweredNode(
                  node, NewInstruction2(XTENSA_OP(feq_d), Materialize(rv, op1),
                                        Materialize(rv, op2))));
    case IR_OP(cmpned): {
      // feq.d op1, op2
      // invert
      TargetInstruction* cmp =
          Emit(rv, NewInstruction2(XTENSA_OP(feq_d), Materialize(rv, op1),
                                   Materialize(rv, op2)));
      return Emit(rv,
                  SetLoweredNode(node, NewInstruction1(XTENSA_OP(seqz), cmp)));
    }
    ...
    case IR_OP(cmpltd):
      ...
      return Emit(
          rv, SetLoweredNode(
                  node, NewInstruction2(XTENSA_OP(flt_d), Materialize(rv, op1),
                                        Materialize(rv, op2))));
    case IR_OP(cmpled):
      // fle.d op1, op2
      return Emit(
          rv, SetLoweredNode(
                  node, NewInstruction2(XTENSA_OP(fle_d), Materialize(rv, op1),
                                        Materialize(rv, op2))));
    case IR_OP(cmpgtd):
      // flt.d op2, op1
      return Emit(
          rv, SetLoweredNode(
                  node, NewInstruction2(XTENSA_OP(flt_d), Materialize(rv, op2),
                                        Materialize(rv, op1))));
    case IR_OP(cmpged):
      // fle.d op2, op1
      return Emit(
          rv, SetLoweredNode(
                  node, NewInstruction2(XTENSA_OP(fle_d), Materialize(rv, op2),
                                        Materialize(rv, op1))));
    default:
      assert(false);
  }
...
// point we also detect the unordered case: RISC-V32 flt yields 0 for either NaN
// operand, so we add 2 when feq(a,a) & feq(b,b) is false.
static TargetInstruction* LowerThreeWay(XTENSAGenerator* rv, IRNode* node) {
  assert(node->inputs.length == 2);
  ...
  if (is_float || is_double) {
    XTENSAOpcode flt = is_double ? XTENSA_OP(flt_d) : XTENSA_OP(flt_s);
    XTENSAOpcode feq = is_double ? XTENSA_OP(feq_d) : XTENSA_OP(feq_s);
    ...
    TargetInstruction* diff = Emit(rv, NewInstruction2(XTENSA_OP(sub), gt, lt));
    TargetInstruction* aord = Emit(rv, NewInstruction2(feq, ma, ma));
    TargetInstruction* bord = Emit(rv, NewInstruction2(feq, mb, mb));
    TargetInstruction* both =
        Emit(rv, NewInstruction2(XTENSA_OP(and), aord, bord));
    TargetInstruction* unord = Emit(rv, NewInstruction1(XTENSA_OP(seqz), both));
    TargetInstruction* twice =
        Emit(rv, NewInstruction2(XTENSA_OP(add), unord, unord));
    return SetLoweredNode(
        node, Emit(rv, NewInstruction2(XTENSA_OP(add), diff, twice)));
  }
  ...
  return SetLoweredNode(node,
                        Emit(rv, NewInstruction2(XTENSA_OP(sub), gt, lt)));
}

static void GetAddressAndOffsetFrom(XTENSAGenerator* rv,
                                    TargetInstruction* addr, int offset,
  ...
  int page_offset;
  TargetInstruction* page_inst =
      PagedOffsetFrom(rv, addr, offset, &page_offset);
  *addr_inst = page_inst;
  *offset_inst = GetIntConstant(rv, NULL, kTargetType32Bit, page_offset);
}

static bool GetRegAndOffset(XTENSAGenerator* rv, IRNode* addr_node,
  ...
  if (IRIsThreadVariable(addr_node)) {
    ...
    *offset = Zero(rv);
    ...
    if ((addr_node->flags & kIRNrvoMarker) != 0) {
      // NRVO variable.
      int reg = addr_node->data.ivalue & ~XTENSA_REG_VAR;
    ...
    // Auto variable is in the stack frame.  These are accessed through
    // the frame pointer with a negative offset.
    GetAddressAndOffsetFrom(rv, FramePointer(rv),
                            LocalVariableOffset(rv, var_offset), addr, offset);
    ...
    if (XTENSA_IS_REG_VAR(var_offset)) {
      ...
      *offset = NULL;
      ...
      GetAddressAndOffsetFrom(rv, FramePointer(rv), var_offset, addr, offset);
    }
...
static TargetInstruction* Load(XTENSAGenerator* rv, IRNode* addr_node,
                               XTENSAOpcode opcode) {
  TargetInstruction* addr;
  TargetInstruction* offset;
  ...
  if (!on_stack) {
    if (TypeIsFloatingPoint(addr_node->type)) {
      return Emit(rv, NewInstruction1(XTENSAFpIsDoubleWidth(addr_node->type)
                                          ? XTENSA_OP(fmv_d)
                                          : XTENSA_OP(fmv_s),
                                      addr));
    }
    return Emit(rv, NewInstruction1(XTENSA_OP(mv), addr));
  }
...
static TargetInstruction* WideMov(XTENSAGenerator* rv, TargetInstruction* src) {
  return Emit(rv, NewInstruction1(XTENSA_OP(mv), src));
}
...
static void MaterializeWide(XTENSAGenerator* rv, IRNode* node,
  ...
  if (IRIsConst(node)) {
    ...
    *lo = Emit(rv, NewInstruction1(XTENSA_OP(li),
                                   GetIntConstant(rv, NULL, kTargetType32Bit,
                                                  (int32_t)(uint32_t)v)));
    *hi =
        Emit(rv, NewInstruction1(XTENSA_OP(li),
                                 GetIntConstant(rv, NULL, kTargetType32Bit,
                                                (int32_t)(uint32_t)(v >> 32))));
    if (*lo != *hi) {
...
static TargetInstruction* LowerWideIntToFP(XTENSAGenerator* rv, IRNode* node) {
  ...
  MaterializeWide(rv, node->inputs.value.p[0], &lo, &hi);
  TargetInstruction* high = Emit(
      rv,
      NewInstruction1(TypeIsUnsigned(((IRNode*)node->inputs.value.p[0])->type)
                          ? XTENSA_OP(fcvt_d_wu)
                          : XTENSA_OP(fcvt_d_w),
                      hi));
  TargetInstruction* scale =
      MaterializeDoubleConstantBits(rv, UINT64_C(0x41f0000000000000));
  high = Emit(rv, NewInstruction2(XTENSA_OP(fmul_d), high, scale));
  TargetInstruction* low = Emit(rv, NewInstruction1(XTENSA_OP(fcvt_d_wu), lo));
  TargetInstruction* result =
      Emit(rv, NewInstruction2(XTENSA_OP(fadd_d), high, low));
  if (node->opcode == IR_OP(i2f)) {
    result = Emit(rv, NewInstruction1(XTENSA_OP(fcvt_s_d), result));
  }
  return SetLoweredNode(node, result);
}
...
static TargetInstruction* LowerFPToWideInt(XTENSAGenerator* rv, IRNode* node) {
  ...
  if (node->opcode == IR_OP(f2i)) {
    value = Emit(rv, NewInstruction1(XTENSA_OP(fcvt_d_s), value));
  }
  TargetInstruction* arg0 = SetDestOrMove(
      rv, value, FloatingPointArgumentRegister(rv, 0), XTENSA_OP(fmv_d));
  TargetInstruction* regarg =
      Emit(rv, NewInstruction2(XTENSA_OP(regarg), NULL, arg0));
  TargetInstruction* sym = GetSymbol(
      rv, NULL,
      GetLibcallSymbol(TypeIsUnsigned(node->type) ? "__davecc_double_to_u64"
                                                  : "__davecc_double_to_i64"));
  TargetInstruction* call =
      Emit(rv, NewInstruction2(XTENSA_OP(call), sym, regarg));
  rv->not_leaf = true;
  rv->base.num_calls++;

  TargetInstruction* hi =
      Emit(rv, NewInstruction1(XTENSA_OP(mv), IntArgumentRegister(rv, 1)));
  TargetInstruction* lo = Emit(rv, NewInstruction1(XTENSA_OP(mv), call));
  PairWideHalves(lo, hi);
  SetLoweredHi(node, hi);
  return SetLoweredNode(node, lo);
}

static TargetInstruction* WideLibCall(XTENSAGenerator* rv, IRNode* node,
                                      const char* name) {
  IRNode* a = node->inputs.value.p[0];
  IRNode* b = node->inputs.value.p[1];
  TargetInstruction *alo, *ahi, *blo, *bhi;
  MaterializeWide(rv, a, &alo, &ahi);
  MaterializeWide(rv, b, &blo, &bhi);

  TargetInstruction* arg0 =
      SetDestOrMove(rv, alo, IntArgumentRegister(rv, 0), XTENSA_OP(mv));
  TargetInstruction* arg1 =
      SetDestOrMove(rv, ahi, IntArgumentRegister(rv, 1), XTENSA_OP(mv));
  TargetInstruction* arg2 =
      SetDestOrMove(rv, blo, IntArgumentRegister(rv, 2), XTENSA_OP(mv));
  TargetInstruction* arg3 =
      SetDestOrMove(rv, bhi, IntArgumentRegister(rv, 3), XTENSA_OP(mv));

  TargetInstruction* regarg =
      Emit(rv, NewInstruction2(XTENSA_OP(regarg), NULL, arg3));
  regarg = Emit(rv, NewInstruction2(XTENSA_OP(regarg), regarg, arg2));
  regarg = Emit(rv, NewInstruction2(XTENSA_OP(regarg), regarg, arg1));
  regarg = Emit(rv, NewInstruction2(XTENSA_OP(regarg), regarg, arg0));

  TargetInstruction* sym = GetSymbol(rv, NULL, GetLibcallSymbol(name));
  TargetInstruction* call =
      Emit(rv, NewInstruction2(XTENSA_OP(call), sym, regarg));
  rv->not_leaf = true;
  rv->base.num_calls++;

  TargetInstruction* a1 = IntArgumentRegister(rv, 1);
  TargetInstruction* hi = Emit(rv, NewInstruction1(XTENSA_OP(mv), a1));
  TargetInstruction* lo = Emit(rv, NewInstruction1(XTENSA_OP(mv), call));
  PairWideHalves(lo, hi);
  SetLoweredHi(node, hi);
  return SetLoweredNode(node, lo);
...
static TargetInstruction* WideLibCallShift(XTENSAGenerator* rv, IRNode* node,
                                           const char* name) {
  IRNode* a = node->inputs.value.p[0];
  IRNode* b = node->inputs.value.p[1];
  TargetInstruction *alo, *ahi;
  MaterializeWide(rv, a, &alo, &ahi);
  TargetInstruction* amount = Materialize(rv, b);
  ...
  TargetInstruction* arg1 =
      SetDestOrMove(rv, ahi, IntArgumentRegister(rv, 1), XTENSA_OP(mv));
  TargetInstruction* arg2 =
      SetDestOrMove(rv, amount, IntArgumentRegister(rv, 2), XTENSA_OP(mv));
...
static TargetInstruction* LowerWideExpression(XTENSAGenerator* rv,
  ...
  switch (node->opcode) {
    case IR_OP(const64):
    case IR_OP(consta):
      MaterializeWide(rv, node, &lo, &hi);
      break;

    case IR_OP(movi): {
      TargetInstruction *alo, *ahi;
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      lo = WideMov(rv, alo);
      hi = WideMov(rv, ahi);
      break;
    }
    ...
    case IR_OP(addi): {
      TargetInstruction *alo, *ahi, *blo, *bhi;
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      MaterializeWide(rv, node->inputs.value.p[1], &blo, &bhi);
      lo = Emit(rv, NewInstruction2(XTENSA_OP(add), alo, blo));
      TargetInstruction* carry =
          Emit(rv, NewInstruction2(XTENSA_OP(sltu), lo, alo));
      hi = Emit(rv, NewInstruction2(XTENSA_OP(add), ahi, bhi));
      hi = Emit(rv, NewInstruction2(XTENSA_OP(add), hi, carry));
      break;
    }
    ...
    case IR_OP(subi): {
      ...
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      MaterializeWide(rv, node->inputs.value.p[1], &blo, &bhi);
      lo = Emit(rv, NewInstruction2(XTENSA_OP(sub), alo, blo));
      TargetInstruction* borrow =
          Emit(rv, NewInstruction2(XTENSA_OP(sltu), alo, blo));
      hi = Emit(rv, NewInstruction2(XTENSA_OP(sub), ahi, bhi));
      hi = Emit(rv, NewInstruction2(XTENSA_OP(sub), hi, borrow));
      break;
    }
    ...
    case IR_OP(ori):
    case IR_OP(xori): {
      XTENSAOpcode op = node->opcode == IR_OP(andi)  ? XTENSA_OP(and)
                        : node->opcode == IR_OP(ori) ? XTENSA_OP(or)
                                                     : XTENSA_OP(xor);
      TargetInstruction *alo, *ahi, *blo, *bhi;
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      MaterializeWide(rv, node->inputs.value.p[1], &blo, &bhi);
      lo = Emit(rv, NewInstruction2(op, alo, blo));
      hi = Emit(rv, NewInstruction2(op, ahi, bhi));
      break;
    }
    ...
    case IR_OP(muli): {
      ...
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      MaterializeWide(rv, node->inputs.value.p[1], &blo, &bhi);
      lo = Emit(rv, NewInstruction2(XTENSA_OP(mul), alo, blo));
      hi = Emit(rv, NewInstruction2(XTENSA_OP(mulhu), alo, blo));
      TargetInstruction* t1 =
          Emit(rv, NewInstruction2(XTENSA_OP(mul), alo, bhi));
      hi = Emit(rv, NewInstruction2(XTENSA_OP(add), hi, t1));
      TargetInstruction* t2 =
          Emit(rv, NewInstruction2(XTENSA_OP(mul), ahi, blo));
      hi = Emit(rv, NewInstruction2(XTENSA_OP(add), hi, t2));
      break;
    }

    case IR_OP(divi):
      return WideLibCall(rv, node,
    ...
    case IR_OP(onescomp): {
      TargetInstruction *alo, *ahi;
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      lo = Emit(rv, NewInstruction1(XTENSA_OP(not), alo));
      hi = Emit(rv, NewInstruction1(XTENSA_OP(not), ahi));
      break;
    }
    ...
    case IR_OP(negi): {
      TargetInstruction *alo, *ahi;
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      TargetInstruction* nlo = Emit(rv, NewInstruction1(XTENSA_OP(not), alo));
      TargetInstruction* nhi = Emit(rv, NewInstruction1(XTENSA_OP(not), ahi));
      TargetInstruction* one = GetIntConstant(rv, NULL, kTargetType32Bit, 1);
      lo = Emit(rv, NewInstruction2(XTENSA_OP(addi), nlo, one));
      TargetInstruction* carry =
          Emit(rv, NewInstruction2(XTENSA_OP(sltu), lo, nlo));
      hi = Emit(rv, NewInstruction2(XTENSA_OP(add), nhi, carry));
      break;
    }
    ...
    case IR_OP(asri): {
      ...
      if (!IRIsConst(amount)) {
        const char* name = node->opcode == IR_OP(lsli)   ? "__ashldi3"
                           : node->opcode == IR_OP(lsri) ? "__lshrdi3"
                                                         : "__ashrdi3";
        return WideLibCallShift(rv, node, name);
      }
      TargetInstruction *alo, *ahi;
      MaterializeWide(rv, node->inputs.value.p[0], &alo, &ahi);
      ...
      if (n == 0) {
        ...
        if (n < 32) {
          TargetInstruction* nconst =
              GetIntConstant(rv, NULL, kTargetType32Bit, n);
          TargetInstruction* ncross =
              GetIntConstant(rv, NULL, kTargetType32Bit, 32 - n);
          TargetInstruction* hi_hi =
              Emit(rv, NewInstruction2(XTENSA_OP(slli), ahi, nconst));
          TargetInstruction* hi_lo =
              Emit(rv, NewInstruction2(XTENSA_OP(srli), alo, ncross));
          hi = Emit(rv, NewInstruction2(XTENSA_OP(or), hi_hi, hi_lo));
          lo = Emit(rv, NewInstruction2(XTENSA_OP(slli), alo, nconst));
        } else {
          hi = (n == 32)
                   ? WideMov(rv, alo)
                   : Emit(rv, NewInstruction2(
        ...
        XTENSAOpcode high_op =
            (op == IR_OP(asri)) ? XTENSA_OP(srai) : XTENSA_OP(srli);
        if (n < 32) {
          TargetInstruction* nconst =
              GetIntConstant(rv, NULL, kTargetType32Bit, n);
          TargetInstruction* ncross =
          ...
          TargetInstruction* lo_lo =
              Emit(rv, NewInstruction2(XTENSA_OP(srli), alo, nconst));
          TargetInstruction* lo_hi =
              Emit(rv, NewInstruction2(XTENSA_OP(slli), ahi, ncross));
          lo = Emit(rv, NewInstruction2(XTENSA_OP(or), lo_lo, lo_hi));
          hi = Emit(rv, NewInstruction2(high_op, ahi, nconst));
        } else if (op == IR_OP(asri)) {
          lo = (n == 32)
                   ? WideMov(rv, ahi)
                   : Emit(rv, NewInstruction2(
                                  XTENSA_OP(srai), ahi,
                                  GetIntConstant(rv, NULL, kTargetType32Bit,
                                                 n - 32)));
          hi = Emit(rv, NewInstruction2(
                            XTENSA_OP(srai), ahi,
                            GetIntConstant(rv, NULL, kTargetType32Bit, 31)));
        } else {
          lo = (n == 32)
                   ? WideMov(rv, ahi)
                   : Emit(rv, NewInstruction2(
...
static TargetInstruction* LowerWideLoad(XTENSAGenerator* rv, IRNode* node) {
  ...
  if (!on_stack) {
    ...
    lo = Emit(rv, NewInstruction2(XTENSA_OP(lw), addr, offset));
    TargetInstruction* offset_hi =
        GetIntConstant(rv, NULL, kTargetType32Bit, off + 4);
    hi = Emit(rv, NewInstruction2(XTENSA_OP(lw), addr, offset_hi));
    PairWideHalves(lo, hi);
  }
  SetLoweredHi(node, hi);
  return SetLoweredNode(node, lo);
...
static TargetInstruction* LowerWideStore(XTENSAGenerator* rv, IRNode* node) {
  ...
  MaterializeWide(rv, src_node, &src_lo, &src_hi);
  ...
  TargetInstruction* offset_hi =
      GetIntConstant(rv, NULL, kTargetType32Bit, off + 4);
  Emit(rv, NewInstruction3(XTENSA_OP(sw), src_hi, addr, offset_hi));
  return SetLoweredNode(node, low_store);
}

static TargetInstruction* LowerLoad(XTENSAGenerator* rv, IRNode* node) {
  XTENSAOpcode opcode;
  ...
  switch (node->opcode) {
    ...
    case IR_OP(loadu32):
      ...
      break;
    case IR_OP(loadu8):
      opcode = XTENSA_OP(lbu);
      break;
    case IR_OP(loadu16):
      opcode = XTENSA_OP(lhu);
      break;
    case IR_OP(loadf):
      opcode = XTENSA_OP(flw);
      break;
    case IR_OP(loadd):
      opcode = XTENSA_OP(fld);
      break;
    case IR_OP(loada):
      opcode = XTENSA_OP(lw);
      break;
...
// register.
static int StoreWidth(XTENSAOpcode opcode) {
  switch (opcode) {
    case XTENSA_OP(sb):
      return 1;
    case XTENSA_OP(sh):
...
static TargetInstruction* NarrowToStoreWidth(XTENSAGenerator* rv,
                                             TargetInstruction* value,
  ...
  if (TargetIsConst(value)) {
    ...
    int64_t narrowed =
        is_signed ? (int64_t)((uint64_t)original << (32 - bits)) >> (32 - bits)
    ...
    return Emit(rv, NewInstruction1(
                        XTENSA_OP(li),
                        GetIntConstant(rv, NULL, kTargetType32Bit, narrowed)));
  }
  TargetInstruction* shift =
      GetIntConstant(rv, NULL, kTargetType32Bit, (int64_t)(32 - bits));
  TargetInstruction* left =
      Emit(rv, NewInstruction2(XTENSA_OP(slli), value, shift));
  return Emit(rv, NewInstruction2(is_signed ? XTENSA_OP(srai) : XTENSA_OP(srli),
                                  left, shift));
}
...
static TargetInstruction* LowerStore(XTENSAGenerator* rv, IRNode* node) {
  XTENSAOpcode opcode;
  assert(node->inputs.length == 2);
  ...
  switch (node->opcode) {
    ...
    case IR_OP(store8):
      ...
      break;
    case IR_OP(store64):
      if (src_node->type != NULL && TypeIsIntegral(src_node->type) &&
          src_node->type->size == 8) {
        return LowerWideStore(rv, node);
      }
      opcode = XTENSA_OP(sw);
      break;
    case IR_OP(store16):
      ...
      break;
    case IR_OP(storef):
      opcode = XTENSA_OP(fsw);
      break;
    case IR_OP(stored):
      opcode = XTENSA_OP(fsd);
      break;
    case IR_OP(storea):
      opcode = XTENSA_OP(sw);
      break;
...
static struct BranchInfo {
  ...
  XTENSAOpcode branch;  // Branch opcode.
  bool reverse;         // Reverse operands.
} branch_compare_ops[] = {
    {IR_OP(cmpeqi), true, XTENSA_OP(beq), false},
    {IR_OP(cmpnei), true, XTENSA_OP(bne), false},
    {IR_OP(cmplti), true, XTENSA_OP(blt), false},
    {IR_OP(cmplei), false, XTENSA_OP(blt), true},
    {IR_OP(cmpgti), true, XTENSA_OP(blt), true},
    {IR_OP(cmpgei), true, XTENSA_OP(bge), false},

    {IR_OP(cmpeqa), true, XTENSA_OP(beq), false},
    {IR_OP(cmpnea), true, XTENSA_OP(bne), false},
    {IR_OP(cmplta), true, XTENSA_OP(bltu), false},
    {IR_OP(cmplea), false, XTENSA_OP(bltu), true},
    {IR_OP(cmpgta), true, XTENSA_OP(bltu), true},
    {IR_OP(cmpgea), true, XTENSA_OP(bgeu), false},

    {IR_OP(cmpeqi), false, XTENSA_OP(bne), false},
    {IR_OP(cmpnei), false, XTENSA_OP(beq), false},
    {IR_OP(cmplti), false, XTENSA_OP(bge), false},
    {IR_OP(cmplei), true, XTENSA_OP(bge), true},
    {IR_OP(cmpgti), false, XTENSA_OP(bge), true},
    {IR_OP(cmpgei), false, XTENSA_OP(blt), false},

    {IR_OP(cmpeqa), false, XTENSA_OP(bne), false},
    {IR_OP(cmpnea), false, XTENSA_OP(beq), false},
    {IR_OP(cmplta), false, XTENSA_OP(bgeu), false},
    {IR_OP(cmplea), true, XTENSA_OP(bgeu), true},
    {IR_OP(cmpgta), false, XTENSA_OP(bgeu), true},
    {IR_OP(cmpgea), false, XTENSA_OP(bltu), false},
};

#define NUM_BRANCH_COMPARES \
  (sizeof(branch_compare_ops) / sizeof(branch_compare_ops[0]))

static TargetInstruction* LowerConditionalBranch(XTENSAGenerator* rv,
                                                 IRNode* node) {
  assert(node->inputs.length == 2);
  ...
  // The RISC-V32 has 3 operand integer compare and branch instructions.
  ...
  if (branch_info != NULL) {
    ...
    if ((IRIsZero(op1) || IRIsZero(op2)) &&
        (branch_info->branch == XTENSA_OP(beq) ||
         branch_info->branch == XTENSA_OP(bne))) {
      XTENSAOpcode branch = branch_info->branch == XTENSA_OP(beq)
                                ? XTENSA_OP(beqz)
                                : XTENSA_OP(bnez);
    ...
    XTENSAOpcode branch_opcode = branch_info->branch;
    if ((op1 != NULL && TypeIsUnsigned(op1->type)) ||
        (op2 != NULL && TypeIsUnsigned(op2->type))) {
      if (branch_opcode == XTENSA_OP(blt)) {
        branch_opcode = XTENSA_OP(bltu);
      } else if (branch_opcode == XTENSA_OP(bge)) {
        branch_opcode = XTENSA_OP(bgeu);
      }
    }
  ...
  switch (node->opcode) {
    case IR_OP(btrue):
      opcode = XTENSA_OP(bnez);
      break;
    case IR_OP(bfalse):
      opcode = XTENSA_OP(beqz);
      break;
    default:
      assert(false);
  }
  ...
  if (OptLevel1() && IRIsConst(expr)) {
    ...
    if (value == 0) {
      ...
      if (opcode == XTENSA_OP(bnez)) {
        // bnez with zero operand means branch will never be taken.
        return Emit(rv, NewInstruction(XTENSA_OP(nop)));
      }
      // beqz with zero is unconditional.
      inst = Emit(rv, NewInstruction(XTENSA_OP(j)));
      target_operand_num = 0;
    } else {
      if (opcode == XTENSA_OP(beqz)) {
    ...
    inst = Emit(rv, NewInstruction1(opcode, Materialize(rv, expr)));
  }
...
static TargetInstruction* LowerBranch(XTENSAGenerator* rv, IRNode* node) {
  ...
  TargetInstruction* inst =
      (TargetInstruction*)Emit(rv, NewInstruction(XTENSA_OP(j)));
...
static TargetInstruction* LowerLabel(XTENSAGenerator* rv, IRNode* label) {
  TargetInstruction* inst = Emit(rv, NewInstruction(XTENSA_OP(label)));
  label->data.ptr = inst;
  ApplyFixups(rv, label);
  return inst;
}

static TargetInstruction* LowerNamedLabel(XTENSAGenerator* rv, IRNode* label) {
...
static TargetInstruction* LowerResult(XTENSAGenerator* rv, IRNode* node) {
  assert(node->inputs.length == 1);
  XTENSAOpcode result_reg_opcode, opcode;
  switch (node->opcode) {
    case IR_OP(resulti):
    case IR_OP(resulta):
      result_reg_opcode = XTENSA_OP(resulti);
      opcode = XTENSA_OP(mv);
      break;
    case IR_OP(resultf):
      result_reg_opcode = XTENSA_OP(resultf);
      opcode = XTENSA_OP(fmv_s);
      break;
    case IR_OP(resultd):
      result_reg_opcode = XTENSA_OP(resultd);
...
#else
  if (node->opcode == IR_OP(resulti) &&
      (NodeIsWideInt(node) || NodeIsWideInt(node->inputs.value.p[0]))) {
    TargetInstruction *lo, *hi;
    MaterializeWide(rv, node->inputs.value.p[0], &lo, &hi);
    TargetInstruction* a0 = EmitSymbol(rv, NewInstruction(XTENSA_OP(resulti)));
    SetDestOrMove(rv, lo, a0, XTENSA_OP(mv));
    TargetInstruction* a1 = IntArgumentRegister(rv, 1);
    return SetLoweredNode(node, SetDestOrMove(rv, hi, a1, XTENSA_OP(mv)));
  }
  TargetInstruction* result = Materialize(rv, node->inputs.value.p[0]);
  TargetInstruction* result_reg =
      EmitSymbol(rv, NewInstruction(result_reg_opcode));
  return SetLoweredNode(node, SetDestOrMove(rv, result, result_reg, opcode));
#endif
}

static TargetInstruction* LowerAsm(XTENSAGenerator* rv, IRNode* node) {
  ...
  if (asm_node == NULL ||
    ...
    TargetInstruction* result =
        Emit(rv, NewInstruction1(XTENSA_OP(asm), literal));

    SetLoweredNode(node, result);
    return result;
  }

  assert(asm_node->outputs.length + asm_node->inputs.length <=
         XTENSA_MAX_ASM_OPERANDS);
  XTENSAAsmInstruction* asm_inst = malloc(sizeof(XTENSAAsmInstruction));
  TargetInitInstruction(&asm_inst->base, (TargetOpcode)XTENSA_OP(asm));
  asm_inst->base.flags |= XTENSA_INST_EXTENDED_ASM;
  asm_inst->base.operand[0] = literal;
  asm_inst->asm_node = asm_node;
  asm_inst->num_operands =
      (int)(asm_node->outputs.length + asm_node->inputs.length);
  memset(asm_inst->immediate_values, 0, sizeof(asm_inst->immediate_values));

  size_t ir_index = 1;
  int operand_index = 0;
  TargetInstruction* output_regs[XTENSA_MAX_ASM_OPERANDS] = {0};
  for (size_t i = 0; i < asm_node->outputs.length; i++, operand_index++) {
    ...
    asm_inst->reg_nums[operand_index] = XTENSA_INT_ARG_START + arg_reg;
    asm_inst->is_fp[operand_index] = false;
    output_regs[i] = reg;
    if (operand->is_readwrite) {
      TargetInstruction* loaded =
          Load(rv, addr_node,
               operand->expr->type->size <= 4 ? XTENSA_OP(lw) : XTENSA_OP(lw));
      SetDestOrMove(rv, loaded, reg, XTENSA_OP(mv));
    }
  }
  ...
  for (size_t i = 0; i < asm_node->inputs.length; i++, operand_index++) {
    ...
    asm_inst->is_fp[operand_index] = false;
    if (strchr(operand->constraint.value, 'i') != NULL &&
        IRIsIntConst(input_node)) {
    ...
    TargetInstruction* reg = IntArgumentRegister(rv, arg_reg);
    asm_inst->reg_nums[operand_index] = XTENSA_INT_ARG_START + arg_reg;
    SetDestOrMove(rv, Materialize(rv, input_node), reg, XTENSA_OP(mv));
  }
...
static TargetInstruction* LowerLiteralReference(XTENSAGenerator* rv,
                                                IRNode* node) {
  IRConstant* id_node = node->inputs.value.p[0];
  TargetInstruction* literal =
      Emit(rv, TargetNewLiteral((int)id_node->value.ivalue));
  ...
  TargetInstruction* result =
      Emit(rv, NewInstruction1(XTENSA_OP(lla), literal));
  ...
  return FinishWithDest(rv, node, result, XTENSA_OP(mv));
}

static TargetInstruction* LowerAddressOf(XTENSAGenerator* rv, IRNode* node) {
  TargetInstruction* src = Materialize(rv, node->inputs.value.p[0]);
  if (XTENSAIsVarRegister(src)) {
    src = Emit(rv, NewInstruction1(XTENSA_OP(mv), src));
  }
  return SetLoweredNode(node, src);
}

static TargetInstruction* LowerZeroExtend(XTENSAGenerator* rv, IRNode* node) {
  IRNode* input = node->inputs.value.p[0];
  TargetInstruction* value;
  if (NodeIsWideInt(input)) {
    TargetInstruction* unused_hi;
    MaterializeWide(rv, input, &value, &unused_hi);
  } else {
    value = Materialize(rv, input);
  }
  ...
  if (NodeIsWideInt(node)) {
    ...
    if (diff > 0 && diff < 32) {
      TargetInstruction* immed =
          GetIntConstant(rv, NULL, kTargetType32Bit, diff);
      TargetInstruction* lsl =
          Emit(rv, NewInstruction2(XTENSA_OP(slli), value, immed));
      lo = Emit(rv, NewInstruction2(XTENSA_OP(srli), lsl, immed));
    }
    TargetInstruction* hi = Zero(rv);
    PairWideHalves(lo, hi);
    SetLoweredHi(node, hi);
    return SetLoweredNode(node, lo);
  }
  if (diff <= 0 || diff >= 32) {
    return FinishWithDest(rv, node, value, XTENSA_OP(mv));
  }
  TargetInstruction* immed = GetIntConstant(rv, NULL, kTargetType32Bit, diff);
  TargetInstruction* lsl =
      Emit(rv, NewInstruction2(XTENSA_OP(slli), value, immed));
  TargetInstruction* lsr =
      Emit(rv, NewInstruction2(XTENSA_OP(srli), lsl, immed));
  return FinishWithDest(rv, node, lsr, XTENSA_OP(mv));
}

static TargetInstruction* LowerInc(XTENSAGenerator* rv, IRNode* node) {
  IRNode* addr_node = node->inputs.value.p[0];
  XTENSAOpcode ld_opcode;
  XTENSAOpcode st_opcode;
  switch (node->opcode) {
    case IR_OP(inc8):
      ld_opcode = XTENSA_OP(lb);
      st_opcode = XTENSA_OP(sb);
      break;
    case IR_OP(uinc8):
      ld_opcode = XTENSA_OP(lbu);
      st_opcode = XTENSA_OP(sb);
      break;
    case IR_OP(inc16):
      ld_opcode = XTENSA_OP(lh);
      st_opcode = XTENSA_OP(sh);
      break;
    case IR_OP(uinc16):
      ld_opcode = XTENSA_OP(lhu);
      st_opcode = XTENSA_OP(sh);
      break;
    case IR_OP(inc32):
      ld_opcode = XTENSA_OP(lw);
      st_opcode = XTENSA_OP(sw);
      break;
    case IR_OP(uinc32):
      ld_opcode = XTENSA_OP(lw);
      st_opcode = XTENSA_OP(sw);
    ...
    case IR_OP(inca):
      ...
      break;
    case IR_OP(incf):
      ld_opcode = XTENSA_OP(flw);
      st_opcode = XTENSA_OP(fsw);
      break;
    case IR_OP(incd):
      ld_opcode = XTENSA_OP(fld);
      st_opcode = XTENSA_OP(fsd);
      break;
    default:
      abort();
  }
  ...
  if (TypeIsFloatingPoint(node->type)) {
    inc = Emit(rv, NewInstruction2(XTENSAFpIsDoubleWidth(node->type)
                                       ? XTENSA_OP(fadd_d)
                                       : XTENSA_OP(fadd_s),
                                   load, amount));
  } else {
...
static TargetInstruction* LowerDec(XTENSAGenerator* rv, IRNode* node) {
  IRNode* addr_node = node->inputs.value.p[0];
  XTENSAOpcode ld_opcode;
  XTENSAOpcode st_opcode;
  switch (node->opcode) {
...
static TargetInstruction* LowerGetBitField(XTENSAGenerator* rv, IRNode* node) {
  TargetInstruction* value = Materialize(rv, node->inputs.value.p[0]);
  ...
  if (TypeIsUnsigned(node->type)) {
    ...
    TargetInstruction* lsr = Emit(
        rv,
        NewInstruction2(XTENSA_OP(srai), value,
                        GetIntConstant(rv, NULL, kTargetType32Bit, bit_pos)));
    uint64_t mask = bit_size == 64 ? -1LL : (1 << bit_size) - 1;
    TargetInstruction* m = Emit(
        rv, NewInstruction2(XTENSA_OP(andi), lsr,
                            GetIntConstant(rv, NULL, kTargetType32Bit, mask)));
    SetLoweredNode(node, m);
    return m;
  }
  // Shift left by 32 - (bit_pos + bit_size).  Top bit in bit 31.
  // Shift right by 32 - bit_size.
  TargetInstruction* lsl =
      Emit(rv, NewInstruction2(XTENSA_OP(slli), value,
                               GetIntConstant(rv, NULL, kTargetType32Bit,
                                              32 - (bit_pos + bit_size))));
  TargetInstruction* asr =
      Emit(rv, NewInstruction2(
                   XTENSA_OP(srai), lsl,
                   GetIntConstant(rv, NULL, kTargetType32Bit, 32 - bit_size)));
...
static TargetInstruction* LowerSetBitField(XTENSAGenerator* rv, IRNode* node) {
  ...
  TargetInstruction* lsl = Emit(
      rv, NewInstruction2(XTENSA_OP(slli), input,
                          GetIntConstant(rv, NULL, kTargetType32Bit, bit_pos)));
  TargetInstruction* m1 = Emit(
      rv, NewInstruction2(XTENSA_OP(andi), lsl,
                          GetIntConstant(rv, NULL, kTargetType32Bit, mask)));

  TargetInstruction* m2 = Emit(
      rv, NewInstruction2(XTENSA_OP(andi), output,
                          GetIntConstant(rv, NULL, kTargetType32Bit, ~mask)));
  TargetInstruction* result = Emit(rv, NewInstruction2(XTENSA_OP(or), m1, m2));
  SetLoweredNode(node, result);
  return result;
}

static TargetInstruction* FinishSignExtend(XTENSAGenerator* rv, IRNode* node,
                                           TargetInstruction* lo) {
  if (NodeIsWideInt(node)) {
    TargetInstruction* hi = Emit(
        rv, NewInstruction2(XTENSA_OP(srai), lo,
                            GetIntConstant(rv, NULL, kTargetType32Bit, 31)));
    PairWideHalves(lo, hi);
    SetLoweredHi(node, hi);
    return SetLoweredNode(node, lo);
  }
  return FinishWithDest(rv, node, lo, XTENSA_OP(mv));
}

static TargetInstruction* LowerSignExtend(XTENSAGenerator* rv, IRNode* node) {
  IRNode* input = node->inputs.value.p[0];
  TargetInstruction* value;
  if (NodeIsWideInt(input)) {
    TargetInstruction* unused_hi;
  ...
  if (XTENSAIsSignedLoad(value)) {
    return FinishSignExtend(rv, node, value);
  }
  ...
  if (diff == 32 || diff == 0) {
    ...
    return FinishSignExtend(rv, node,
                            Emit(rv, NewInstruction1(XTENSA_OP(mv), value)));
  }
  TargetInstruction* immed = GetIntConstant(rv, NULL, kTargetType32Bit, diff);
  TargetInstruction* lsl =
      Emit(rv, NewInstruction2(XTENSA_OP(slli), value, immed));
  TargetInstruction* asr =
      Emit(rv, NewInstruction2(XTENSA_OP(srai), lsl, immed));

  return FinishSignExtend(rv, node, asr);
}

static TargetInstruction* LowerAlign(XTENSAGenerator* rv, IRNode* node) {
  TargetInstruction* value = Materialize(rv, node->inputs.value.p[0]);
  IRConstant* align = node->inputs.value.p[1];

  TargetInstruction* immed =
      GetIntConstant(rv, NULL, kTargetType32Bit, align->value.ivalue - 1);
  TargetInstruction* inv_immed =
      GetIntConstant(rv, NULL, kTargetType32Bit, ~(align->value.ivalue - 1));
  TargetInstruction* add =
      Emit(rv, NewInstruction2(XTENSA_OP(addi), value, immed));
  TargetInstruction*and =
      Emit(rv, NewInstruction2(XTENSA_OP(andi), add, inv_immed));

  SetLoweredNode(node, and);
  return and;
}

static TargetInstruction* PushArg(XTENSAGenerator* rv, IRNode* node,
                                  TargetInstruction* inst, size_t offset) {
  if (node->type == NULL) {
    return Emit(rv, NewInstruction3(
                        XTENSA_OP(sw), inst, StackPointer(rv),
                        GetIntConstant(rv, node, kTargetType64Bit, offset)));
  }
  XTENSAOpcode opcode = XTENSA_OP(sw);
  if (TypeIsFloatingPoint(node->type)) {
    opcode =
        XTENSAFpIsDoubleWidth(node->type) ? XTENSA_OP(fsd) : XTENSA_OP(fsw);
  }
  return Emit(
      rv, NewInstruction3(opcode, inst, StackPointer(rv),
                          GetIntConstant(rv, node, kTargetType64Bit, offset)));
}

static TargetInstruction* PopArg(XTENSAGenerator* rv, IRNode* node,
                                 size_t offset) {
  if (node->type == NULL) {
    return Emit(rv, NewInstruction2(
                        XTENSA_OP(lw), FramePointer(rv),
                        GetIntConstant(rv, node, kTargetType64Bit, offset)));
  }
  XTENSAOpcode opcode = XTENSA_OP(lw);
  if (TypeIsFloatingPoint(node->type)) {
    opcode =
        XTENSAFpIsDoubleWidth(node->type) ? XTENSA_OP(fld) : XTENSA_OP(flw);
  }
  return Emit(
      rv, NewInstruction2(opcode, FramePointer(rv),
                          GetIntConstant(rv, node, kTargetType64Bit, offset)));
}

static TargetInstruction* LowerMemcpy(XTENSAGenerator* rv, IRNode* node) {
  ...
  if (src_offset != NULL) {
    if (!XTENSAIsIntConst(src_offset)) {
  ...
  if (dest_offset != NULL) {
    if (!XTENSAIsIntConst(dest_offset)) {
...
static TargetInstruction* LowerMemzero(XTENSAGenerator* rv, IRNode* node) {
...
typedef struct {
  ...
  XTENSAOpcode opcode;
} XTENSAPendingArgMove;

static XTENSAPendingArgMove* NewPendingArgMove(TargetInstruction* source,
                                               TargetInstruction* destination,
                                               XTENSAOpcode opcode) {
  XTENSAPendingArgMove* move = malloc(sizeof(*move));
  move->source = source;
...
static ArgLocation* NewArgLocationPushedPair(size_t first_offset) {
  ArgLocation* loc = NewArgLocationPushed(kArgLocationPushedPair, first_offset);
  loc->second_offset = first_offset + 4;
  return loc;
}
...
// Build a list of XTENSA_OP(regarg) instructions to hold the
...
static TargetInstruction* BuildArgList(XTENSAGenerator* rv,
  ...
  for (size_t i = 0; i < arg_locations->length; i++) {
    ...
    if (loc->type == kArgLocationRegister) {
      result = Emit(
          rv, NewInstruction2(XTENSA_OP(regarg), result, loc->location.reg));
      ...
      if (loc->second_reg != NULL) {
        result = Emit(
            rv, NewInstruction2(XTENSA_OP(regarg), result, loc->second_reg));
      }
    }
  }
  return result;
...
// The RISC-V32 calling convention is very complex.  There are 8 integer and 8
...
typedef struct {
  ...
  TypeRecord* type[2];
  int offset[2];
} XTENSAFloatingAggregate;

static bool GetFloatingAggregate(TypeRecord* type,
                                 XTENSAFloatingAggregate* aggregate) {
  ...
  for (size_t i = 0; i < info->members.length; i++) {
    ...
    if (member->bit_size != 0 || member->symbol == NULL ||
        (!TypeUsesFloat32Representation(member->symbol->type) &&
         !XTENSAFpIsDoubleWidth(member->symbol->type)) ||
        aggregate->count == 2) {
      return false;
    }
...
static void MaterializeDoubleBits(XTENSAGenerator* rv, IRNode* node,
                                  TargetInstruction** lo,
                                  TargetInstruction** hi) {
  TargetInstruction* value = Materialize(rv, node);
  TargetInstruction* newsp = AddImmediate(rv, StackPointer(rv), -16);
  TargetSetDest(newsp, StackPointer(rv));
  Emit(rv, NewInstruction3(XTENSA_OP(fsd), value, StackPointer(rv),
                           GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
  *lo =
      Emit(rv, NewInstruction2(XTENSA_OP(lw), StackPointer(rv),
                               GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
  *hi =
      Emit(rv, NewInstruction2(XTENSA_OP(lw), StackPointer(rv),
                               GetIntConstant(rv, NULL, kTargetType32Bit, 4)));
  TargetInstruction* restore = AddImmediate(rv, StackPointer(rv), 16);
  TargetSetDest(restore, StackPointer(rv));
  TargetAddUser(*lo, restore);
  TargetAddUser(*hi, restore);
  PairWideHalves(*lo, *hi);
}

static TargetInstruction* LowerCall(XTENSAGenerator* rv, IRNode* node) {
  assert(node->inputs.length >= 1);
  ...
  for (size_t i = 1; i < node->inputs.length; i++) {
    ...
    XTENSAFloatingAggregate floating_aggregate;
    bool pass_floating_aggregate =
        !is_variadic_arg &&
        GetFloatingAggregate(arg_node->type, &floating_aggregate) &&
        next_fp_arg_reg + floating_aggregate.count <= XTENSA_NUM_FP_ARGS;
    if (is_hidden_struct_result) {
      TargetInstruction* arg_reg = IntArgumentRegister(rv, next_int_arg_reg++);
      ...
      VectorAppend(&arg_locations, location);
               ...
               (is_variadic_arg && TypeIsFloatingPoint(arg_node->type) &&
                XTENSAFpIsDoubleWidth(arg_node->type))) {
      ...
      // passed wholly in an 8-byte-aligned stack slot.
      if (is_variadic_arg && (next_int_arg_reg & 1) != 0) {
        next_int_arg_reg++;
      }
      if (next_int_arg_reg + 1 < XTENSA_NUM_INT_ARGS) {
        TargetInstruction* first = IntArgumentRegister(rv, next_int_arg_reg++);
        TargetInstruction* second = IntArgumentRegister(rv, next_int_arg_reg++);
        VectorAppend(&arg_locations, NewArgLocationRegisterPair(first, second));
      } else {
        next_pushed_arg_offset = (next_pushed_arg_offset + 7) & ~(size_t)7;
      ...
      if (struct_size <= 4) {
        if (next_int_arg_reg < XTENSA_NUM_INT_ARGS) {
      ...
      if (next_fp_arg_reg < XTENSA_NUM_FP_ARGS) {
        // Argument goes in an argument register.
        TargetInstruction* arg_reg =
            FloatingPointArgumentRegister(rv, next_fp_arg_reg++);
        VectorAppend(&arg_locations, NewArgLocationRegister(arg_reg));
        ...
        // Need to push argument on to the stack.  But we do that in reverse
        // order so for now, we record that the arg location is on the stack.
        size_t arg_size = arg_node->type->size;
        next_pushed_arg_offset =
            (next_pushed_arg_offset + arg_size - 1) & ~(arg_size - 1);
        VectorAppend(
            &arg_locations,
            NewArgLocationPushed(kArgLocationPushed, next_pushed_arg_offset));
        next_pushed_arg_offset += arg_size;
      }
    } else {
      if (next_int_arg_reg < XTENSA_NUM_INT_ARGS) {
        // Argument goes in an argument register.
  ...
  if (total_stack_size > 0) {
    ...
    TargetSetDest(newsp, StackPointer(rv));
    // Emit(rv, NewInstruction2(XTENSA_OP(rmov), StackPointer(rv), newsp));
  }
    ...
    switch (arg_location->type) {
      case kArgLocationFPRegisterAggregate: {
        ...
        for (int member = 0; member < aggregate.count; member++) {
          XTENSAOpcode load_opcode =
              XTENSAFpIsDoubleWidth(aggregate.type[member]) ? XTENSA_OP(fld)
                                                            : XTENSA_OP(flw);
          XTENSAOpcode move_opcode =
              XTENSAFpIsDoubleWidth(aggregate.type[member]) ? XTENSA_OP(fmv_d)
                                                            : XTENSA_OP(fmv_s);
          TargetInstruction* value = Emit(
              rv, NewInstruction2(load_opcode, address,
                                  GetIntConstant(rv, NULL, kTargetType32Bit,
                                                 aggregate.offset[member])));
          TargetInstruction* destination = member == 0
                                               ? arg_location->location.reg
      ...
      case kArgLocationRegisterPair: {
        if (TypeIsFloatingPoint(arg_node->type)) {
          TargetInstruction *lo, *hi;
          MaterializeDoubleBits(rv, arg_node, &lo, &hi);
          VectorAppend(
              &pending_arg_moves,
              NewPendingArgMove(lo, arg_location->location.reg, XTENSA_OP(mv)));
          VectorAppend(
              &pending_arg_moves,
              NewPendingArgMove(hi, arg_location->second_reg, XTENSA_OP(mv)));
          break;
        }
        if (NodeIsWideInt(arg_node)) {
          TargetInstruction *lo, *hi;
          MaterializeWide(rv, arg_node, &lo, &hi);
          VectorAppend(
              &pending_arg_moves,
              NewPendingArgMove(lo, arg_location->location.reg, XTENSA_OP(mv)));
          VectorAppend(
        ...
        TargetInstruction* first = Emit(
            rv, NewInstruction2(XTENSA_OP(lw), address,
                                GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
        ...
        VectorAppend(
            &pending_arg_moves,
            NewPendingArgMove(second, arg_location->second_reg, XTENSA_OP(mv)));
        break;
      }
      case kArgLocationPushedPair: {
        if (TypeIsFloatingPoint(arg_node->type)) {
          TargetInstruction* value = Materialize(rv, arg_node);
          Emit(rv,
               NewInstruction3(XTENSA_OP(fsd), value, StackPointer(rv),
                               GetIntConstant(rv, NULL, kTargetType32Bit,
        ...
        TargetInstruction* second = Emit(
            rv, NewInstruction2(XTENSA_OP(lw), address,
                                GetIntConstant(rv, NULL, kTargetType32Bit, 4)));
        Emit(rv,
             NewInstruction3(XTENSA_OP(sw), first, StackPointer(rv),
                             GetIntConstant(rv, NULL, kTargetType64Bit,
                                            arg_location->location.offset)));
        Emit(rv, NewInstruction3(XTENSA_OP(sw), second, StackPointer(rv),
                                 GetIntConstant(rv, NULL, kTargetType64Bit,
      ...
      case kArgLocationPassedByReferenceInRegister: {
        ...
        VectorAppend(
            &pending_arg_moves,
            NewPendingArgMove(arg, arg_location->location.reg, XTENSA_OP(mv)));
        break;
      }
      case kArgLocationPassedByReferenceOnStack: {
      ...
      case kArgLocationPushed: {
        ...
        if (pass_float_as_int) {
          arg = Emit(
              rv, NewInstruction1(!TypeUsesFloat32Representation(arg_node->type)
                                      ? XTENSA_OP(fmv_x_d)
                                      : XTENSA_OP(fmv_x_w),
                                  arg));
          Emit(rv,
               NewInstruction3(XTENSA_OP(sw), arg, StackPointer(rv),
      ...
      case kArgLocationRegister: {
        ...
        if (pass_float_as_int) {
          ...
          if (XTENSAFpIsDoubleWidth(arg_node->type)) {
            mov_opcode = XTENSA_OP(fmv_d);
          } else {
            mov_opcode = XTENSA_OP(fmv_s);
          }
        }
        VectorAppend(
            &pending_arg_moves,
            NewPendingArgMove(arg, arg_location->location.reg, mov_opcode));
        break;
      }
    }
  }
  ...
  for (size_t i = 0; i < pending_arg_moves.length; i++) {
    XTENSAPendingArgMove* pending = pending_arg_moves.value.p[i];
    TargetInstruction* move =
        Emit(rv, NewInstruction2(pending->opcode, pending->destination,
                                 pending->source));
    move->flags |= XTENSA_INST_ARG_MOVE;
  }
  ...
  if (can_be_tail_call) {
    ...
    if (XTENSAIsExpression(addr)) {
      ...
      TargetInstruction* mv = Emit(rv, NewInstruction1(XTENSA_OP(mv), addr));
      mv->dest = Tmp(rv);
      Emit(rv, NewInstruction(XTENSA_OP(restore)));
      call = Emit(rv, NewInstruction1(XTENSA_OP(jr), Tmp(rv)));
    } else {
      Emit(rv, NewInstruction(XTENSA_OP(restore)));
      BuildArgList(rv, &arg_locations);
      if (((int)addr->opcode == (int)XTENSA_OP(symbol))) {
        // Direct tail call to a known function: a plain jump to the symbol.
        call = Emit(rv, NewInstruction1(XTENSA_OP(j), addr));
      } else {
        ...
        call = Emit(rv, NewInstruction1(XTENSA_OP(jr), addr));
      }
    }
    rv->base.num_calls--;
  } else {
    ...
    if (((int)addr->opcode == (int)XTENSA_OP(symbol))) {
      ...
      opcode =
          TypeIsFloatingPoint(node->type) ? XTENSA_OP(callf) : XTENSA_OP(call);
    } else {
      // Calling through a register, rcall.
      opcode = TypeIsFloatingPoint(node->type) ? XTENSA_OP(rcallf)
                                               : XTENSA_OP(rcall);
    }
    call = Emit(
        rv, NewInstruction2(opcode, addr, BuildArgList(rv, &arg_locations)));
  ...
  if (!can_be_tail_call) {
    ...
    if (node->type != NULL && TypeIsFloatingPoint(node->type)) {
      mov_opcode = XTENSAFpIsDoubleWidth(node->type) ? XTENSA_OP(fmv_d)
                                                     : XTENSA_OP(fmv_s);
    }
    TargetInstruction* dest = GetDestInstruction(rv, node);
    if (dest != NULL) {
...
// A computed branch indexes a dense table of three-byte Xtensa J
// instructions.  Materialize the local table address through the normal
// literal-pool path, add index * 3, and jump indirectly.

static TargetInstruction* LowerComputedBranch(XTENSAGenerator* rv,
                                              IRNode* node) {
  assert(node->inputs.length == 1);
  TargetInstruction* value = GetLoweredNode(node->inputs.value.p[0]);
  TargetInstruction* doubled =
      Emit(rv, NewInstruction2(XTENSA_OP(slli), value,
                               GetIntConstant(rv, NULL, kTargetType32Bit, 1)));
  TargetInstruction* scaled =
      Emit(rv, NewInstruction2(XTENSA_OP(add), value, doubled));
  TargetInstruction* table = NewInstruction(XTENSA_OP(label));
  TargetInstruction* base = Emit(rv, NewInstruction1(XTENSA_OP(lla), table));
  TargetInstruction* address =
      Emit(rv, NewInstruction2(XTENSA_OP(add), base, scaled));
  TargetInstruction* jalr = Emit(rv, NewInstruction1(XTENSA_OP(jalr), address));
...
static TargetInstruction* LowerBuiltinVaStart(XTENSAGenerator* rv,
                                              IRNode* node) {
  TargetInstruction* s0 = Emit(rv, NewInstruction(XTENSA_OP(fp)));
  // Odd named-arg counts leave a0 at an 8-byte boundary, so the first unnamed
  // register (a1, a3, ...) is saved at s0+4.  Point va_list at that slot.
  if ((rv->num_int_arg_regs & 1) != 0) {
    s0 = Emit(rv,
              NewInstruction2(XTENSA_OP(addi), s0,
                              GetIntConstant(rv, NULL, kTargetType32Bit, 4)));
  }
  TargetInstruction* addr;
  TargetInstruction* offset;
  ...
  if (!on_stack) {
    TargetInstruction* mv = Emit(rv, NewInstruction1(XTENSA_OP(mv), s0));
    mv->dest = addr;
    return SetLoweredNode(node, addr);
  }
  return SetLoweredNode(
      node, Emit(rv, NewInstruction3(XTENSA_OP(sw), s0, addr, offset)));
}
...
static TargetInstruction* LowerBuiltinVaArg(XTENSAGenerator* rv, IRNode* node) {
  ...
  if (!on_stack) {
    ...
    ap_load = Emit(rv, NewInstruction2(XTENSA_OP(lw), ap_addr, ap_offset));
  }
  TargetInstruction* result;
  size_t arg_size = 4;
  ...
  if (is_eight) {
    ap_load = Emit(
        rv, NewInstruction2(XTENSA_OP(addi), ap_load,
                            GetIntConstant(rv, NULL, kTargetType32Bit, 7)));
    ap_load = Emit(
        rv, NewInstruction2(XTENSA_OP(andi), ap_load,
  ...
  if (TypeIsStructOrUnion(node->type) &&
    ...
    result = ap_load;
    arg_size = (struct_size + 3) & ~(size_t)3;
  } else if (TypeIsFloatingPoint(node->type)) {
    result = Emit(
        rv, NewInstruction2(XTENSA_OP(fld), ap_load,
                            GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
  } else if (NodeIsWideInt(node)) {
    result = Emit(
        rv, NewInstruction2(XTENSA_OP(lw), ap_load,
                            GetIntConstant(rv, NULL, kTargetType32Bit, 0)));
    TargetInstruction* hi = Emit(
        rv, NewInstruction2(XTENSA_OP(lw), ap_load,
                            GetIntConstant(rv, NULL, kTargetType32Bit, 4)));
  ...
  TargetInstruction* addi = Emit(
      rv,
      NewInstruction2(XTENSA_OP(addi), ap_load,
                      GetIntConstant(rv, NULL, kTargetType32Bit, arg_size)));
  if (on_stack) {
    Emit(rv, NewInstruction3(XTENSA_OP(sw), addi, ap_addr, ap_offset));
  } else {
    TargetInstruction* mv = Emit(rv, NewInstruction1(XTENSA_OP(mv), addi));
    mv->dest = ap_load;
  }
  return SetLoweredNode(node, result);
}

static TargetInstruction* LowerBuiltinVaEnd(XTENSAGenerator* rv, IRNode* node) {
  // Nothing to do for va_end.
  return NULL;
}

static TargetInstruction* LowerBuiltinVaCopy(XTENSAGenerator* rv,
                                             IRNode* node) {
  TargetInstruction* dest_addr;
  TargetInstruction* dest_offset;
  bool dest_on_stack =
  ...
  TargetInstruction* value =
      src_on_stack
          ? Emit(rv, NewInstruction2(XTENSA_OP(lw), src_addr, src_offset))
          : src_addr;

  if (dest_on_stack) {
    return SetLoweredNode(
        node, Emit(rv, NewInstruction3(XTENSA_OP(sw), value, dest_addr,
                                       dest_offset)));
  }
  TargetInstruction* move = Emit(rv, NewInstruction1(XTENSA_OP(mv), value));
  move->dest = dest_addr;
  return SetLoweredNode(node, dest_addr);
}

static TargetInstruction* LowerLocation(XTENSAGenerator* rv, IRNode* node) {
  IRLocation* loc = (IRLocation*)node;
  return SetLoweredNode(node, Emit(rv, TargetNewLocation(loc)));
}

static TargetInstruction* LowerStackPointerOps(XTENSAGenerator* rv,
                                               IRNode* node) {
  switch (node->opcode) {
    case IR_OP(decsp): {
      ...
      if (TargetIsConst(size)) {
        int64_t s = XTENSAIntValue(size);
        new_sp = AddImmediate(rv, StackPointer(rv), -s);
      } else {
        new_sp =
            Emit(rv, NewInstruction2(XTENSA_OP(sub), StackPointer(rv), size));
      }
    ...
    case IR_OP(savesp): {
      ...
      TargetInstruction* mv =
          Emit(rv, NewInstruction1(XTENSA_OP(mv), StackPointer(rv)));
      mv->dest = tmp;
      return tmp;
    }
    case IR_OP(restoresp): {
      TargetInstruction* tmp = Materialize(rv, node->inputs.value.p[0]);
      TargetInstruction* mv = Emit(rv, NewInstruction1(XTENSA_OP(mv), tmp));
...
static int AtomicAccessLog2(TypeRecord* type) {
  ...
  switch (type->size) {
    ...
    case 4:
      return 2;
    default:
      assert(false && "RISC-V32 atomics require a 1/2/4-byte object");
      return 2;
  }
}

static TargetInstruction* AtomicAddress(XTENSAGenerator* rv,
                                        IRNode* addr_node) {
  TargetInstruction* base;
  TargetInstruction* offset;
  ...
  if (TargetIsConst(offset)) {
    return AddImmediate(rv, base, XTENSAIntValue(offset));
  }
  return Emit(rv, NewInstruction2(XTENSA_OP(add), base, offset));
}

static void SetAtomicMetadata(TargetInstruction* inst, TypeRecord* value_type,
                              int success_order, int failure_order, bool weak) {
  inst->flags |= AtomicAccessLog2(value_type) << XTENSA_ATOMIC_SIZE_SHIFT;
  inst->flags |= success_order << XTENSA_ATOMIC_ORDER_SHIFT;
  inst->flags |= failure_order << XTENSA_ATOMIC_FAILURE_ORDER_SHIFT;
  if (weak) {
    inst->flags |= XTENSA_ATOMIC_WEAK;
  }
}

static TargetInstruction* FinishAtomicValue(XTENSAGenerator* rv, IRNode* node,
                                            TargetInstruction* inst) {
  Emit(rv, inst);
  TargetInstruction* dest = GetDestInstruction(rv, node);
  if (dest != NULL) {
    inst = SetDestOrMove(rv, inst, dest, XTENSA_OP(mv));
  }
  return SetLoweredNode(node, inst);
}

static TargetInstruction* LowerAtomic(XTENSAGenerator* rv, IRNode* node) {
  if (node->opcode == IR_OP(atomic_fence)) {
    TargetInstruction* inst = NewInstruction(XTENSA_OP(atomic_fence));
  ...
  switch (node->opcode) {
    case IR_OP(atomic_load):
      inst = NewInstruction1(XTENSA_OP(atomic_load), addr);
    ...
    case IR_OP(atomic_store): {
      ...
      inst = NewInstruction2(XTENSA_OP(atomic_store), value, addr);
      SetAtomicMetadata(inst, value_type,
    ...
    case IR_OP(atomic_sub_fetch): {
      XTENSAOpcode opcode = node->opcode == IR_OP(atomic_fetch_add)
    ...
    case IR_OP(atomic_compare_exchange_n): {
      ...
      XTENSAOpcode opcode =
          expected_is_pointer ? XTENSA_OP(atomic_compare_exchange_n)
      ...
      TargetInstruction* expected = Materialize(rv, node->inputs.value.p[1]);
      ...
      bool weak =
          expected_is_pointer && AtomicIRConstant(node->inputs.value.p[3]) != 0;
      SetAtomicMetadata(
          inst, value_type, AtomicIRConstant(node->inputs.value.p[order_index]),
...
static TargetInstruction* LowerIRNode(XTENSAGenerator* rv, Generator* gen,
                                      IRNode* node) {
  // If we have already lowered the IR node, return it.
  if (node->data.ptr != NULL) {
    return node->data.ptr;
  ...
  switch (node->opcode) {
    ...
    case IR_OP(popcounti):
      assert(
          false &&
          "bit operation must be software-expanded before RISC-V32 lowering");
      return NULL;
    ...
    case IR_OP(capturev):
      assert(false &&
             "vector operation must be software-expanded before RISC-V32 "
             "lowering");
      return NULL;
    ...
    case IR_OP(observable_checkpoint): {
      TargetInstruction* checkpoint = Emit(rv, NewInstruction(XTENSA_OP(nop)));
    ...
    case IR_OP(nrvoval):
      return Emit(rv,
                  NewInstruction1(XTENSA_OP(nrvoval),
                                  Materialize(rv, node->inputs.value.p[0])));
    ...
    case IR_OP(structreturn): {
      ...
      TargetInstruction* result = SetLoweredNode(
          node, EmitSymbol(rv, NewInstruction(XTENSA_OP(structreturn))));
      TargetInstruction* mv =
          Emit(rv, NewInstruction1(XTENSA_OP(mv), IntArgumentRegister(rv, 0)));
      mv->dest = result;
      return result;
    }
    ...
    case IR_OP(enter):
      Emit(rv, NewInstruction(XTENSA_OP(save)));
    ...
    case IR_OP(ret):
      return Emit(rv, NewInstruction(XTENSA_OP(ret)));
    ...
    case IR_OP(cmpgta):
    case IR_OP(cmpgea):
      return FinishWithDest(rv, node, LowerComparison(rv, node), XTENSA_OP(mv));
    ...
    case IR_OP(cmp3wayf):
    case IR_OP(cmp3wayd):
      return FinishWithDest(rv, node, LowerThreeWay(rv, node), XTENSA_OP(mv));
    ...
    case IR_OP(pusharg):
      if (NodeIsWideInt(node) || NodeIsWideInt(node->inputs.value.p[0])) {
        TargetInstruction* lo;
        TargetInstruction* hi;
        MaterializeWide(rv, node->inputs.value.p[0], &lo, &hi);
        PairWideHalves(lo, hi);
...
static int64_t CalculateArgumentSize(IRNode* arg) {
  ...
  if (arg->opcode == IR_OP(argument) && ((IRVariable*)arg)->symbol != NULL) {
...
static ArgLocation ArgumentLocation(PoolEntry* arg, Vector* args) {
  ...
  int int_reg = XTENSA_INT_ARG_START;
  if (is_struct_return) {
    int_reg +=
        1;  // For struct returns, the first arg is the address of the struct.
  }
  int fp_reg = XTENSA_FP_ARG_START;
  int stack_offset = 0;
  for (size_t i = 0; i < args->length; i++) {
    if (i == arg_num) {
      ArgLocation location = {0};
      XTENSAFloatingAggregate aggregate;
      bool in_fp_registers = GetFloatingAggregate(arg_type, &aggregate) &&
                             fp_reg + aggregate.count - 1 <= XTENSA_FP_ARG_END;
      if (in_fp_registers) {
        location.type = kArgLocationFPRegisterAggregate;
        ...
        if (int_reg + 1 <= XTENSA_INT_ARG_END) {
          ...
          location.second_offset = stack_offset + 4;
        }
      } else if (TypeIsFloatingPoint(arg_type)) {
        if (fp_reg <= XTENSA_FP_ARG_END) {
          // Arg is in a floating point register.
          location.type = kArgLocationRegister;
          location.location.offset = fp_reg;
        } else {
          location.type = kArgLocationPushed;
          int alignment = arg_type->size;
          stack_offset = (stack_offset + alignment - 1) & ~(alignment - 1);
          location.location.offset = stack_offset;
        }
      } else {
        if (int_reg <= XTENSA_INT_ARG_END) {
    ...
    XTENSAFloatingAggregate aggregate;
    bool in_fp_registers = GetFloatingAggregate(arg_symbol->type, &aggregate) &&
                           fp_reg + aggregate.count - 1 <= XTENSA_FP_ARG_END;
    if (in_fp_registers) {
      ...
      if (fp_reg <= XTENSA_FP_ARG_END) {
        ...
        int alignment = arg_symbol->type->size;
        stack_offset = (stack_offset + alignment - 1) & ~(alignment - 1);
...
static TargetInstruction* LoadFpArgumentIntoRegisterVariable(
    XTENSAGenerator* rv, int reg_var, ArgLocation arg_loc, IRNode* symbol) {
  switch (arg_loc.type) {
    case kArgLocationRegister:
    case kArgLocationPassedByReferenceInRegister: {
      ...
      XTENSAOpcode move_op = XTENSAFpIsDoubleWidth(symbol->type)
                                 ? XTENSA_OP(fmv_d)
                                 : XTENSA_OP(fmv_s);
      Emit(rv, NewInstruction2(move_op, var,
                               FloatingPointArgumentRegister(
                                   rv, (int)arg_loc.location.offset -
                                           XTENSA_FP_ARG_START)));
      return var;
    }
    case kArgLocationPushed:
...
static TargetInstruction* LoadIntArgumentIntoRegisterVariable(
    XTENSAGenerator* rv, int reg_var, ArgLocation arg_loc, IRNode* symbol) {
  switch (arg_loc.type) {
    case kArgLocationRegister:
    case kArgLocationPassedByReferenceInRegister: {
      ...
      TargetInstruction* mv = Emit(
          rv,
          NewInstruction1(XTENSA_OP(mv),
                          IntArgumentRegister(rv, (int)arg_loc.location.offset -
                                                      XTENSA_INT_ARG_START)));
      mv->dest = var;
      return var;
    }
    case kArgLocationPassedByReferenceOnStack:
    case kArgLocationPushed: {
      ...
      TargetInstruction* var = IntVariableRegister(rv, reg_var, sym->symbol);
      TargetInstruction* mv = Emit(
          rv, NewInstruction1(XTENSA_OP(mv),
...
static int SavedArgumentAreaLowAddress(const XTENSAGenerator* rv) {
  int low = -XTENSA_STACK_FRAME_HEADER_SIZE;
...
static int AllocateSavedArgumentArea(const XTENSAGenerator* rv, int size,
                                     int alignment) {
  assert(size > 0);
...
static int SavedArgumentAreaSize(const XTENSAGenerator* rv) {
  return -XTENSA_STACK_FRAME_HEADER_SIZE - SavedArgumentAreaLowAddress(rv);
}

static void HomeFloatingAggregateArgument(
    XTENSAGenerator* rv, PoolEntry* entry, ArgLocation location,
    const XTENSAFloatingAggregate* aggregate) {
  int size = 0;
  for (int member = 0; member < aggregate->count; member++) {
  ...
  for (int member = 0; member < aggregate->count; member++) {
    ...
    VectorAppend(&rv->saved_regs,
                 NewSavedArgumentRegister(reg, XTENSA_FP_REG,
...
static void AssignRegisterOrOffset(XTENSAGenerator* rv, PoolEntry* entry,
  ...
  if (TypeIsFloatingPoint(entry->pooled->type)) {
    if (UseRegisterForVariable(rv, entry->pooled)) {
      ...
      entry->pooled->data.ivalue = XTENSA_REG_VAR | reg;
      ...
      if (is_arg) {
        ...
        if (location.type == kArgLocationRegister) {
          ...
          SavedArgumentRegister* saved = NewSavedArgumentRegister(
              (int)location.location.offset, XTENSA_FP_REG, offset,
              entry->pooled->type->size, true);
          entry->pooled->data.ivalue = offset;
      ...
      if (location.type == kArgLocationFPRegisterAggregate) {
        ...
        VectorAppend(&rv->saved_regs,
                     NewSavedArgumentRegister((int)location.location.offset,
                                              XTENSA_FP_REG, offset, 4, false));
        VectorAppend(&rv->saved_regs, NewSavedArgumentRegister(
                                          (int)location.second_offset,
                                          XTENSA_FP_REG, offset + 4, 4, false));
    ...
    if (is_arg) {
      if (size <= 4) {
        ...
        // the struct's address, and the frontend does not mark a by-value
        // struct parameter as address-taken, so UseRegisterForVariable would
        // wrongly promote it.  Home the incoming value into a stack slot
        // exactly like a pointer-sized integer argument so the prologue spills
        // it and the address computation refers to that slot.
        ArgLocation location = ArgumentLocation(entry, args);
        if (location.type == kArgLocationFPRegisterAggregate) {
          XTENSAFloatingAggregate aggregate;
          if (!GetFloatingAggregate(variable_type, &aggregate)) {
          ...
          int offset = AllocateSavedArgumentArea(rv, 8, 8);
          SavedArgumentRegister* saved = NewSavedArgumentRegister(
              (int)location.location.offset, XTENSA_FP_REG, offset, 8, false);
          entry->pooled->data.ivalue = offset;
          VectorAppend(&rv->saved_regs, saved);
          rv->num_int_arg_regs++;
          SetDebugStackLocation(entry, entry->pooled->data.ivalue);
      ...
      if ((entry->pooled->flags & kIRNrvoMarker) != 0) {
        ...
        // structreturn.
        entry->pooled->data.ivalue = XTENSA_REG_VAR | rv->struct_return_reg;
        TargetInstruction* var =
            IntVariableRegister(rv, rv->struct_return_reg, entry->value.symbol);
        Emit(rv,
             NewInstruction2(XTENSA_OP(mv), var, IntArgumentRegister(rv, 0)));
...
static void FinalizeDebugStackLocations(XTENSAGenerator* rv, Vector* vars) {
...
static void AssignRegisterVars(XTENSAGenerator* rv, Vector* vars,
  ...
  rv->base.stack_frame_size = (int32_t)var_offset + SavedArgumentAreaSize(rv);
...
void XTENSALower(XTENSAGenerator* rv, Generator* gen) {
  ...
  if (compiler->print_back_end || compiler->ir_output_file != stdout) {
    XTENSAPrint(rv, compiler->ir_output_file);
  }
  ...
  if (OptLevel2()) {
    ...
    if (compiler->print_back_end || compiler->ir_output_file != stdout) {
      fprintf(compiler->ir_output_file, "\n After RISC-V32 optimization\n");
      TargetPrintBasicBlocks(&rv->base, compiler->ir_output_file);
    }
  }
  // Allocate registers to the instructions.
  XTENSAAllocateRegisters(&rv->register_allocator);
}

void XTENSAPrint(XTENSAGenerator* rv, FILE* fp) {
  TargetInstruction* inst = TargetFirstInstruction(&rv->base);
  while (inst != NULL) {
    TargetPrintInstruction(inst, XTENSAOpcodeName, fp);
