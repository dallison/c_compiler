...
// Standalone ARM assembler that generates ELF object files.
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(int argc, char* argv[]) {
  ...
  StringInit(&target->value.svalue, "arm");
  ...
  for (size_t i = 0; i < asm_filenames.length; i++) {
    ...
    ARMAssembler* assembler = NewARMAssembler(asm_filename, &output_filename);
